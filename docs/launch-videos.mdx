...
| **Website → HyperFrames** | Companion to the [website-to-video](/guides/website-to-video) flow — now `/product-launch-video`'s tour angle — captures a site and animates it. | [`website-to-hyperframes/`](https://github.com/heygen-com/hyperframes-launches/tree/main/website-to-hyperframes) |
