...
<CatalogDetail
  previewSrc="/public/catalog/blocks/flowchart.json"
  compositionId="flowchart"
  compositionSrc="compositions/flowchart.html"
  title="Flowchart"
  description="Animated decision tree with SVG connectors, sticky-note nodes, cursor interaction, and typing correction"
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":459}}
  attribution={{"path":"registry/blocks/flowchart","tags":["diagram","flowchart","interactive"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/flowchart/flowchart.html"
>
