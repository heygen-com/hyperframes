...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-dissolve.json"
  compositionId="transitions-dissolve"
  compositionSrc="compositions/transitions-dissolve.html"
  title="Dissolve Transitions"
  description="Showcase of dissolve and fade transitions"
  variables={[]}
  meta={{"duration":24,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":391}}
  attribution={{"path":"registry/blocks/transitions-dissolve","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-dissolve/transitions-dissolve.html"
>

<CatalogSlot slot="code">

```html transitions-dissolve.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
