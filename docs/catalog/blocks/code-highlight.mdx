...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-highlight.json"
  compositionId="code-highlight"
  compositionSrc="compositions/code-highlight.html"
  title="Code Highlight Sweep"
  description="A highlight band sweeps across a target line while the surrounding context dims — draws the eye to one line."
  variables={[]}
  meta={{"duration":5,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":745}}
  attribution={{"path":"registry/blocks/code-highlight","tags":["code","code-animation","highlight","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-highlight/code-highlight.html"
>

<CatalogSlot slot="code">

```html code-highlight.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
