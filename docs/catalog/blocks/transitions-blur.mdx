...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-blur.json"
  compositionId="transitions-blur"
  compositionSrc="compositions/transitions-blur.html"
  title="Blur Transitions"
  description="Showcase of blur-based transitions between scenes"
  variables={[]}
  meta={{"duration":20,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":387}}
  attribution={{"path":"registry/blocks/transitions-blur","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-blur/transitions-blur.html"
>

<CatalogSlot slot="code">

```html transitions-blur.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
