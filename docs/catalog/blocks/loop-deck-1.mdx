...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-deck-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-deck-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-deck-1" item="loop-deck-1" />

That writes one file: `compositions/loop-deck-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-deck-1.html"
  data-start="0"
  data-duration="7"
  data-track-index="1"
  data-width="1080"
...
| `gap` | `0.29` | 0px to 2px, step 0.01px | Spacing between cards. |
