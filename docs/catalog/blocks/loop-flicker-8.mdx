...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-8.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-8.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-8" item="loop-flicker-8" />

That writes one file: `compositions/loop-flicker-8.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-8"
  data-composition-src="compositions/loop-flicker-8.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `scaleAmount` | `40` | 0 to 80, step 1 | Scale Amount (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-8-bg"></div>
        <div id="loop-flicker-8-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-8-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-8-bg"));
        const stage = document.getElementById("loop-flicker-8-stage");
        ...
        window.__timelines["loop-flicker-8"] = tl;
      })();
    </script>
  </body>
</html>
