...
```html index.html
<div
  data-composition-id="loop-marquee-2"
  data-composition-src="compositions/loop-marquee-2.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-marquee-2.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-2-bg"></div>
        <div id="loop-marquee-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-2-bg"));
        const stage = document.getElementById("loop-marquee-2-stage");
        ...
        window.__timelines["loop-marquee-2"] = tl;
      })();
    </script>
  </body>
</html>
