...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flip-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flip-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flip-3" item="loop-flip-3" />

That writes one file: `compositions/loop-flip-3.html`.
...
```html index.html
<div
  data-composition-id="loop-flip-3"
  data-composition-src="compositions/loop-flip-3.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `670` | 0 to 1340, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flip-3-bg"></div>
        <div id="loop-flip-3-stage"><div id="loop-flip-3-col"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flip-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flip-3-bg"));
        document.getElementById("loop-flip-3-stage").style.perspective = f + "px";
        const col = document.getElementById("loop-flip-3-col");
        ...
        window.__timelines["loop-flip-3"] = tl;
      })();
    </script>
  </body>
</html>
