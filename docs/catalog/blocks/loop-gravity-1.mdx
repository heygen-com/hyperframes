...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-gravity-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-gravity-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-gravity-1" item="loop-gravity-1" />

That writes one file: `compositions/loop-gravity-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-gravity-1.html"
  data-start="0"
  data-duration="7"
  data-track-index="1"
  data-width="1080"
...
| `cardSize` | `300` | 0 to 820, step 10 | Card Size (engine parameter; see the block header comment). |
| `gravity` | `1` | 0 to 10, step 0.1 | Gravity (engine parameter; see the block header comment). |
| `bounce` | `0.2` | 0 to 2, step 0.01 | Bounce (engine parameter; see the block header comment). |
