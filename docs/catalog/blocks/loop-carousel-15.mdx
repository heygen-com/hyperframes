...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-15.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-15.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-15" item="loop-carousel-15" />

That writes one file: `compositions/loop-carousel-15.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-15"
  data-composition-src="compositions/loop-carousel-15.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `614` | 0 to 1700, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-15-bg"></div>
        <div id="loop-carousel-15-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-15-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-15-bg"));
        const stage = document.getElementById("loop-carousel-15-stage");
        ...
        window.__timelines["loop-carousel-15"] = tl;
      })();
    </script>
  </body>
</html>
