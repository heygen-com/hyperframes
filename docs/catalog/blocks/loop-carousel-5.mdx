...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-5.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-5.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-5" item="loop-carousel-5" />

That writes one file: `compositions/loop-carousel-5.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-5"
  data-composition-src="compositions/loop-carousel-5.html"
  data-start="0"
  data-duration="18"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `730` | 0 to 1700, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-5-bg"></div>
        <div id="loop-carousel-5-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-5-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-5-bg"));
        const stage = document.getElementById("loop-carousel-5-stage");
        ...
        window.__timelines["loop-carousel-5"] = tl;
      })();
    </script>
  </body>
</html>
