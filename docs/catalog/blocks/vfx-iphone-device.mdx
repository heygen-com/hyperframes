...
<iframe src="/public/catalog/preview/blocks/vfx-iphone-device.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="iPhone & MacBook 3D Showcase preview" />

## Install

<InstallCommand command="npx hyperframes add vfx-iphone-device" />
