...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stack-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stack-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-stack-3" item="loop-stack-3" />

That writes one file: `compositions/loop-stack-3.html`.
...
```html index.html
<div
  data-composition-id="loop-stack-3"
  data-composition-src="compositions/loop-stack-3.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-stack-3-bg"></div>
        <div id="loop-stack-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-stack-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-stack-3-bg"));
        const stage = document.getElementById("loop-stack-3-stage");
        ...
        window.__timelines["loop-stack-3"] = tl;
      })();
    </script>
  </body>
</html>
