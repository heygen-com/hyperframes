...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-fold.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-fold.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-fold" item="loop-fold" />

That writes one file: `compositions/loop-fold.html`.
...
<div
  ...
  data-composition-src="compositions/loop-fold.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `scaleIntensity` | `0.71` | 0 to 1, step 0.05 | Strength of the size change. |
| `borderRadius` | `28` | 0px to 200px, step 1px | Card corner radius in px at 1080. |
...
| `transitionShare` | `55` | 0 to 110, step 1 | Transition Share (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `fold` `3d`.
