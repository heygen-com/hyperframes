...
<CatalogDetail
  previewSrc="/public/catalog/blocks/liquid-glass-media-controls.json"
  compositionId="liquid-glass-media-controls"
  compositionSrc="compositions/liquid-glass-media-controls.html"
  title="Liquid Glass Media Controls"
  description="Frosted glass media control panels spreading over an aurora shader background"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":688}}
  attribution={{"path":"registry/blocks/liquid-glass-media-controls","tags":["html-in-canvas","liquid-glass-html-in-canvas","webgpu"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/liquid-glass-media-controls/liquid-glass-media-controls.html"
>

<CatalogSlot slot="code">

```html liquid-glass-media-controls.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
