...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-8.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-8.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-spiral-8" item="loop-spiral-8" />

That writes one file: `compositions/loop-spiral-8.html`.
...
```html index.html
<div
  data-composition-id="loop-spiral-8"
  data-composition-src="compositions/loop-spiral-8.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `radius` | `1535` | 0 to 6000, step 10 | Radius (engine parameter; see the block header comment). |
...
| `planeSize` | `170` | 0 to 1620, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-spiral-8-bg"></div>
        <div id="loop-spiral-8-stage"><div id="loop-spiral-8-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-spiral-8-loop").dataset.duration = DUR;
        background(document.getElementById("loop-spiral-8-bg"));
        ...
        const stage = document.getElementById("loop-spiral-8-stage");
        stage.style.perspective = f + "px";
        const world = document.getElementById("loop-spiral-8-world");
        ...
        window.__timelines["loop-spiral-8"] = tl;
      })();
    </script>
  </body>
</html>
