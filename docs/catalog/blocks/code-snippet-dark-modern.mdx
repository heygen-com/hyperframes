...
<iframe src="/public/catalog/preview/blocks/code-snippet-dark-modern.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Dark Modern preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-dark-modern" />

That writes `compositions/code-snippet-dark-modern.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-dark-modern.html`}>
