...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-dark-modern.json"
  compositionId="code-snippet-dark-modern"
  compositionSrc="compositions/code-snippet-dark-modern.html"
  title="Code Snippet - Dark Modern"
  description="VS Code workbench with per-character typing animation in the Dark Modern theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1087}}
  attribution={{"path":"registry/blocks/code-snippet-dark-modern","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-dark-modern/code-snippet-dark-modern.html"
>

<CatalogSlot slot="code">

```html code-snippet-dark-modern.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Dark Modern VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-dark-modern-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Dark Modern</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">dark_modern.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-dark-modern"] =
            window.__timelines["vscode-dark-modern"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-dark-modern", {
            id: "dark-modern",
            label: "Dark Modern",
