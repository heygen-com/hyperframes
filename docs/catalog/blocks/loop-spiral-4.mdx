---
title: "Loop Spiral 4"
description: "Image cards evenly spaced along a helix that advances toward the camera. 8 image slots, 15s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-spiral-4" item="loop-spiral-4" />

That writes one file: `compositions/loop-spiral-4.html`.
...
```html index.html
<div
  data-composition-id="loop-spiral-4"
  data-composition-src="compositions/loop-spiral-4.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `count` | `55` | 0 to 240, step 10 | Count (engine parameter; see the block header comment). |
| `radius` | `915` | 0 to 6000, step 10 | Radius (engine parameter; see the block header comment). |
...
| `planeSize` | `300` | 0 to 1620, step 10 | Card size in scene units. |
| `distance` | `0` | 0 to 9300, step 10 | Camera distance from the formation. |
| `perspective` | `215` | 0 to 600, step 10 | Camera focal length: smaller = stronger perspective. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-spiral-4-bg"></div>
        <div id="loop-spiral-4-stage"><div id="loop-spiral-4-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-spiral-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-spiral-4-bg"));
        ...
        const stage = document.getElementById("loop-spiral-4-stage");
        stage.style.perspective = f + "px";
        const world = document.getElementById("loop-spiral-4-world");
        ...
        window.__timelines["loop-spiral-4"] = tl;
      })();
    </script>
  </body>
</html>
