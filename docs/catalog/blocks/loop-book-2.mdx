...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-book-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-book-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-book-2" item="loop-book-2" />

That writes one file: `compositions/loop-book-2.html`.
...
```html index.html
<div
  data-composition-id="loop-book-2"
  data-composition-src="compositions/loop-book-2.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-book-2-bg"></div>
        <div id="loop-book-2-stage">
          <div id="loop-book-2-book"><div id="loop-book-2-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-book-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-book-2-bg"));
        const f = 1000 * (100 / PERSP) * (REF / 1080),
          s = f / D;
        document.getElementById("loop-book-2-stage").style.perspective = f + "px";
        const book = document.getElementById("loop-book-2-book"),
          spin = document.getElementById("loop-book-2-spin");
        ...
        window.__timelines["loop-book-2"] = tl;
      })();
    </script>
  </body>
</html>
