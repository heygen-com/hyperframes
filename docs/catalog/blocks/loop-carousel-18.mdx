---
title: "Loop Carousel 18"
description: "One lane of image cards steps past the centre, the focused card featured. 8 image slots, 13s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-18.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-18.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-18" item="loop-carousel-18" />

That writes one file: `compositions/loop-carousel-18.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-18"
  data-composition-src="compositions/loop-carousel-18.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `tiltStyle` | `alternate` | `off`, `fan`, `uniform`, `alternate` | Tilt Style (engine parameter; see the block header comment). |
...
| `planeSize` | `657` | 0 to 1700, step 10 | Card size in scene units. |
| `gap` | `273` | 0px to 1000px, step 10px | Spacing between cards. |
...
| `scaleCenter` | `off` | `off`, `on` | Scale Center (engine parameter; see the block header comment). |
| `scaleFocus` | `center` | `center`, `start`, `end` | Scale Focus (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-18-bg"></div>
        <div id="loop-carousel-18-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-18-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-18-bg"));
        const stage = document.getElementById("loop-carousel-18-stage");
        ...
        window.__timelines["loop-carousel-18"] = tl;
      })();
    </script>
  </body>
</html>
