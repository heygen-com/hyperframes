...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-3d-extrude.json"
  compositionId="code-3d-extrude"
  compositionSrc="compositions/code-3d-extrude.html"
  title="Code 3D Extrude"
  description="Syntax-highlighted code on a lit, beveled 3D slab that rotates through real space and settles to a readable rest — true WebGL depth and lighting, not a 2D transform."
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":616}}
  attribution={{"path":"registry/blocks/code-3d-extrude","tags":["code","code-animation","3d","webgl","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-3d-extrude/code-3d-extrude.html"
>

<CatalogSlot slot="code">

```html code-3d-extrude.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
