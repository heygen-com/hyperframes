...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-homebrew.json"
  compositionId="code-snippet-apple-terminal-homebrew"
  compositionSrc="compositions/code-snippet-apple-terminal-homebrew.html"
  title="Code Snippet - Apple Terminal Homebrew"
  description="Apple Terminal Homebrew profile: black background with bright green text and lime cursor, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":248}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-homebrew","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-homebrew/code-snippet-apple-terminal-homebrew.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-homebrew.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
