...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-parallax-2" item="loop-parallax-2" />

That writes one file: `compositions/loop-parallax-2.html`.
...
```html index.html
<div
  data-composition-id="loop-parallax-2"
  data-composition-src="compositions/loop-parallax-2.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `fade` | `78` | 0 to 100, step 1 | Fade (engine parameter; see the block header comment). |
| `count` | `200` | 0 to 400, step 10 | Count (engine parameter; see the block header comment). |
| `planeSize` | `340` | 0 to 680, step 10 | Card size in scene units. |
| `spread` | `300` | 0 to 600, step 10 | Spread (engine parameter; see the block header comment). |
| `travel` | `150` | 0 to 600, step 10 | Travel (engine parameter; see the block header comment). |
| `depth` | `100` | 0 to 200, step 1 | Depth (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-parallax-2-bg"></div>
        <div id="loop-parallax-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-parallax-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-parallax-2-bg"));
        const stage = document.getElementById("loop-parallax-2-stage");
        ...
        window.__timelines["loop-parallax-2"] = tl;
      })();
    </script>
  </body>
</html>
