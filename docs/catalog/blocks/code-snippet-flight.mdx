...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-flight.json"
  compositionId="code-snippet-flight"
  compositionSrc="compositions/code-snippet-flight.html"
  title="Code Snippet Flight"
  description="Discrete code snippets fly in from the side and assemble into a stacked program, staggered. Block-level FLIP."
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":668}}
  attribution={{"path":"registry/blocks/code-snippet-flight","tags":["code","code-animation","flight","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-flight/code-snippet-flight.html"
>

<CatalogSlot slot="code">

```html code-snippet-flight.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      (function () {
        ...
        function go() {
          ...
          document.fonts.ready.then(function () {
            ...
            window.__timelines["code-snippet-flight"] = tl; // register AFTER setup completes
