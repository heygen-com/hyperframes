...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-diff.json"
  compositionId="code-diff"
  compositionSrc="compositions/code-diff.html"
  title="Code Diff"
  description="An edit shown as a colored diff — removed lines collapse in red, added lines expand in green."
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":816}}
  attribution={{"path":"registry/blocks/code-diff","tags":["code","code-animation","diff","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-diff/code-diff.html"
>
