...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-particle-assemble.json"
  compositionId="code-particle-assemble"
  compositionSrc="compositions/code-particle-assemble.html"
  title="Code Particle Assemble"
  description="Thousands of GPU points scatter through space and fly to the exact glyph pixels of the code, resolving into readable syntax-highlighted text — a particle system, not a token tween."
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":482}}
  attribution={{"path":"registry/blocks/code-particle-assemble","tags":["code","code-animation","particles","gpu","webgl","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-particle-assemble/code-particle-assemble.html"
>

<CatalogSlot slot="code">

```html code-particle-assemble.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
