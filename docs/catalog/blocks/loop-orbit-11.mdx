...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-11.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-11.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-11" item="loop-orbit-11" />

That writes one file: `compositions/loop-orbit-11.html`.
...
```html index.html
<div
  data-composition-id="loop-orbit-11"
  data-composition-src="compositions/loop-orbit-11.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-orbit-11-bg"></div>
        <div id="loop-orbit-11-stage"><div id="loop-orbit-11-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-orbit-11-loop").dataset.duration = DUR;
        background(document.getElementById("loop-orbit-11-bg"));
        const f = 1200 * (100 / PERSP) * s;
        document.getElementById("loop-orbit-11-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-orbit-11-world");
        ...
        window.__timelines["loop-orbit-11"] = tl;
      })();
    </script>
  </body>
</html>
