...
<CatalogDetail
  previewSrc="/public/catalog/blocks/light-leak.json"
  compositionId="light-leak"
  compositionSrc="compositions/light-leak.html"
  title="Light Leak"
  description="Shader transition with cinematic light leak overlay"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":365}}
  attribution={{"path":"registry/blocks/light-leak","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/light-leak/light-leak.html"
>

<CatalogSlot slot="code">

```html light-leak.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
