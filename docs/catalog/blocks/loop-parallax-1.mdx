...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-parallax-1" item="loop-parallax-1" />

That writes one file: `compositions/loop-parallax-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-parallax-1.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
| `count` | `133` | 0 to 400, step 10 | Count (engine parameter; see the block header comment). |
...
| `travel` | `300` | 0 to 600, step 10 | Travel (engine parameter; see the block header comment). |
