...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-solid-colors.json"
  compositionId="code-snippet-apple-terminal-solid-colors"
  compositionSrc="compositions/code-snippet-apple-terminal-solid-colors.html"
  title="Code Snippet - Apple Terminal Solid Colors"
  description="Apple Terminal Solid Colors profile: deep purple background with white text, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":247}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-solid-colors","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-solid-colors/code-snippet-apple-terminal-solid-colors.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-solid-colors.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
