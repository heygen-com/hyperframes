---
title: "Loop Carousel 3D 2"
description: "Radial image panes spin around a vertical axis like a paddle wheel under a 3D camera. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel3d-2" item="loop-carousel3d-2" />

That writes one file: `compositions/loop-carousel3d-2.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel3d-2"
  data-composition-src="compositions/loop-carousel3d-2.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
| `orbitRadius` | `330` | 0 to 960, step 10 | Ring radius in scene units. |
| `distance` | `990` | 0 to 3740, step 10 | Camera distance from the formation. |
| `perspective` | `100` | 0 to 600, step 10 | Camera focal length: smaller = stronger perspective. |
| `rotationX` | `6` | -180° to 180°, step 1° | Formation tilt about the horizontal axis, degrees. |
| `rotationY` | `18` | -180° to 180°, step 1° | Formation turn about the vertical axis, degrees. |
| `rotationZ` | `-17` | -180° to 180°, step 1° | Formation roll about the view axis, degrees. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel3d-2-bg"></div>
        <div id="loop-carousel3d-2-stage">
          <div id="loop-carousel3d-2-ring"><div id="loop-carousel3d-2-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel3d-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel3d-2-bg"));
        ...
        const Rpx = R * s;
        document.getElementById("loop-carousel3d-2-stage").style.perspective = f + "px";
        document.getElementById("loop-carousel3d-2-ring").style.transform =
          `translate3d(${(OX / 100) * W}px,${(OY / 100) * H}px,0) rotateX(${RX}deg) rotateY(${RY}deg) rotateZ(${RZ}deg)`;
        const spin = document.getElementById("loop-carousel3d-2-spin");
        for (let i = 0; i < N; i++) {
          const m = IMAGES[i],
        ...
        window.__timelines["loop-carousel3d-2"] = tl;
      })();
    </script>
  </body>
</html>
