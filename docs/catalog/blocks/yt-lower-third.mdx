...
<CatalogDetail
  previewSrc="/public/catalog/blocks/yt-lower-third.json"
  compositionId="yt-lower-third"
  compositionSrc="compositions/yt-lower-third.html"
  title="YouTube Lower Third"
  description="Animated YouTube subscribe lower third with avatar and channel info"
  variables={[]}
  meta={{"duration":4.5,"width":1920,"height":1080,"category":"Social Overlays","badge":"Stable","codeLines":242}}
  attribution={{"path":"registry/blocks/yt-lower-third","tags":["social","overlay","youtube"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/yt-lower-third/yt-lower-third.html"
>

<CatalogSlot slot="code">

```html yt-lower-third.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
