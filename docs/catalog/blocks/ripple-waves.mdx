...
<CatalogDetail
  previewSrc="/public/catalog/blocks/ripple-waves.json"
  compositionId="ripple-waves"
  compositionSrc="compositions/ripple-waves.html"
  title="Ripple Waves"
  description="Shader transition with concentric ripple wave distortion"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/ripple-waves","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/ripple-waves/ripple-waves.html"
>

<CatalogSlot slot="code">

```html ripple-waves.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
