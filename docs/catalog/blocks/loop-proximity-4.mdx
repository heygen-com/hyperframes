---
title: "Loop Proximity 4"
description: "A field of image tiles swells as the camera passes over them. 8 image slots, 15s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-proximity-4" item="loop-proximity-4" />

That writes one file: `compositions/loop-proximity-4.html`.
...
```html index.html
<div
  data-composition-id="loop-proximity-4"
  data-composition-src="compositions/loop-proximity-4.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `count` | `100` | 0 to 1000, step 10 | Count (engine parameter; see the block header comment). |
| `tilt` | `6` | -180° to 180°, step 1° | Tilt (engine parameter; see the block header comment). |
| `sizeMix` | `100` | 0 to 200, step 1 | Size Mix (engine parameter; see the block header comment). |
| `minScale` | `43` | 0 to 86, step 1 | Min Scale (engine parameter; see the block header comment). |
| `maxScale` | `63` | 0 to 198, step 1 | Max Scale (engine parameter; see the block header comment). |
| `maxDist` | `5` | 0 to 86, step 1 | Max Dist (engine parameter; see the block header comment). |
| `atmosphere` | `0` | 0 to 100, step 1 | Atmosphere (engine parameter; see the block header comment). |
| `panRange` | `125` | 0 to 360, step 10 | Pan Range (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-proximity-4-bg"></div>
        <div id="loop-proximity-4-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-proximity-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-proximity-4-bg"));
        const stage = document.getElementById("loop-proximity-4-stage");
        ...
        window.__timelines["loop-proximity-4"] = tl;
      })();
    </script>
  </body>
</html>
