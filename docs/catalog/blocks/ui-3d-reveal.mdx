...
<CatalogDetail
  previewSrc="/public/catalog/blocks/ui-3d-reveal.json"
  compositionId="ui-3d-reveal"
  compositionSrc="compositions/ui-3d-reveal.html"
  title="3D UI Reveal"
  description="Perspective 3D reveal animation for UI elements"
  variables={[]}
  meta={{"duration":13,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":2764}}
  attribution={{"path":"registry/blocks/ui-3d-reveal","tags":["showcase","3d","reveal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/ui-3d-reveal/ui-3d-reveal.html"
>

<CatalogSlot slot="code">

```html ui-3d-reveal.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
