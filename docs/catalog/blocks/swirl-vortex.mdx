...
<CatalogDetail
  previewSrc="/public/catalog/blocks/swirl-vortex.json"
  compositionId="swirl-vortex"
  compositionSrc="compositions/swirl-vortex.html"
  title="Swirl Vortex"
  description="Shader transition with swirling vortex distortion"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":376}}
  attribution={{"path":"registry/blocks/swirl-vortex","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/swirl-vortex/swirl-vortex.html"
>

<CatalogSlot slot="code">

```html swirl-vortex.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
