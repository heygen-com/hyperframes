...
<iframe src="/public/catalog/preview/blocks/swirl-vortex.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Swirl Vortex preview" />

## Install

<InstallCommand command="npx hyperframes add swirl-vortex" />

That writes one file: `compositions/swirl-vortex.html`.

## Source

<Accordion title={`swirl-vortex.html`}>
