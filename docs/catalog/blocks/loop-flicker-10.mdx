---
title: "Loop Flicker 10"
description: "One centred image card at a time, hard-cut to the next on the beat. 8 image slots, 4s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-10.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-10.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-10" item="loop-flicker-10" />

That writes one file: `compositions/loop-flicker-10.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-10"
  data-composition-src="compositions/loop-flicker-10.html"
  data-start="0"
  data-duration="4"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `63` | 0 to 236, step 10 | Card size in scene units. |
| `scaleAmount` | `5` | 0 to 80, step 1 | Scale Amount (engine parameter; see the block header comment). |
| `driftAmount` | `40` | 0 to 200, step 1 | Drift Amount (engine parameter; see the block header comment). |
...
| `scaleDir` | `reverse` | `forward`, `reverse` | Scale Dir (engine parameter; see the block header comment). |
| `driftDir` | `left` | `up`, `down`, `left`, `right` | Drift Dir (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-10-bg"></div>
        <div id="loop-flicker-10-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-10-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-10-bg"));
        const stage = document.getElementById("loop-flicker-10-stage");
        ...
        window.__timelines["loop-flicker-10"] = tl;
      })();
    </script>
  </body>
</html>
