...
<iframe src="/public/catalog/preview/blocks/thread-message-stack.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Thread Message Stack preview" />
