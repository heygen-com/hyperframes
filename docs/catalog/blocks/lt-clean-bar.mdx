...
<CatalogDetail
  previewSrc="/public/catalog/blocks/lt-clean-bar.json"
  compositionId="lt-clean-bar"
  compositionSrc="compositions/lt-clean-bar.html"
  title="Lower Third — Clean Bar"
  description="Minimal white-card lower third for podcasts/interviews: accent tab, name + role, clip-wipe entrance"
  variables={[]}
  meta={{"duration":4.8,"width":1920,"height":1080,"category":"Lower Thirds","badge":"Stable","codeLines":111}}
  attribution={{"path":"registry/blocks/lt-clean-bar","tags":["lower-third","overlay","podcast","interview"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/lt-clean-bar/lt-clean-bar.html"
>

<CatalogSlot slot="code">

```html lt-clean-bar.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
