...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-3" item="loop-orbit-3" />

That writes one file: `compositions/loop-orbit-3.html`.
...
```html index.html
<div
  data-composition-id="loop-orbit-3"
  data-composition-src="compositions/loop-orbit-3.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `230` | 0 to 1024, step 10 | Card size in scene units. |
| `orbitRadius` | `485` | 0 to 1036, step 10 | Ring radius in scene units. |
...
| `perspective` | `140` | 0 to 280, step 10 | Camera focal length: smaller = stronger perspective. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-orbit-3-bg"></div>
        <div id="loop-orbit-3-stage"><div id="loop-orbit-3-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-orbit-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-orbit-3-bg"));
        const f = 1200 * (100 / PERSP) * s;
        document.getElementById("loop-orbit-3-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-orbit-3-world");
        ...
        window.__timelines["loop-orbit-3"] = tl;
      })();
    </script>
  </body>
</html>
