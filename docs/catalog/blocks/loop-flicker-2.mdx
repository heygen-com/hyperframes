---
title: "Loop Flicker 2"
description: "One centred image card at a time, hard-cut to the next on the beat. 8 image slots, 8s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-2" item="loop-flicker-2" />

That writes one file: `compositions/loop-flicker-2.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-2"
  data-composition-src="compositions/loop-flicker-2.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `73` | 0 to 236, step 10 | Card size in scene units. |
| `scaleAmount` | `30` | 0 to 80, step 1 | Scale Amount (engine parameter; see the block header comment). |
...
| `pacing` | `eased` | `equal`, `eased` | Pacing (engine parameter; see the block header comment). |
| `effect` | `off` | `off`, `scale`, `drift` | Effect (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-2-bg"></div>
        <div id="loop-flicker-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-2-bg"));
        const stage = document.getElementById("loop-flicker-2-stage");
        ...
        window.__timelines["loop-flicker-2"] = tl;
      })();
    </script>
  </body>
</html>
...
Tagged `loop` `images` `showcase` `gallery` `flicker`.
