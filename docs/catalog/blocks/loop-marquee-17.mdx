---
title: "Loop Marquee 17"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-17.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-17.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-17" item="loop-marquee-17" />

That writes one file: `compositions/loop-marquee-17.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-17"
  data-composition-src="compositions/loop-marquee-17.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `150` | 0 to 360, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-17-bg"></div>
        <div id="loop-marquee-17-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-17-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-17-bg"));
        const stage = document.getElementById("loop-marquee-17-stage");
        ...
        window.__timelines["loop-marquee-17"] = tl;
      })();
    </script>
  </body>
</html>
