...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-4" item="loop-flicker-4" />

That writes one file: `compositions/loop-flicker-4.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-4"
  data-composition-src="compositions/loop-flicker-4.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-flicker-4.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-4-bg"></div>
        <div id="loop-flicker-4-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-4-bg"));
        const stage = document.getElementById("loop-flicker-4-stage");
        ...
        window.__timelines["loop-flicker-4"] = tl;
      })();
    </script>
  </body>
</html>
