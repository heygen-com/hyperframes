...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-11.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-11.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-11" item="loop-carousel-11" />

That writes one file: `compositions/loop-carousel-11.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-11"
  data-composition-src="compositions/loop-carousel-11.html"
  data-start="0"
  data-duration="18"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `568` | 0 to 1700, step 10 | Card size in scene units. |
| `gap` | `235` | 0px to 1000px, step 10px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-11-bg"></div>
        <div id="loop-carousel-11-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-11-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-11-bg"));
        const stage = document.getElementById("loop-carousel-11-stage");
        ...
        window.__timelines["loop-carousel-11"] = tl;
      })();
    </script>
  </body>
</html>
