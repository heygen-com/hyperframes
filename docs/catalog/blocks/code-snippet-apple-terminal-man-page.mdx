...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-man-page.json"
  compositionId="code-snippet-apple-terminal-man-page"
  compositionSrc="compositions/code-snippet-apple-terminal-man-page.html"
  title="Code Snippet - Apple Terminal Man Page"
  description="Apple Terminal Man Page profile: pale yellow background with black text, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":248}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-man-page","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-man-page/code-snippet-apple-terminal-man-page.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-man-page.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
