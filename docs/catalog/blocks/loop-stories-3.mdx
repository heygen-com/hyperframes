...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-stories-3" item="loop-stories-3" />

That writes one file: `compositions/loop-stories-3.html`.
...
```html index.html
<div
  data-composition-id="loop-stories-3"
  data-composition-src="compositions/loop-stories-3.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `thumbAspect` | `1:1` | `1:1`, `3:4`, `4:3` | Thumb Aspect (engine parameter; see the block header comment). |
...
| `selectorPad` | `5.5` | 0 to 11, step 0.1 | Selector Pad (engine parameter; see the block header comment). |
| `selectorStroke` | `1.5` | 0 to 4, step 0.1 | Selector Stroke (engine parameter; see the block header comment). |
| `dimAmount` | `40` | 0 to 100, step 1 | Dim Amount (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-stories-3-bg"></div>
        <div id="loop-stories-3-big"></div>
        <div id="loop-stories-3-strip"><div id="loop-stories-3-panel"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-stories-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-stories-3-bg"));
        // big image layer: one <img> per image, cover-fitted, scaled by bigScale
        const big = document.getElementById("loop-stories-3-big");
        ...
        const strip = document.getElementById("loop-stories-3-strip");
        ...
        const CX = PW / 2,
          CY = PH / 2;
        const panel = document.getElementById("loop-stories-3-panel");
        if (COP > 0)
          panel.style.cssText =
        ...
        window.__timelines["loop-stories-3"] = tl;
      })();
    </script>
  </body>
</html>
