...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-morph.json"
  compositionId="code-morph"
  compositionSrc="compositions/code-morph.html"
  title="Code Morph"
  description="One snippet transforms into another — tokens glide between positions, leavers fade out, enterers fade in. Shiki Magic Move re-driven as a paused GSAP timeline."
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":1216}}
  attribution={{"path":"registry/blocks/code-morph","tags":["code","code-animation","morph","refactor","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-morph/code-morph.html"
>

<CatalogSlot slot="code">

```html code-morph.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
