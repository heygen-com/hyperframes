---
title: "Loop Pages 2"
description: "An open two-page spread; pages turn about the spine to reveal each image. 8 image slots, 12s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-pages-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-pages-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-pages-2" item="loop-pages-2" />

That writes one file: `compositions/loop-pages-2.html`.
...
```html index.html
<div
  data-composition-id="loop-pages-2"
  data-composition-src="compositions/loop-pages-2.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `stagger` | `1` | 0 to 10, step 0.1 | Stagger (engine parameter; see the block header comment). |
...
| `flipDuration` | `4` | 0 to 10, step 0.1 | Flip Duration (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-pages-2-bg"></div>
        <div id="loop-pages-2-stage"><div id="loop-pages-2-spread"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-pages-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-pages-2-bg"));
        const f = 1000 * (100 / PERSP) * (REF / 1080);
        document.getElementById("loop-pages-2-stage").style.perspective = f + "px";
        const spread = document.getElementById("loop-pages-2-spread");
        ...
        window.__timelines["loop-pages-2"] = tl;
      })();
    </script>
  </body>
</html>
