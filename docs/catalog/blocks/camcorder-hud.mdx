...
<CatalogDetail
  previewSrc="/public/catalog/blocks/camcorder-hud.json"
  compositionId="camcorder-hud"
  compositionSrc="compositions/camcorder-hud.html"
  title="Camcorder HUD"
  description="Responsive REC, battery, editable date placeholder, and timeline-driven counter overlay for creator-camera and camcorder treatments"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Camera","badge":"Stable","codeLines":163}}
  attribution={{"path":"registry/blocks/camcorder-hud","tags":["camcorder","camera","recording","hud","overlay","creator","media-treatment-overlay"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/camcorder-hud/camcorder-hud.html"
>

<CatalogSlot slot="code">

```html camcorder-hud.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
