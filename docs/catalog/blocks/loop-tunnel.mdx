...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-tunnel.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-tunnel.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-tunnel" item="loop-tunnel" />

That writes one file: `compositions/loop-tunnel.html`.
...
<div
  ...
  data-composition-src="compositions/loop-tunnel.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
| `backgroundColor` | `#08080b` | color | Flat colour when Type is Color; also the ground under an Image. |
...
| `scaleIntensity` | `0.9` | 0 to 1, step 0.05 | Strength of the size change. |
...
| `depthFade` | `0.45` | 0 to 2, step 0.01 | Depth Fade (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `tunnel` `3d`.
