---
title: "Loop Orbit 8"
description: "Image cards on a 3D ring, always parallel to the screen, orbit under a perspective camera. 8 image slots, 16s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-8.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-8.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-8" item="loop-orbit-8" />

That writes one file: `compositions/loop-orbit-8.html`.
...
```html index.html
<div
  data-composition-id="loop-orbit-8"
  data-composition-src="compositions/loop-orbit-8.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `235` | 0 to 1024, step 10 | Card size in scene units. |
| `orbitRadius` | `511` | 0 to 1036, step 10 | Ring radius in scene units. |
| `rotationX` | `90` | -180° to 180°, step 1° | Formation tilt about the horizontal axis, degrees. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-orbit-8-bg"></div>
        <div id="loop-orbit-8-stage"><div id="loop-orbit-8-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-orbit-8-loop").dataset.duration = DUR;
        background(document.getElementById("loop-orbit-8-bg"));
        const f = 1200 * (100 / PERSP) * s;
        document.getElementById("loop-orbit-8-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-orbit-8-world");
        ...
        window.__timelines["loop-orbit-8"] = tl;
      })();
    </script>
  </body>
</html>
