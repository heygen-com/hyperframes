...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-6.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-6.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-6" item="loop-orbit-6" />

That writes one file: `compositions/loop-orbit-6.html`.
...
```html index.html
<div
  data-composition-id="loop-orbit-6"
  data-composition-src="compositions/loop-orbit-6.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `rotationZ` | `306` | -180° to 180°, step 1° | Formation roll about the view axis, degrees. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-orbit-6-bg"></div>
        <div id="loop-orbit-6-stage"><div id="loop-orbit-6-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-orbit-6-loop").dataset.duration = DUR;
        background(document.getElementById("loop-orbit-6-bg"));
        const f = 1200 * (100 / PERSP) * s;
        document.getElementById("loop-orbit-6-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-orbit-6-world");
        ...
        window.__timelines["loop-orbit-6"] = tl;
      })();
    </script>
  </body>
</html>
