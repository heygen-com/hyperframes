...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-basic.json"
  compositionId="code-snippet-apple-terminal-basic"
  compositionSrc="compositions/code-snippet-apple-terminal-basic.html"
  title="Code Snippet - Apple Terminal Basic"
  description="Apple Terminal Basic profile: white background, black text, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":249}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-basic","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-basic/code-snippet-apple-terminal-basic.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-basic.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
