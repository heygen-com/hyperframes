---
title: "Loop Marquee 21"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 19s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-21.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-21.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-21" item="loop-marquee-21" />

That writes one file: `compositions/loop-marquee-21.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-21"
  data-composition-src="compositions/loop-marquee-21.html"
  data-start="0"
  data-duration="19"
  data-track-index="1"
  data-width="1080"
...
| `gap` | `5` | 0px to 84px, step 1px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-21-bg"></div>
        <div id="loop-marquee-21-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-21-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-21-bg"));
        const stage = document.getElementById("loop-marquee-21-stage");
        ...
        window.__timelines["loop-marquee-21"] = tl;
      })();
    </script>
  </body>
</html>
