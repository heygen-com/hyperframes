...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-4" item="loop-orbit-4" />

That writes one file: `compositions/loop-orbit-4.html`.
...
```html index.html
<div
  data-composition-id="loop-orbit-4"
  data-composition-src="compositions/loop-orbit-4.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-orbit-4.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-orbit-4-bg"></div>
        <div id="loop-orbit-4-stage"><div id="loop-orbit-4-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-orbit-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-orbit-4-bg"));
        const f = 1200 * (100 / PERSP) * s;
        document.getElementById("loop-orbit-4-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-orbit-4-world");
        ...
        window.__timelines["loop-orbit-4"] = tl;
      })();
    </script>
  </body>
</html>
