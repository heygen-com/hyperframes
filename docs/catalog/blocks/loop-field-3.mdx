---
title: "Loop Field 3"
description: "A field of image cards drifts past the camera in true perspective. 8 image slots, 15s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-field-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-field-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-field-3" item="loop-field-3" />

That writes one file: `compositions/loop-field-3.html`.
...
```html index.html
<div
  data-composition-id="loop-field-3"
  data-composition-src="compositions/loop-field-3.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `count` | `40` | 0 to 100, step 1 | Count (engine parameter; see the block header comment). |
...
| `farZ` | `10000` | 0 to 29900, step 10 | Far Z (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-field-3-bg"></div>
        <div id="loop-field-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-field-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-field-3-bg"));
        const stage = document.getElementById("loop-field-3-stage");
        ...
        window.__timelines["loop-field-3"] = tl;
      })();
    </script>
  </body>
</html>
