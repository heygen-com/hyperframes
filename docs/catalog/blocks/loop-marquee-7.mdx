---
title: "Loop Marquee 7"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 11s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-7.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-7.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-7" item="loop-marquee-7" />

That writes one file: `compositions/loop-marquee-7.html`.

## Add it to your video

It runs for 11 seconds at 1080×1080. Paste this into your composition:

```html index.html
<div
  data-composition-id="loop-marquee-7"
  data-composition-src="compositions/loop-marquee-7.html"
  data-start="0"
  data-duration="11"
  data-track-index="1"
  data-width="1080"
...
| `stagger` | `5` | 0 to 10, step 0.1 | Stagger (engine parameter; see the block header comment). |
...
| `planeSize` | `115` | 0 to 360, step 10 | Card size in scene units. |
| `gap` | `42` | 0px to 84px, step 1px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-7-bg"></div>
        <div id="loop-marquee-7-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-7-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-7-bg"));
        const stage = document.getElementById("loop-marquee-7-stage");
        ...
        window.__timelines["loop-marquee-7"] = tl;
      })();
    </script>
  </body>
</html>
