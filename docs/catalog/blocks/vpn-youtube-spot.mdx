...
<iframe src="/public/catalog/preview/blocks/vpn-youtube-spot.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="VPN YouTube Spot preview" />

## Install

<InstallCommand command="npx hyperframes add vpn-youtube-spot" />
