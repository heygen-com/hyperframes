...
<CatalogDetail
  previewSrc="/public/catalog/blocks/vpn-youtube-spot.json"
  compositionId="vpn-youtube-spot"
  compositionSrc="compositions/vpn-youtube-spot.html"
  title="VPN YouTube Spot"
  description="Snappy Apple-style YouTube insert showing a phone finding and installing a friendly VPN app with sound effects."
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":987}}
  attribution={{"author":"Stronkter","authorUrl":"https://x.com/Stronkter","path":"registry/blocks/vpn-youtube-spot","tags":["app","showcase","youtube","sfx"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/vpn-youtube-spot/vpn-youtube-spot.html"
>

<CatalogSlot slot="code">

```html vpn-youtube-spot.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
