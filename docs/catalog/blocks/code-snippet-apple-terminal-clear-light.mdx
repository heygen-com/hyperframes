...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-clear-light.json"
  compositionId="code-snippet-apple-terminal-clear-light"
  compositionSrc="compositions/code-snippet-apple-terminal-clear-light.html"
  title="Code Snippet - Apple Terminal Clear Light"
  description="Apple Terminal Clear Light profile: semi-transparent light background, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":244}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-clear-light","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-clear-light/code-snippet-apple-terminal-clear-light.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-clear-light.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
