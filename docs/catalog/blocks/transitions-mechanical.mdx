...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-mechanical.json"
  compositionId="transitions-mechanical"
  compositionSrc="compositions/transitions-mechanical.html"
  title="Mechanical Transitions"
  description="Showcase of mechanical shutter and iris transitions"
  variables={[]}
  meta={{"duration":15,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":423}}
  attribution={{"path":"registry/blocks/transitions-mechanical","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-mechanical/transitions-mechanical.html"
>

<CatalogSlot slot="code">

```html transitions-mechanical.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
