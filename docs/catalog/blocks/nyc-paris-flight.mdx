...
<CatalogDetail
  previewSrc="/public/catalog/blocks/nyc-paris-flight.json"
  compositionId="nyc-paris-flight"
  compositionSrc="compositions/nyc-paris-flight.html"
  title="NYC Paris Flight"
  description="Apple-style realistic map animation with a plane flying from New York to Paris, marker circle, landing pop, and sound effects."
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":525}}
  attribution={{"author":"Stronkter","authorUrl":"https://x.com/Stronkter","path":"registry/blocks/nyc-paris-flight","tags":["showcase","travel","map","youtube","sfx"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/nyc-paris-flight/nyc-paris-flight.html"
>

<CatalogSlot slot="code">

```html nyc-paris-flight.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
