...
<CatalogDetail
  previewSrc="/public/catalog/blocks/glitch.json"
  compositionId="glitch"
  compositionSrc="compositions/glitch.html"
  title="Glitch"
  description="Shader transition with digital glitch artifacts"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/glitch","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/glitch/glitch.html"
>
