...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-6.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-6.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-6" item="loop-flicker-6" />

That writes one file: `compositions/loop-flicker-6.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-6"
  data-composition-src="compositions/loop-flicker-6.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `driftAmount` | `80` | 0 to 200, step 1 | Drift Amount (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-6-bg"></div>
        <div id="loop-flicker-6-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-6-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-6-bg"));
        const stage = document.getElementById("loop-flicker-6-stage");
        ...
        window.__timelines["loop-flicker-6"] = tl;
      })();
    </script>
  </body>
</html>
