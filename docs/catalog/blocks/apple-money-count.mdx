...
<CatalogDetail
  previewSrc="/public/catalog/blocks/apple-money-count.json"
  compositionId="apple-money-count"
  compositionSrc="compositions/apple-money-count.html"
  title="Apple Money Count"
  description="Apple-style finance counter that counts from $0 to $10,000, flashes green, and bursts money icons with sound."
  variables={[]}
  meta={{"duration":5,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":320}}
  attribution={{"author":"Stronkter","authorUrl":"https://x.com/Stronkter","path":"registry/blocks/apple-money-count","tags":["showcase","finance","kinetic","youtube","sfx"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/apple-money-count/apple-money-count.html"
>

<CatalogSlot slot="code">

```html apple-money-count.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
