...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-gravity-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-gravity-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-gravity-2" item="loop-gravity-2" />

That writes one file: `compositions/loop-gravity-2.html`.
...
```html index.html
<div
  data-composition-id="loop-gravity-2"
  data-composition-src="compositions/loop-gravity-2.html"
  data-start="0"
  data-duration="7"
  data-track-index="1"
  data-width="1080"
...
| `stagger` | `0.18` | 0 to 2, step 0.01 | Stagger (engine parameter; see the block header comment). |
| `cardSize` | `230` | 0 to 820, step 10 | Card Size (engine parameter; see the block header comment). |
...
| `spin` | `0.03` | 0 to 2, step 0.01 | Spin (engine parameter; see the block header comment). |
| `tilt` | `18` | -180° to 180°, step 1° | Tilt (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-gravity-2-bg"></div>
        <div id="loop-gravity-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-gravity-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-gravity-2-bg"));
        const stage = document.getElementById("loop-gravity-2-stage");
        ...
        window.__timelines["loop-gravity-2"] = tl;
      })();
    </script>
  </body>
</html>
