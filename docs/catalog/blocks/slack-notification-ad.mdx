...
<CatalogDetail
  previewSrc="/public/catalog/blocks/slack-notification-ad.json"
  compositionId="slack-notification-ad"
  compositionSrc="compositions/slack-notification-ad.html"
  title="Slack Notification Ad"
  description="A portrait lock screen fills with escalating Slack video requests before HeyGen delivers the payoff"
  variables={[]}
  meta={{"duration":12,"width":1080,"height":1920,"category":"Showcases","badge":"Stable","codeLines":710}}
  attribution={{"author":"HeyGen","path":"registry/blocks/slack-notification-ad","tags":["showcase","mock-ui","notification","vertical","ad-template"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/slack-notification-ad/slack-notification-ad.html"
>

<CatalogSlot slot="code">

```html slack-notification-ad.html
<!doctype html>
<html
  lang="en"
  ...
  data-composition-variables='[
    ...
    { "id": "payoffTitle", "type": "string", "role": "content", "label": "Payoff sender", "description": "Sender of the final payoff notification: the brand this video promotes, by its real name.", "portrays": ["subject_name", "recommended_position"], "default": "HeyGen" },
    { "id": "payoffText", "type": "string", "role": "content", "label": "Payoff message", "description": "Payoff message from the brand this video promotes.", "default": "Heard you needed some videos?" },
    { "id": "payoffIcon", "type": "image", "role": "content", "label": "Payoff logo", "description": "Mark of the brand this video promotes, shown only in the final payoff notification.", "portrays": ["subject_logo"], "default": "assets/img/heygen-mark.svg" }
  ]'
>
  <head>
    <meta charset="UTF-8" />
