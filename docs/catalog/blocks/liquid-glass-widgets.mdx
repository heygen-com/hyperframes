...
<CatalogDetail
  previewSrc="/public/catalog/blocks/liquid-glass-widgets.json"
  compositionId="liquid-glass-widgets"
  compositionSrc="compositions/liquid-glass-widgets.html"
  title="Liquid Glass Widgets"
  description="Frosted glass stat cards, showcase panel and pill chips over an aurora shader background"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":763}}
  attribution={{"path":"registry/blocks/liquid-glass-widgets","tags":["html-in-canvas","liquid-glass-html-in-canvas","webgpu"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/liquid-glass-widgets/liquid-glass-widgets.html"
>

<CatalogSlot slot="code">

```html liquid-glass-widgets.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
