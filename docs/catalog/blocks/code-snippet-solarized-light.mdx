...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-solarized-light.json"
  compositionId="code-snippet-solarized-light"
  compositionSrc="compositions/code-snippet-solarized-light.html"
  title="Code Snippet - Solarized Light"
  description="VS Code workbench with per-character typing animation in the Solarized Light theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1070}}
  attribution={{"path":"registry/blocks/code-snippet-solarized-light","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-solarized-light/code-snippet-solarized-light.html"
>

<CatalogSlot slot="code">

```html code-snippet-solarized-light.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Solarized Light VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-solarized-light-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Solarized Light</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">solarized-light-color-theme.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-solarized-light"] =
            window.__timelines["vscode-solarized-light"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-solarized-light", {
            id: "solarized-light",
