...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-grid-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-grid-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-grid-3" item="loop-grid-3" />

That writes one file: `compositions/loop-grid-3.html`.
...
```html index.html
<div
  data-composition-id="loop-grid-3"
  data-composition-src="compositions/loop-grid-3.html"
  data-start="0"
  data-duration="20"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-grid-3-bg"></div>
        <div id="loop-grid-3-stage"><div id="loop-grid-3-plane"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-grid-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-grid-3-bg"));
        ...
        const plane = document.getElementById("loop-grid-3-plane");
        ...
        const stage = document.getElementById("loop-grid-3-stage");
        function renderAt(t) {
        ...
        window.__timelines["loop-grid-3"] = tl;
      })();
    </script>
  </body>
</html>
