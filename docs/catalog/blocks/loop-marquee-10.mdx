---
title: "Loop Marquee 10"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-10.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-10.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-10" item="loop-marquee-10" />

That writes one file: `compositions/loop-marquee-10.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-10"
  data-composition-src="compositions/loop-marquee-10.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
| `gap` | `25` | 0px to 84px, step 1px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-10-bg"></div>
        <div id="loop-marquee-10-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-10-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-10-bg"));
        const stage = document.getElementById("loop-marquee-10-stage");
        ...
        window.__timelines["loop-marquee-10"] = tl;
      })();
    </script>
  </body>
</html>
