...
<CatalogDetail
  previewSrc="/public/catalog/blocks/liquid-glass-context-menu.json"
  compositionId="liquid-glass-context-menu"
  compositionSrc="compositions/liquid-glass-context-menu.html"
  title="Liquid Glass Context Menu"
  description="Frosted glass context menu panel drifting over an aurora shader background"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":627}}
  attribution={{"path":"registry/blocks/liquid-glass-context-menu","tags":["html-in-canvas","liquid-glass-html-in-canvas","webgpu"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/liquid-glass-context-menu/liquid-glass-context-menu.html"
>

<CatalogSlot slot="code">

```html liquid-glass-context-menu.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
