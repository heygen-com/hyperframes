...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-stories-4" item="loop-stories-4" />

That writes one file: `compositions/loop-stories-4.html`.
...
```html index.html
<div
  data-composition-id="loop-stories-4"
  data-composition-src="compositions/loop-stories-4.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `direction` | `right` | `right`, `left`, `down`, `up` | Direction of travel. |
...
| `thumbSize` | `85` | 0 to 200, step 1 | Thumb Size (engine parameter; see the block header comment). |
| `containerOpacity` | `0` | 0 to 80, step 1 | Container Opacity (engine parameter; see the block header comment). |
| `containerBlur` | `0` | 0 to 120, step 1 | Container Blur (engine parameter; see the block header comment). |
| `selectorPad` | `0` | 0 to 11, step 0.1 | Selector Pad (engine parameter; see the block header comment). |
| `selectorStroke` | `0` | 0 to 4, step 0.1 | Selector Stroke (engine parameter; see the block header comment). |
| `dimAmount` | `50` | 0 to 100, step 1 | Dim Amount (engine parameter; see the block header comment). |
| `offsetX` | `0` | -100% to 100%, step 1% | Horizontal offset of the formation, % of width. |
| `offsetY` | `30` | -100% to 100%, step 1% | Vertical offset of the formation, % of height. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-stories-4-bg"></div>
        <div id="loop-stories-4-big"></div>
        <div id="loop-stories-4-strip"><div id="loop-stories-4-panel"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-stories-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-stories-4-bg"));
        // big image layer: one <img> per image, cover-fitted, scaled by bigScale
        const big = document.getElementById("loop-stories-4-big");
        ...
        const strip = document.getElementById("loop-stories-4-strip");
        ...
        const CX = PW / 2,
          CY = PH / 2;
        const panel = document.getElementById("loop-stories-4-panel");
        if (COP > 0)
          panel.style.cssText =
        ...
        window.__timelines["loop-stories-4"] = tl;
      })();
    </script>
  </body>
</html>
