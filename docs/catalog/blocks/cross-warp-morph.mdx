...
<CatalogDetail
  previewSrc="/public/catalog/blocks/cross-warp-morph.json"
  compositionId="cross-warp-morph"
  compositionSrc="compositions/cross-warp-morph.html"
  title="Cross Warp Morph"
  description="Shader transition with cross-warped morphing"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":377}}
  attribution={{"path":"registry/blocks/cross-warp-morph","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/cross-warp-morph/cross-warp-morph.html"
>

<CatalogSlot slot="code">

```html cross-warp-morph.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
