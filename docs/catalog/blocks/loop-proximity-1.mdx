...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-proximity-1" item="loop-proximity-1" />

That writes one file: `compositions/loop-proximity-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-proximity-1.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
| `maxDist` | `35` | 0 to 86, step 1 | Max Dist (engine parameter; see the block header comment). |
| `atmosphere` | `0` | 0 to 100, step 1 | Atmosphere (engine parameter; see the block header comment). |
| `panRange` | `100` | 0 to 360, step 10 | Pan Range (engine parameter; see the block header comment). |
| `buildInOut` | `on` | `off`, `on` | Build In Out (engine parameter; see the block header comment). |
