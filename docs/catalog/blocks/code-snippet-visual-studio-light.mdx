...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-visual-studio-light.json"
  compositionId="code-snippet-visual-studio-light"
  compositionSrc="compositions/code-snippet-visual-studio-light.html"
  title="Code Snippet - Visual Studio Light"
  description="VS Code workbench with per-character typing animation in the Visual Studio Light theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1056}}
  attribution={{"path":"registry/blocks/code-snippet-visual-studio-light","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-visual-studio-light/code-snippet-visual-studio-light.html"
>

<CatalogSlot slot="code">

```html code-snippet-visual-studio-light.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Visual Studio Light VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-visual-studio-light-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Visual Studio Light</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">light_vs.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-visual-studio-light"] =
            window.__timelines["vscode-visual-studio-light"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-visual-studio-light", {
