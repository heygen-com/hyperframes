---
title: "Loop Marquee 3"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 5s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-3" item="loop-marquee-3" />

That writes one file: `compositions/loop-marquee-3.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-3"
  data-composition-src="compositions/loop-marquee-3.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-marquee-3.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-3-bg"></div>
        <div id="loop-marquee-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-3-bg"));
        const stage = document.getElementById("loop-marquee-3-stage");
        ...
        window.__timelines["loop-marquee-3"] = tl;
      })();
    </script>
  </body>
</html>
