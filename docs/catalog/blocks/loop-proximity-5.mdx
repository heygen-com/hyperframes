---
title: "Loop Proximity 5"
description: "A field of image tiles swells as the camera passes over them. 8 image slots, 14s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-5.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-5.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-proximity-5" item="loop-proximity-5" />

That writes one file: `compositions/loop-proximity-5.html`.
...
```html index.html
<div
  data-composition-id="loop-proximity-5"
  data-composition-src="compositions/loop-proximity-5.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
| `minScale` | `0` | 0 to 86, step 1 | Min Scale (engine parameter; see the block header comment). |
| `maxScale` | `99` | 0 to 198, step 1 | Max Scale (engine parameter; see the block header comment). |
| `maxDist` | `32` | 0 to 86, step 1 | Max Dist (engine parameter; see the block header comment). |
| `atmosphere` | `0` | 0 to 100, step 1 | Atmosphere (engine parameter; see the block header comment). |
| `panRange` | `180` | 0 to 360, step 10 | Pan Range (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-proximity-5-bg"></div>
        <div id="loop-proximity-5-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-proximity-5-loop").dataset.duration = DUR;
        background(document.getElementById("loop-proximity-5-bg"));
        const stage = document.getElementById("loop-proximity-5-stage");
        ...
        window.__timelines["loop-proximity-5"] = tl;
      })();
    </script>
  </body>
</html>
