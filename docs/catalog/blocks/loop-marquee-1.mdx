...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-1" item="loop-marquee-1" />

That writes one file: `compositions/loop-marquee-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-marquee-1.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-marquee-1.html`}>
