...
<iframe src="/public/catalog/preview/blocks/transitions-distortion.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Distortion Transitions preview" />

## Install

<InstallCommand command="npx hyperframes add transitions-distortion" />

That writes one file: `compositions/transitions-distortion.html`.

## Source

<Accordion title={`transitions-distortion.html`}>
