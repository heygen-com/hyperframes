---
title: "Loop 3D Ring 4"
description: "Image cards ring a vertical axis facing outward while the ring spins under a 3D camera. 8 image slots, 15s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-3d-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-3d-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-3d-4" item="loop-3d-4" />

That writes one file: `compositions/loop-3d-4.html`.
...
```html index.html
<div
  data-composition-id="loop-3d-4"
  data-composition-src="compositions/loop-3d-4.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `1566` | 0 to 8120, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-3d-4-bg"></div>
        <div id="loop-3d-4-stage">
          <div id="loop-3d-4-ring"><div id="loop-3d-4-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-3d-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-3d-4-bg"));

        const f = 1000 * (100 / PERSP) * (REF / 1080); // CSS focal length, px
        const s = f / Math.max(D, R, 1); // world -> px (ring centre or ring at z=0)
        const Rpx = R * s,
          Dpx = D * s;
        const stage = document.getElementById("loop-3d-4-stage");
        stage.style.perspective = f + "px";
        const ring = document.getElementById("loop-3d-4-ring");
        ...
        const spin = document.getElementById("loop-3d-4-spin");
        ...
        window.__timelines["loop-3d-4"] = tl;
      })();
    </script>
  </body>
</html>
