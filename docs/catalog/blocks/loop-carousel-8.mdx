...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-8.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-8.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-8" item="loop-carousel-8" />

That writes one file: `compositions/loop-carousel-8.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-8"
  data-composition-src="compositions/loop-carousel-8.html"
  data-start="0"
  data-duration="18"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `642` | 0 to 1700, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-8-bg"></div>
        <div id="loop-carousel-8-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-8-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-8-bg"));
        const stage = document.getElementById("loop-carousel-8-stage");
        ...
        window.__timelines["loop-carousel-8"] = tl;
      })();
    </script>
  </body>
</html>
