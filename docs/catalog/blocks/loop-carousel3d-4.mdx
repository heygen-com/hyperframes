---
title: "Loop Carousel 3D 4"
description: "Radial image panes spin around a vertical axis like a paddle wheel under a 3D camera. 8 image slots, 12s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel3d-4" item="loop-carousel3d-4" />

That writes one file: `compositions/loop-carousel3d-4.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel3d-4"
  data-composition-src="compositions/loop-carousel3d-4.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `410` | 0 to 820, step 10 | Card size in scene units. |
| `orbitRadius` | `210` | 0 to 960, step 10 | Ring radius in scene units. |
| `distance` | `1250` | 0 to 3740, step 10 | Camera distance from the formation. |
...
| `offsetX` | `50.5` | -100% to 100%, step 1% | Horizontal offset of the formation, % of width. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel3d-4-bg"></div>
        <div id="loop-carousel3d-4-stage">
          <div id="loop-carousel3d-4-ring"><div id="loop-carousel3d-4-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel3d-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel3d-4-bg"));
        ...
        const Rpx = R * s;
        document.getElementById("loop-carousel3d-4-stage").style.perspective = f + "px";
        document.getElementById("loop-carousel3d-4-ring").style.transform =
          `translate3d(${(OX / 100) * W}px,${(OY / 100) * H}px,0) rotateX(${RX}deg) rotateY(${RY}deg) rotateZ(${RZ}deg)`;
        const spin = document.getElementById("loop-carousel3d-4-spin");
        for (let i = 0; i < N; i++) {
          const m = IMAGES[i],
        ...
        window.__timelines["loop-carousel3d-4"] = tl;
      })();
    </script>
  </body>
</html>
