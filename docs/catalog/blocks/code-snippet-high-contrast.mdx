...
<iframe src="/public/catalog/preview/blocks/code-snippet-high-contrast.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - High Contrast preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-high-contrast" />

That writes `compositions/code-snippet-high-contrast.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-high-contrast.html`}>
