...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-high-contrast.json"
  compositionId="code-snippet-high-contrast"
  compositionSrc="compositions/code-snippet-high-contrast.html"
  title="Code Snippet - High Contrast"
  description="VS Code workbench with per-character typing animation in the High Contrast theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1054}}
  attribution={{"path":"registry/blocks/code-snippet-high-contrast","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-high-contrast/code-snippet-high-contrast.html"
>

<CatalogSlot slot="code">

```html code-snippet-high-contrast.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Default High Contrast VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-high-contrast-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Default High Contrast</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">hc_black.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-high-contrast"] =
            window.__timelines["vscode-high-contrast"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-high-contrast", {
            id: "high-contrast",
