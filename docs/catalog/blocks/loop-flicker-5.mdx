...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-5.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-5.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-5" item="loop-flicker-5" />

That writes one file: `compositions/loop-flicker-5.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-5"
  data-composition-src="compositions/loop-flicker-5.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `107` | 0 to 236, step 10 | Card size in scene units. |
| `scaleAmount` | `30` | 0 to 80, step 1 | Scale Amount (engine parameter; see the block header comment). |
| `driftAmount` | `7` | 0 to 200, step 1 | Drift Amount (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-5-bg"></div>
        <div id="loop-flicker-5-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-5-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-5-bg"));
        const stage = document.getElementById("loop-flicker-5-stage");
        ...
        window.__timelines["loop-flicker-5"] = tl;
      })();
    </script>
  </body>
</html>
