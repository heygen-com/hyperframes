...
<CatalogDetail
  previewSrc="/public/catalog/blocks/gravitational-lens.json"
  compositionId="gravitational-lens"
  compositionSrc="compositions/gravitational-lens.html"
  title="Gravitational Lens"
  description="Shader transition with gravitational lensing distortion"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":365}}
  attribution={{"path":"registry/blocks/gravitational-lens","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/gravitational-lens/gravitational-lens.html"
>

<CatalogSlot slot="code">

```html gravitational-lens.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
