...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-7.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-7.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-7" item="loop-flicker-7" />

That writes one file: `compositions/loop-flicker-7.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-7"
  data-composition-src="compositions/loop-flicker-7.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `driftAmount` | `100` | 0 to 200, step 1 | Drift Amount (engine parameter; see the block header comment). |
...
| `effect` | `drift` | `off`, `scale`, `drift` | Effect (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-7-bg"></div>
        <div id="loop-flicker-7-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-7-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-7-bg"));
        const stage = document.getElementById("loop-flicker-7-stage");
        ...
        window.__timelines["loop-flicker-7"] = tl;
      })();
    </script>
  </body>
</html>
