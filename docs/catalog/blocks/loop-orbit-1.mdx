...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-orbit-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-orbit-1" item="loop-orbit-1" />

That writes one file: `compositions/loop-orbit-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-orbit-1.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `orbitRadius` | `420` | 0 to 1036, step 10 | Ring radius in scene units. |
