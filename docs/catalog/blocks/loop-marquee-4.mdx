---
title: "Loop Marquee 4"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 5s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-4" item="loop-marquee-4" />

That writes one file: `compositions/loop-marquee-4.html`.

## Add it to your video

It runs for 5 seconds at 1080×1080. Paste this into your composition:

```html index.html
<div
  data-composition-id="loop-marquee-4"
  data-composition-src="compositions/loop-marquee-4.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-4-bg"></div>
        <div id="loop-marquee-4-stage"></div>
      </div>
    </div>
    <script>
      ...
      (async () => {
        ...
        const __V = Object.assign(
          ...
          (window.__hyperframes && window.__hyperframes.getVariables
            ...
            : null) || {},
          { loopDuration: 5, loopRepeat: 2, imageCount: 8 },
        );
        const __PH = [
        ...
        document.getElementById("loop-marquee-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-4-bg"));
        const stage = document.getElementById("loop-marquee-4-stage");
        ...
        window.__timelines["loop-marquee-4"] = tl;
      })();
    </script>
  </body>
</html>
