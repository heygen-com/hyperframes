...
<CatalogDetail
  previewSrc="/public/catalog/blocks/lt-color-block.json"
  compositionId="lt-color-block"
  compositionSrc="compositions/lt-color-block.html"
  title="Lower Third — Color Block"
  description="High-energy lower third: bold accent-color block slides in with overshoot, condensed name + mono role"
  variables={[]}
  meta={{"duration":4.8,"width":1920,"height":1080,"category":"Lower Thirds","badge":"Stable","codeLines":100}}
  attribution={{"path":"registry/blocks/lt-color-block","tags":["lower-third","overlay","podcast","interview","bold"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/lt-color-block/lt-color-block.html"
>

<CatalogSlot slot="code">

```html lt-color-block.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
