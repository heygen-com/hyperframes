...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-light.json"
  compositionId="transitions-light"
  compositionSrc="compositions/transitions-light.html"
  title="Light Transitions"
  description="Showcase of light-based glow and flash transitions"
  variables={[]}
  meta={{"duration":21,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":391}}
  attribution={{"path":"registry/blocks/transitions-light","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-light/transitions-light.html"
>

<CatalogSlot slot="code">

```html transitions-light.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
