...
<CatalogDetail
  compositionId="macos-tahoe-liquid-glass"
  compositionSrc="compositions/macos-tahoe-liquid-glass.html"
  title="macOS Tahoe Liquid Glass Desktop"
  description="3D MacBook with a macOS Tahoe-style desktop, glass menu bar, Finder window, dock, and cinematic device camera move."
  variables={[]}
  meta={{"duration":15,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":1461}}
  attribution={{"path":"registry/blocks/macos-tahoe-liquid-glass","tags":["html-in-canvas","3d","macos","tahoe","gltf"]}}
  ...
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/macos-tahoe-liquid-glass/macos-tahoe-liquid-glass.html"
>

<CatalogSlot slot="code">

```html macos-tahoe-liquid-glass.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
