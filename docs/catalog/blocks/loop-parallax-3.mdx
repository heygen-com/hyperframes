---
title: "Loop Parallax 3"
description: "Image cards scattered in a 3D slab drift with parallax under a moving camera. 8 image slots, 16s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-parallax-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-parallax-3" item="loop-parallax-3" />

That writes one file: `compositions/loop-parallax-3.html`.
...
```html index.html
<div
  data-composition-id="loop-parallax-3"
  data-composition-src="compositions/loop-parallax-3.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `fade` | `80` | 0 to 100, step 1 | Fade (engine parameter; see the block header comment). |
| `count` | `140` | 0 to 400, step 10 | Count (engine parameter; see the block header comment). |
| `planeSize` | `240` | 0 to 680, step 10 | Card size in scene units. |
| `spread` | `180` | 0 to 600, step 10 | Spread (engine parameter; see the block header comment). |
| `travel` | `100` | 0 to 600, step 10 | Travel (engine parameter; see the block header comment). |
| `depth` | `60` | 0 to 200, step 1 | Depth (engine parameter; see the block header comment). |
| `seed` | `10` | 0 to 20, step 0.1 | Seed (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-parallax-3-bg"></div>
        <div id="loop-parallax-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-parallax-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-parallax-3-bg"));
        const stage = document.getElementById("loop-parallax-3-stage");
        ...
        window.__timelines["loop-parallax-3"] = tl;
      })();
    </script>
  </body>
</html>
...
Tagged `loop` `images` `showcase` `gallery` `parallax` `3d`.
