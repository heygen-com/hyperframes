...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-scroll.json"
  compositionId="code-scroll"
  compositionSrc="compositions/code-scroll.html"
  title="Code Scroll To Line"
  description="The camera scrolls a long file to bring a target line to center and spotlights it — for walking through real modules."
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Code Animations","badge":"Stable","codeLines":1560}}
  attribution={{"path":"registry/blocks/code-scroll","tags":["code","code-animation","scroll","developer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-scroll/code-scroll.html"
>

<CatalogSlot slot="code">

```html code-scroll.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
