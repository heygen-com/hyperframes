...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-globe-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-globe-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-globe-1" item="loop-globe-1" />

That writes one file: `compositions/loop-globe-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-globe-1.html"
  data-start="0"
  data-duration="7"
  data-track-index="1"
  data-width="1080"
...
| `radius` | `355` | 0 to 1780, step 10 | Radius (engine parameter; see the block header comment). |
