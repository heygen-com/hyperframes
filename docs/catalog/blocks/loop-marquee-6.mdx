---
title: "Loop Marquee 6"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-6.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-6.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-6" item="loop-marquee-6" />

That writes one file: `compositions/loop-marquee-6.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-6"
  data-composition-src="compositions/loop-marquee-6.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `160` | 0 to 360, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-6-bg"></div>
        <div id="loop-marquee-6-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-6-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-6-bg"));
        const stage = document.getElementById("loop-marquee-6-stage");
        ...
        window.__timelines["loop-marquee-6"] = tl;
      })();
    </script>
  </body>
</html>
