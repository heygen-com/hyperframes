---
title: "Loop Proximity 3"
description: "A field of image tiles swells as the camera passes over them. 8 image slots, 16s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-proximity-3" item="loop-proximity-3" />

That writes one file: `compositions/loop-proximity-3.html`.
...
```html index.html
<div
  data-composition-id="loop-proximity-3"
  data-composition-src="compositions/loop-proximity-3.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `sizeMix` | `50` | 0 to 200, step 1 | Size Mix (engine parameter; see the block header comment). |
| `minScale` | `8` | 0 to 86, step 1 | Min Scale (engine parameter; see the block header comment). |
| `maxScale` | `63` | 0 to 198, step 1 | Max Scale (engine parameter; see the block header comment). |
| `maxDist` | `41` | 0 to 86, step 1 | Max Dist (engine parameter; see the block header comment). |
| `atmosphere` | `50` | 0 to 100, step 1 | Atmosphere (engine parameter; see the block header comment). |
| `panRange` | `145` | 0 to 360, step 10 | Pan Range (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-proximity-3-bg"></div>
        <div id="loop-proximity-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-proximity-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-proximity-3-bg"));
        const stage = document.getElementById("loop-proximity-3-stage");
        ...
        window.__timelines["loop-proximity-3"] = tl;
      })();
    </script>
  </body>
</html>
