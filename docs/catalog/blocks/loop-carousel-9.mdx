...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-9.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-9.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-9" item="loop-carousel-9" />

That writes one file: `compositions/loop-carousel-9.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-9"
  data-composition-src="compositions/loop-carousel-9.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `600` | 0 to 1700, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-9-bg"></div>
        <div id="loop-carousel-9-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-9-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-9-bg"));
        const stage = document.getElementById("loop-carousel-9-stage");
        ...
        window.__timelines["loop-carousel-9"] = tl;
      })();
    </script>
  </body>
</html>
