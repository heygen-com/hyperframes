---
title: "Loop Carousel 10"
description: "One lane of image cards steps past the centre, the focused card featured. 8 image slots, 16s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-10.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-10.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-10" item="loop-carousel-10" />

That writes one file: `compositions/loop-carousel-10.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-10"
  data-composition-src="compositions/loop-carousel-10.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `delay` | `0.5` | 0s to 2s, step 0.01s | Hold time between steps, seconds. |
| `direction` | `left` | `up`, `down`, `left`, `right` | Direction of travel. |
| `planeSize` | `454` | 0 to 1700, step 10 | Card size in scene units. |
| `gap` | `332` | 0px to 1000px, step 10px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-10-bg"></div>
        <div id="loop-carousel-10-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-10-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-10-bg"));
        const stage = document.getElementById("loop-carousel-10-stage");
        ...
        window.__timelines["loop-carousel-10"] = tl;
      })();
    </script>
  </body>
</html>
