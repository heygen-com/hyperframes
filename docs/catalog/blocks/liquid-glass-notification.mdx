...
<CatalogDetail
  previewSrc="/public/catalog/blocks/liquid-glass-notification.json"
  compositionId="liquid-glass-notification"
  compositionSrc="compositions/liquid-glass-notification.html"
  title="Liquid Glass Notification"
  description="Frosted glass notification cards floating over an aurora shader background"
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":485}}
  attribution={{"path":"registry/blocks/liquid-glass-notification","tags":["html-in-canvas","liquid-glass-html-in-canvas","webgpu"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/liquid-glass-notification/liquid-glass-notification.html"
>

<CatalogSlot slot="code">

```html liquid-glass-notification.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
