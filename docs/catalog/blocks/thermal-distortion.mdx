...
<CatalogDetail
  previewSrc="/public/catalog/blocks/thermal-distortion.json"
  compositionId="thermal-distortion"
  compositionSrc="compositions/thermal-distortion.html"
  title="Thermal Distortion"
  description="Shader transition with heat haze thermal distortion"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":377}}
  attribution={{"path":"registry/blocks/thermal-distortion","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/thermal-distortion/thermal-distortion.html"
>

<CatalogSlot slot="code">

```html thermal-distortion.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
