...
<CatalogDetail
  previewSrc="/public/catalog/blocks/instagram-follow.json"
  compositionId="instagram-follow"
  compositionSrc="compositions/instagram-follow.html"
  title="Instagram Follow"
  description="Animated Instagram follow overlay with profile card and follow button"
  variables={[]}
  meta={{"duration":4.5,"width":1080,"height":1920,"category":"Social Overlays","badge":"Stable","codeLines":288}}
  attribution={{"path":"registry/blocks/instagram-follow","tags":["social","overlay","instagram"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/instagram-follow/instagram-follow.html"
>

<CatalogSlot slot="code">

```html instagram-follow.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
