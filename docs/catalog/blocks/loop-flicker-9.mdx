...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-9.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-9.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-9" item="loop-flicker-9" />

That writes one file: `compositions/loop-flicker-9.html`.
...
```html index.html
<div
  data-composition-id="loop-flicker-9"
  data-composition-src="compositions/loop-flicker-9.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-flicker-9-bg"></div>
        <div id="loop-flicker-9-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-flicker-9-loop").dataset.duration = DUR;
        background(document.getElementById("loop-flicker-9-bg"));
        const stage = document.getElementById("loop-flicker-9-stage");
        ...
        window.__timelines["loop-flicker-9"] = tl;
      })();
    </script>
  </body>
</html>
