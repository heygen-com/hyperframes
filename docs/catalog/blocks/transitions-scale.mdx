...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-scale.json"
  compositionId="transitions-scale"
  compositionSrc="compositions/transitions-scale.html"
  title="Scale Transitions"
  description="Showcase of scale and zoom transitions"
  variables={[]}
  meta={{"duration":15,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":350}}
  attribution={{"path":"registry/blocks/transitions-scale","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-scale/transitions-scale.html"
>

<CatalogSlot slot="code">

```html transitions-scale.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
