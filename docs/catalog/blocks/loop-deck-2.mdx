...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-deck-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-deck-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-deck-2" item="loop-deck-2" />

That writes one file: `compositions/loop-deck-2.html`.
...
```html index.html
<div
  data-composition-id="loop-deck-2"
  data-composition-src="compositions/loop-deck-2.html"
  data-start="0"
  data-duration="7"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `375` | 0 to 1000, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-deck-2-bg"></div>
        <div id="loop-deck-2-stage"><div id="loop-deck-2-belt"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-deck-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-deck-2-bg"));

        const f = 1000 * (100 / PERSP) * (REF / 1080); // CSS focal length, px
        const s = f / D; // world -> px at the belt plane (z = 0)
        const S = PLANE * s;
        const P = S * (1 + GAP) * PITCH_K;
        const stage = document.getElementById("loop-deck-2-stage");
        stage.style.perspective = f + "px";
        const belt = document.getElementById("loop-deck-2-belt");
        ...
        window.__timelines["loop-deck-2"] = tl;
      })();
    </script>
  </body>
</html>
