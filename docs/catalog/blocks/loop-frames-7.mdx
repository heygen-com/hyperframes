...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-frames-7.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-frames-7.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-frames-7" item="loop-frames-7" />

That writes one file: `compositions/loop-frames-7.html`.
...
```html index.html
<div
  data-composition-id="loop-frames-7"
  data-composition-src="compositions/loop-frames-7.html"
  data-start="0"
  data-duration="15"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `61` | 0 to 200, step 1 | Card size in scene units. |
| `gap` | `0` | 0px to 214px, step 10px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-frames-7-bg"></div>
        <div id="loop-frames-7-sheet"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-frames-7-loop").dataset.duration = DUR;
        background(document.getElementById("loop-frames-7-bg"));
        const sheet = document.getElementById("loop-frames-7-sheet");
        ...
        window.__timelines["loop-frames-7"] = tl;
      })();
    </script>
  </body>
</html>
