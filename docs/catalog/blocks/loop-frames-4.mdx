...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-frames-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-frames-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-frames-4" item="loop-frames-4" />

That writes one file: `compositions/loop-frames-4.html`.
...
```html index.html
<div
  data-composition-id="loop-frames-4"
  data-composition-src="compositions/loop-frames-4.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-frames-4.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-frames-4-bg"></div>
        <div id="loop-frames-4-sheet"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-frames-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-frames-4-bg"));
        const sheet = document.getElementById("loop-frames-4-sheet");
        ...
        window.__timelines["loop-frames-4"] = tl;
      })();
    </script>
  </body>
</html>
