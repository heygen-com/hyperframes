...
<CatalogDetail
  previewSrc="/public/catalog/blocks/blue-sweater-intro-video.json"
  compositionId="blue-sweater-intro-video"
  compositionSrc="compositions/blue-sweater-intro-video.html"
  title="Blue Sweater Intro Video"
  description="Warm AI creator intro sequence that resolves into an X follow card for @_blue_sweater_."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":1523}}
  attribution={{"author":"Joe Sai","authorUrl":"https://x.com/_blue_sweater_","path":"registry/blocks/blue-sweater-intro-video","tags":["showcase","ai","creator","sfx"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/blue-sweater-intro-video/blue-sweater-intro-video.html"
>

<CatalogSlot slot="code">

```html blue-sweater-intro-video.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
