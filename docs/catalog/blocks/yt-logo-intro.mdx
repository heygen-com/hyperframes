...
<iframe src="/public/catalog/preview/blocks/yt-logo-intro.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Logo Intro Sequence preview" />

## Install

<InstallCommand command="npx hyperframes add yt-logo-intro" />
