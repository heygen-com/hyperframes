...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stack-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stack-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-stack-2" item="loop-stack-2" />

That writes one file: `compositions/loop-stack-2.html`.
...
```html index.html
<div
  data-composition-id="loop-stack-2"
  data-composition-src="compositions/loop-stack-2.html"
  data-start="0"
  data-duration="11"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `38` | 0 to 76, step 1 | Card size in scene units. |
| `visible` | `3` | 0 to 12, step 0.1 | Visible (engine parameter; see the block header comment). |
| `perspective` | `73` | 0 to 246, step 10 | Camera focal length: smaller = stronger perspective. |
| `zoom` | `150` | 0 to 534, step 10 | Zoom (engine parameter; see the block header comment). |
| `offsetX` | `0` | -100% to 100%, step 1% | Horizontal offset of the formation, % of width. |
| `offsetY` | `2.5` | -100% to 100%, step 1% | Vertical offset of the formation, % of height. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-stack-2-bg"></div>
        <div id="loop-stack-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-stack-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-stack-2-bg"));
        const stage = document.getElementById("loop-stack-2-stage");
        ...
        window.__timelines["loop-stack-2"] = tl;
      })();
    </script>
  </body>
</html>
