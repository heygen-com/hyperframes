---
title: "Loop Tour Space 2"
description: "A tour through images set in open space. 8 image slots, 10s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-tour02-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-tour02-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-tour02-2" item="loop-tour02-2" />

That writes one file: `compositions/loop-tour02-2.html`.
...
```html index.html
<div
  data-composition-id="loop-tour02-2"
  data-composition-src="compositions/loop-tour02-2.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-tour02-2-bg"></div>
        <div id="loop-tour02-2-stage"><div id="loop-tour02-2-world"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        const BILLBOARD = false; // tour02 (generated from tour01.html): cards face the camera; tour02: cards face down the path (fixed)
        ...
        document.getElementById("loop-tour02-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-tour02-2-bg"));
        const f = 1000 * (REF / 1080),
          U = f; // px per world unit: a unit-size card at distance 1 spans f px
        document.getElementById("loop-tour02-2-stage").style.perspective = f + "px";
        const world = document.getElementById("loop-tour02-2-world");
        ...
        window.__timelines["loop-tour02-2"] = tl;
      })();
    </script>
  </body>
</html>
