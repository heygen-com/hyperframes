...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-cardtoss.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-cardtoss.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-cardtoss" item="loop-cardtoss" />

That writes one file: `compositions/loop-cardtoss.html`.
...
<div
  ...
  data-composition-src="compositions/loop-cardtoss.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `cropAspectRatio` | `3:4` | `16:9`, `9:16`, `1:1`, `4:5`, `3:2`, `3:4`, `2:3` | Card aspect used when Fit is Crop. |
...
| `sizeVar` | `20` | 0 to 40, step 1 | Size Var (engine parameter; see the block header comment). |
| `throwHeight` | `75` | 0 to 150, step 1 | Throw Height (engine parameter; see the block header comment). |
| `spread` | `70` | 0 to 140, step 1 | Spread (engine parameter; see the block header comment). |
| `spin` | `12` | 0 to 24, step 1 | Spin (engine parameter; see the block header comment). |
| `flow` | `staggered` | `one`, `staggered` | Flow (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `cardtoss`.
