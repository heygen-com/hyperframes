...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-monokai.json"
  compositionId="code-snippet-monokai"
  compositionSrc="compositions/code-snippet-monokai.html"
  title="Code Snippet - Monokai"
  description="VS Code workbench with per-character typing animation in the Monokai theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1068}}
  attribution={{"path":"registry/blocks/code-snippet-monokai","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-monokai/code-snippet-monokai.html"
>

<CatalogSlot slot="code">

```html code-snippet-monokai.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Monokai VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-monokai-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Monokai</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">monokai-color-theme.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-monokai"] =
            window.__timelines["vscode-monokai"] || gsap.timeline({ paused: true });
