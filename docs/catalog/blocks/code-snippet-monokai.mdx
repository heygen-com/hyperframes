...
<iframe src="/public/catalog/preview/blocks/code-snippet-monokai.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Monokai preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-monokai" />

That writes `compositions/code-snippet-monokai.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-monokai.html`}>
