...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-light-2026.json"
  compositionId="code-snippet-light-2026"
  compositionSrc="compositions/code-snippet-light-2026.html"
  title="Code Snippet - Light 2026"
  description="VS Code workbench with per-character typing animation in the Light 2026 theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1090}}
  attribution={{"path":"registry/blocks/code-snippet-light-2026","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-light-2026/code-snippet-light-2026.html"
>

<CatalogSlot slot="code">

```html code-snippet-light-2026.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Light 2026 VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-light-2026-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Light 2026</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">2026-light.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-light-2026"] =
            window.__timelines["vscode-light-2026"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-light-2026", {
            id: "light-2026",
            label: "Light 2026",
