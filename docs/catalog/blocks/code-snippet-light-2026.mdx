...
<iframe src="/public/catalog/preview/blocks/code-snippet-light-2026.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Light 2026 preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-light-2026" />

That writes `compositions/code-snippet-light-2026.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-light-2026.html`}>
