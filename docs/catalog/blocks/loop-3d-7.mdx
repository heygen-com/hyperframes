...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-3d-7.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-3d-7.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-3d-7" item="loop-3d-7" />

That writes one file: `compositions/loop-3d-7.html`.
...
```html index.html
<div
  data-composition-id="loop-3d-7"
  data-composition-src="compositions/loop-3d-7.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-3d-7-bg"></div>
        <div id="loop-3d-7-stage">
          <div id="loop-3d-7-ring"><div id="loop-3d-7-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-3d-7-loop").dataset.duration = DUR;
        background(document.getElementById("loop-3d-7-bg"));

        const f = 1000 * (100 / PERSP) * (REF / 1080); // CSS focal length, px
        const s = f / Math.max(D, R, 1); // world -> px (ring centre or ring at z=0)
        const Rpx = R * s,
          Dpx = D * s;
        const stage = document.getElementById("loop-3d-7-stage");
        stage.style.perspective = f + "px";
        const ring = document.getElementById("loop-3d-7-ring");
        ...
        const spin = document.getElementById("loop-3d-7-spin");
        ...
        window.__timelines["loop-3d-7"] = tl;
      })();
    </script>
  </body>
</html>
