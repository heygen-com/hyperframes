...
<CatalogDetail
  previewSrc="/public/catalog/blocks/world-map.json"
  compositionId="world-map"
  compositionSrc="compositions/world-map.html"
  title="World Map"
  description="Animated world choropleth with country-by-country reveal, tooltip labels, and rotating globe inset — D3 Natural Earth projection"
  variables={[]}
  meta={{"duration":14,"width":1920,"height":1080,"category":"Data","badge":"Stable","codeLines":435}}
  attribution={{"path":"registry/blocks/world-map","tags":["data","map","geography","world","choropleth"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/world-map/world-map.html"
>
