...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-scale-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-scale-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-scale-3" item="loop-scale-3" />

That writes one file: `compositions/loop-scale-3.html`.
...
```html index.html
<div
  data-composition-id="loop-scale-3"
  data-composition-src="compositions/loop-scale-3.html"
  data-start="0"
  data-duration="4"
  data-track-index="1"
  data-width="1080"
...
| `spin` | `-45` | -90 to 90, step 1 | Spin (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-scale-3-bg"></div>
        <div id="loop-scale-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-scale-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-scale-3-bg"));
        const stage = document.getElementById("loop-scale-3-stage");
        ...
        window.__timelines["loop-scale-3"] = tl;
      })();
    </script>
  </body>
</html>
