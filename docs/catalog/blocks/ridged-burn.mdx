...
<CatalogDetail
  previewSrc="/public/catalog/blocks/ridged-burn.json"
  compositionId="ridged-burn"
  compositionSrc="compositions/ridged-burn.html"
  title="Ridged Burn"
  description="Shader transition with ridged turbulence burn effect"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":377}}
  attribution={{"path":"registry/blocks/ridged-burn","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/ridged-burn/ridged-burn.html"
>

<CatalogSlot slot="code">

```html ridged-burn.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
