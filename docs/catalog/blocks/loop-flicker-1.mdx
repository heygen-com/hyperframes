...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-flicker-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-flicker-1" item="loop-flicker-1" />

That writes one file: `compositions/loop-flicker-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-flicker-1.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `100` | 0 to 236, step 10 | Card size in scene units. |
