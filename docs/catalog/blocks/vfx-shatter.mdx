...
<CatalogDetail
  compositionId="vfx-shatter"
  compositionSrc="compositions/vfx-shatter.html"
  title="Shatter"
  description="VFX composition block"
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":1156}}
  attribution={{"path":"registry/blocks/vfx-shatter","tags":["html-in-canvas","webgl"]}}
  ...
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/vfx-shatter/vfx-shatter.html"
>

<CatalogSlot slot="code">

```html vfx-shatter.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
