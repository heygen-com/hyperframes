...
<CatalogDetail
  previewSrc="/public/catalog/blocks/chromatic-radial-split.json"
  compositionId="chromatic-radial-split"
  compositionSrc="compositions/chromatic-radial-split.html"
  title="Chromatic Radial Split"
  description="Shader transition with chromatic aberration radial split"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/chromatic-radial-split","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/chromatic-radial-split/chromatic-radial-split.html"
>

<CatalogSlot slot="code">

```html chromatic-radial-split.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
