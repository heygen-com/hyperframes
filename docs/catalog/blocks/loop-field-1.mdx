...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-field-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-field-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-field-1" item="loop-field-1" />

That writes one file: `compositions/loop-field-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-field-1.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
| `count` | `12` | 0 to 100, step 1 | Count (engine parameter; see the block header comment). |
