...
<CatalogDetail
  previewSrc="/public/catalog/blocks/flowchart-vertical.json"
  compositionId="flowchart-vertical"
  compositionSrc="compositions/flowchart-vertical.html"
  title="Flowchart Vertical"
  description="Portrait animated decision tree with SVG connectors, sticky-note nodes, cursor interaction, and typing correction"
  variables={[]}
  meta={{"duration":12,"width":1440,"height":2560,"category":"Blocks","badge":"Stable","codeLines":459}}
  attribution={{"path":"registry/blocks/flowchart-vertical","tags":["diagram","flowchart","interactive","portrait"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/flowchart-vertical/flowchart-vertical.html"
>

<CatalogSlot slot="code">

```html flowchart-vertical.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
