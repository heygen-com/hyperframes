...
<iframe src="/public/catalog/preview/blocks/code-snippet-light-modern.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Light Modern preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-light-modern" />

That writes `compositions/code-snippet-light-modern.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-light-modern.html`}>
