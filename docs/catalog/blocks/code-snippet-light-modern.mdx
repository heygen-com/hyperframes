...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-light-modern.json"
  compositionId="code-snippet-light-modern"
  compositionSrc="compositions/code-snippet-light-modern.html"
  title="Code Snippet - Light Modern"
  description="VS Code workbench with per-character typing animation in the Light Modern theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1088}}
  attribution={{"path":"registry/blocks/code-snippet-light-modern","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-light-modern/code-snippet-light-modern.html"
>

<CatalogSlot slot="code">

```html code-snippet-light-modern.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Light Modern VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-light-modern-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Light Modern</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">light_modern.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-light-modern"] =
            window.__timelines["vscode-light-modern"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-light-modern", {
            id: "light-modern",
            label: "Light Modern",
