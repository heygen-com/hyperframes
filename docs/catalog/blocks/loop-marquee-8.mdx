---
title: "Loop Marquee 8"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 11s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-8.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-8.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-8" item="loop-marquee-8" />

That writes one file: `compositions/loop-marquee-8.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-8"
  data-composition-src="compositions/loop-marquee-8.html"
  data-start="0"
  data-duration="11"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-8-bg"></div>
        <div id="loop-marquee-8-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-8-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-8-bg"));
        const stage = document.getElementById("loop-marquee-8-stage");
        ...
        window.__timelines["loop-marquee-8"] = tl;
      })();
    </script>
  </body>
</html>
