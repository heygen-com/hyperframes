...
<CatalogDetail
  previewSrc="/public/catalog/blocks/news-ticker.json"
  compositionId="news-ticker"
  compositionSrc="compositions/news-ticker.html"
  title="News Ticker"
  description="Premium broadcast-style lower-third ticker with live label, headline ribbon, and scrolling news crawl."
  variables={[]}
  meta={{"duration":7,"width":1920,"height":1080,"category":"Lower Thirds","badge":"Stable","codeLines":408}}
  attribution={{"path":"registry/blocks/news-ticker","tags":["lower-third","overlay","news","ticker"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/news-ticker/news-ticker.html"
>

<CatalogSlot slot="code">

```html news-ticker.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
