...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-light-plus.json"
  compositionId="code-snippet-light-plus"
  compositionSrc="compositions/code-snippet-light-plus.html"
  title="Code Snippet - Light+"
  description="VS Code workbench with per-character typing animation in the Light+ theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1056}}
  attribution={{"path":"registry/blocks/code-snippet-light-plus","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-light-plus/code-snippet-light-plus.html"
>

<CatalogSlot slot="code">

```html code-snippet-light-plus.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Light+ VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-light-plus-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Light+</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">light_plus.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-light-plus"] =
            window.__timelines["vscode-light-plus"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-light-plus", {
            id: "light-plus",
            label: "Light+",
