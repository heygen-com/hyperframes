...
<iframe src="/public/catalog/preview/blocks/code-snippet-light-plus.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Light+ preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-light-plus" />

That writes `compositions/code-snippet-light-plus.html`, plus 1 supporting file under `assets/`.

## Source

<Accordion title={`code-snippet-light-plus.html`}>
