...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-stories-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-stories-1" item="loop-stories-1" />

That writes one file: `compositions/loop-stories-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-stories-1.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `dimAmount` | `20` | 0 to 100, step 1 | Dim Amount (engine parameter; see the block header comment). |
