---
title: "Loop Proximity 6"
description: "A field of image tiles swells as the camera passes over them. 8 image slots, 14s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-6.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-proximity-6.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-proximity-6" item="loop-proximity-6" />

That writes one file: `compositions/loop-proximity-6.html`.
...
```html index.html
<div
  data-composition-id="loop-proximity-6"
  data-composition-src="compositions/loop-proximity-6.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
<Accordion title={`loop-proximity-6.html`}>
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-proximity-6-bg"></div>
        <div id="loop-proximity-6-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-proximity-6-loop").dataset.duration = DUR;
        background(document.getElementById("loop-proximity-6-bg"));
        const stage = document.getElementById("loop-proximity-6-stage");
        ...
        window.__timelines["loop-proximity-6"] = tl;
      })();
    </script>
  </body>
</html>
