---
title: "Loop Marquee 13"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 10s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-13.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-13.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-13" item="loop-marquee-13" />

That writes one file: `compositions/loop-marquee-13.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-13"
  data-composition-src="compositions/loop-marquee-13.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
| `stagger` | `2` | 0 to 10, step 0.1 | Stagger (engine parameter; see the block header comment). |
...
| `alternate` | `off` | `off`, `on` | Alternate (engine parameter; see the block header comment). |
| `lanes` | `6` | 0 to 12, step 0.1 | Lanes (engine parameter; see the block header comment). |
| `planeSize` | `55` | 0 to 360, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-13-bg"></div>
        <div id="loop-marquee-13-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-13-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-13-bg"));
        const stage = document.getElementById("loop-marquee-13-stage");
        ...
        window.__timelines["loop-marquee-13"] = tl;
      })();
    </script>
  </body>
</html>
