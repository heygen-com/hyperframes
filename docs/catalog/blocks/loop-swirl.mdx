...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-swirl.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-swirl.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-swirl" item="loop-swirl" />

That writes one file: `compositions/loop-swirl.html`.
...
<div
  ...
  data-composition-src="compositions/loop-swirl.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `borderRadius` | `26` | 0px to 200px, step 1px | Card corner radius in px at 1080. |
| `direction` | `inward` | `inward`, `outward` | Direction of travel. |
| `fadeIn` | `20` | 0 to 40, step 1 | Fade In (engine parameter; see the block header comment). |
| `turns` | `3.5` | 0 to 7, step 0.1 | Turns (engine parameter; see the block header comment). |
| `spread` | `7` | 0 to 14, step 0.1 | Spread (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `swirl`.
