...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-push.json"
  compositionId="transitions-push"
  compositionSrc="compositions/transitions-push.html"
  title="Push Transitions"
  description="Showcase of push and slide transitions"
  variables={[]}
  meta={{"duration":24,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":383}}
  attribution={{"path":"registry/blocks/transitions-push","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-push/transitions-push.html"
>

<CatalogSlot slot="code">

```html transitions-push.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
