...
<CatalogDetail
  previewSrc="/public/catalog/blocks/x-post.json"
  compositionId="x-post"
  compositionSrc="compositions/x-post.html"
  title="X Post Card"
  description="Animated X/Twitter post card overlay with engagement metrics"
  variables={[]}
  meta={{"duration":5,"width":1920,"height":1080,"category":"Social Overlays","badge":"Stable","codeLines":442}}
  attribution={{"path":"registry/blocks/x-post","tags":["social","overlay","twitter"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/x-post/x-post.html"
>
