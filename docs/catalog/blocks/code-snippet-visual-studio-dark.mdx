...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-visual-studio-dark.json"
  compositionId="code-snippet-visual-studio-dark"
  compositionSrc="compositions/code-snippet-visual-studio-dark.html"
  title="Code Snippet - Visual Studio Dark"
  description="VS Code workbench with per-character typing animation in the Visual Studio Dark theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1056}}
  attribution={{"path":"registry/blocks/code-snippet-visual-studio-dark","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-visual-studio-dark/code-snippet-visual-studio-dark.html"
>

<CatalogSlot slot="code">

```html code-snippet-visual-studio-dark.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Visual Studio Dark VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-visual-studio-dark-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Visual Studio Dark</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">dark_vs.json</span>.
            </p>
          </section>
        ...
        <script>
          window.__timelines = window.__timelines || {};
          window.__timelines["vscode-visual-studio-dark"] =
            window.__timelines["vscode-visual-studio-dark"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-visual-studio-dark", {
