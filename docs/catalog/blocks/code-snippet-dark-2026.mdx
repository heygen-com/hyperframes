...
<iframe src="/public/catalog/preview/blocks/code-snippet-dark-2026.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Code Snippet - Dark 2026 preview" />

## Install

<InstallCommand command="npx hyperframes add code-snippet-dark-2026" />
