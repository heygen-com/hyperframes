  ...
  <body>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [3832.597, 235.863], in: [-468.543, 0], out: [468.543, 0] },
            { p: [4680.976, 1084.34], in: [0, -468.597], out: [0, 468.597] },
            { p: [3832.597, 1932.818], in: [468.543, 0], out: [-468.543, 0] },
            { p: [2984.218, 1084.34], in: [0, 468.597], out: [0, -468.597] },
          ],
          closed: true,
        },
        keys: {
...
<Accordion title={`carousel-text-circle-5.html`}>
