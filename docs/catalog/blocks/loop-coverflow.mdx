...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-coverflow.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-coverflow.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-coverflow" item="loop-coverflow" />

That writes one file: `compositions/loop-coverflow.html`.
...
<div
  ...
  data-composition-src="compositions/loop-coverflow.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `flowAngle` | `0` | 0 to 2, step 0.01 | Flow Angle (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `coverflow` `3d`.
