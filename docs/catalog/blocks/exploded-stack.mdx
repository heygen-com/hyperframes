...
<CatalogDetail
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"3D objects","badge":"Stable","codeLines":335}}
  ...
  <body>
    ...
    <script>
      (function () {
        ...
        var clock = { t: 0 };
        var scene = { vars: vars, names: names, duration: duration, clock: clock, hex: hex, render: null };
    ...
    <script type="module">
      ...
      host.render = (t) => {
        ...
        for (let i = 0; i < LAYERS; i++) {
          ...
          labelEls[i].style.transform = `translate(${Math.round(lx + 24 + (1 - shown) * 16)}px, ${Math.round(ay - 22)}px)`;
