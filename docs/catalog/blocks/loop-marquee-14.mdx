---
title: "Loop Marquee 14"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-14.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-14.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-14" item="loop-marquee-14" />

That writes one file: `compositions/loop-marquee-14.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-14"
  data-composition-src="compositions/loop-marquee-14.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
| `lanes` | `4` | 0 to 12, step 0.1 | Lanes (engine parameter; see the block header comment). |
| `planeSize` | `100` | 0 to 360, step 10 | Card size in scene units. |
| `gap` | `13` | 0px to 84px, step 1px | Spacing between cards. |
| `angle` | `-15` | -180° to 180°, step 1° | Angle (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-14-bg"></div>
        <div id="loop-marquee-14-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-14-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-14-bg"));
        const stage = document.getElementById("loop-marquee-14-stage");
        ...
        window.__timelines["loop-marquee-14"] = tl;
      })();
    </script>
  </body>
</html>
