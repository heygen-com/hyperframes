---
title: "Loop Cover Flow Vertical"
description: "A vertical cover-flow fold: the focused card faces the camera while cards above and below tilt away. 8 image slots, 12s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-coverflowvertical.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-coverflowvertical.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-coverflowvertical" item="loop-coverflowvertical" />

That writes one file: `compositions/loop-coverflowvertical.html`.
...
```html index.html
<div
  data-composition-id="loop-coverflowvertical"
  data-composition-src="compositions/loop-coverflowvertical.html"
  data-start="0"
  data-duration="12"
  data-track-index="1"
  data-width="1080"
...
| `scaleIntensity` | `0.46` | 0 to 1, step 0.05 | Strength of the size change. |
...
| `gap` | `4` | 0px to 10px, step 0.1px | Spacing between cards. |
| `sideTilt` | `40` | 0 to 80, step 1 | Side Tilt (engine parameter; see the block header comment). |
...
>
  <head>
    ...
    <style>
      * {
      ...
      #loop-coverflowvertical-bg {
        position: absolute;
        inset: 0;
      }
      #loop-coverflowvertical-stage {
        position: absolute;
        inset: 0;
        perspective-origin: 50% 50%;
      }
      #loop-coverflowvertical-flow {
        position: absolute;
        left: 50%;
        top: 50%;
        width: 0;
  ...
  <body>
    <div
      id="loop-coverflowvertical-root"
      data-composition-id="loop-coverflowvertical"
      data-start="0"
      data-width="1080"
      data-height="1080"
    ...
    >
      <div
        id="loop-coverflowvertical-loop"
        class="clip"
        data-start="0"
        data-duration="12"
        data-track-index="1"
      ...
      >
        <div id="loop-coverflowvertical-bg"></div>
        <div id="loop-coverflowvertical-stage"><div id="loop-coverflowvertical-flow"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-coverflowvertical-loop").dataset.duration = DUR;
        background(document.getElementById("loop-coverflowvertical-bg"));
        ...
        const stage = document.getElementById("loop-coverflowvertical-stage");
        stage.style.perspective = F + "px";
        const flow = document.getElementById("loop-coverflowvertical-flow");
        ...
        window.__timelines["loop-coverflowvertical"] = tl;
      })();
    </script>
  </body>
</html>
...
Tagged `loop` `images` `showcase` `gallery` `coverflowvertical` `3d`.
