...
<CatalogDetail
  previewSrc="/public/catalog/blocks/us-map-hex.json"
  compositionId="us-map-hex"
  compositionSrc="compositions/us-map-hex.html"
  title="US Hex Grid Map"
  description="Animated hexagonal tile grid map — each state as an equal-weight hex with data fill and abbreviation label"
  variables={[]}
  meta={{"duration":10,"width":1920,"height":1080,"category":"Data","badge":"Stable","codeLines":559}}
  attribution={{"path":"registry/blocks/us-map-hex","tags":["data","map","geography","usa","hexgrid","tilegrid"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/us-map-hex/us-map-hex.html"
>

<CatalogSlot slot="code">

```html us-map-hex.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
