...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-book-5.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-book-5.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-book-5" item="loop-book-5" />

That writes one file: `compositions/loop-book-5.html`.
...
```html index.html
<div
  data-composition-id="loop-book-5"
  data-composition-src="compositions/loop-book-5.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
| `rotationX` | `-18` | -180° to 180°, step 1° | Formation tilt about the horizontal axis, degrees. |
| `rotationY` | `-48` | -180° to 180°, step 1° | Formation turn about the vertical axis, degrees. |
| `rotationZ` | `1` | -180° to 180°, step 1° | Formation roll about the view axis, degrees. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-book-5-bg"></div>
        <div id="loop-book-5-stage">
          <div id="loop-book-5-book"><div id="loop-book-5-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-book-5-loop").dataset.duration = DUR;
        background(document.getElementById("loop-book-5-bg"));
        const f = 1000 * (100 / PERSP) * (REF / 1080),
          s = f / D;
        document.getElementById("loop-book-5-stage").style.perspective = f + "px";
        const book = document.getElementById("loop-book-5-book"),
          spin = document.getElementById("loop-book-5-spin");
        ...
        window.__timelines["loop-book-5"] = tl;
      })();
    </script>
  </body>
</html>
