...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-wipe-3.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-wipe-3.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-wipe-3" item="loop-wipe-3" />

That writes one file: `compositions/loop-wipe-3.html`.
...
```html index.html
<div
  data-composition-id="loop-wipe-3"
  data-composition-src="compositions/loop-wipe-3.html"
  data-start="0"
  data-duration="21"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-wipe-3-bg"></div>
        <div id="loop-wipe-3-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-wipe-3-loop").dataset.duration = DUR;
        background(document.getElementById("loop-wipe-3-bg"));
        const stage = document.getElementById("loop-wipe-3-stage");
        ...
        window.__timelines["loop-wipe-3"] = tl;
      })();
    </script>
  </body>
</html>
