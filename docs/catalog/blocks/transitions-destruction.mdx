...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-destruction.json"
  compositionId="transitions-destruction"
  compositionSrc="compositions/transitions-destruction.html"
  title="Destruction Transitions"
  description="Showcase of destructive break-apart transitions"
  variables={[]}
  meta={{"duration":14,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":414}}
  attribution={{"path":"registry/blocks/transitions-destruction","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-destruction/transitions-destruction.html"
>

<CatalogSlot slot="code">

```html transitions-destruction.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
