...
<iframe src="/public/catalog/preview/blocks/transitions-destruction.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Destruction Transitions preview" />

## Install

<InstallCommand command="npx hyperframes add transitions-destruction" />
