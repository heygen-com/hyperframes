---
title: "Loop Marquee 9"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 9s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-9.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-9.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-9" item="loop-marquee-9" />

That writes one file: `compositions/loop-marquee-9.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-9"
  data-composition-src="compositions/loop-marquee-9.html"
  data-start="0"
  data-duration="9"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-9-bg"></div>
        <div id="loop-marquee-9-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-9-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-9-bg"));
        const stage = document.getElementById("loop-marquee-9-stage");
        ...
        window.__timelines["loop-marquee-9"] = tl;
      })();
    </script>
  </body>
</html>
