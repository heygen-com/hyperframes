...
<iframe src="/public/catalog/preview/blocks/yt-lcd-background.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Scanline Board Background preview" />

## Install

<InstallCommand command="npx hyperframes add yt-lcd-background" />
