...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-grass.json"
  compositionId="code-snippet-apple-terminal-grass"
  compositionSrc="compositions/code-snippet-apple-terminal-grass.html"
  title="Code Snippet - Apple Terminal Grass"
  description="Apple Terminal Grass profile: black background with green text, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":243}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-grass","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-grass/code-snippet-apple-terminal-grass.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-grass.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
