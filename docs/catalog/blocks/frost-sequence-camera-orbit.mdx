...
That writes `compositions/frost-sequence-camera-orbit/frost-sequence-camera-orbit.html`, plus 16 supporting files under `compositions/frost-sequence-camera-orbit/assets/`, `compositions/frost-sequence-camera-orbit/assets/fonts/`, `compositions/frost-sequence-camera-orbit/assets/textures/`, and `compositions/frost-sequence-camera-orbit/`.
