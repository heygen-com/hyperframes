...
<CatalogDetail
  previewSrc="/public/catalog/blocks/vfx-text-cursor.json"
  compositionId="vfx-text-cursor"
  compositionSrc="compositions/vfx-text-cursor.html"
  title="VFX Text Cursor"
  description="Dramatic text reveal with cursor glow, chromatic shadow rays, and directional lighting on a black stage. Canvas-based shader post-processing with spectral color edges."
  variables={[]}
  meta={{"duration":8,"width":1920,"height":1080,"category":"HTML-in-Canvas","badge":"Experimental","codeLines":855}}
  attribution={{"path":"registry/blocks/vfx-text-cursor","tags":["html-in-canvas","text","shader","cursor","chromatic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/vfx-text-cursor/vfx-text-cursor.html"
>

<CatalogSlot slot="code">

```html vfx-text-cursor.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
