...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-6.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-6.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-6" item="loop-carousel-6" />

That writes one file: `compositions/loop-carousel-6.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-6"
  data-composition-src="compositions/loop-carousel-6.html"
  data-start="0"
  data-duration="18"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `540` | 0 to 1700, step 10 | Card size in scene units. |
| `gap` | `80` | 0px to 1000px, step 10px | Spacing between cards. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-6-bg"></div>
        <div id="loop-carousel-6-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-6-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-6-bg"));
        const stage = document.getElementById("loop-carousel-6-stage");
        ...
        window.__timelines["loop-carousel-6"] = tl;
      })();
    </script>
  </body>
</html>
