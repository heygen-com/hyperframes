---
title: "Loop Spin 4"
description: "One image card at the frame centre turns on the spot, showing the next image each half turn. 8 image slots, 10s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spin-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spin-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-spin-4" item="loop-spin-4" />

That writes one file: `compositions/loop-spin-4.html`.
...
```html index.html
<div
  data-composition-id="loop-spin-4"
  data-composition-src="compositions/loop-spin-4.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-spin-4-bg"></div>
        <div id="loop-spin-4-stage"><div id="loop-spin-4-pivot"></div></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-spin-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-spin-4-bg"));
        const f = 1.33 * REF * (50 / PERSP);
        document.getElementById("loop-spin-4-stage").style.perspective = f + "px";
        const pivot = document.getElementById("loop-spin-4-pivot");
        ...
        window.__timelines["loop-spin-4"] = tl;
      })();
    </script>
  </body>
</html>
