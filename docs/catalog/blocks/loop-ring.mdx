...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-ring.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-ring.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-ring" item="loop-ring" />

That writes one file: `compositions/loop-ring.html`.
...
<div
  ...
  data-composition-src="compositions/loop-ring.html"
  data-start="0"
  data-duration="16"
  data-track-index="1"
  data-width="1080"
...
| `direction` | `anticlockwise` | `anticlockwise`, `clockwise` | Direction of travel. |
| `radiusX` | `32` | 0 to 64, step 1 | Radius X (engine parameter; see the block header comment). |
| `radiusY` | `32` | 0 to 64, step 1 | Radius Y (engine parameter; see the block header comment). |
| `repeat` | `1` | 0 to 10, step 0.1 | Repeat (engine parameter; see the block header comment). |
| `tangent` | `true` | `true`, `false` | Tangent (engine parameter; see the block header comment). |
| `stack` | `lastOnTop` | `lastOnTop`, `firstOnTop` | Stack (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `ring`.
