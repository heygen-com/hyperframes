...
<CatalogDetail
  previewSrc="/public/catalog/blocks/whip-pan.json"
  compositionId="whip-pan"
  compositionSrc="compositions/whip-pan.html"
  title="Whip Pan"
  description="Shader transition simulating a fast camera whip pan"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/whip-pan","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/whip-pan/whip-pan.html"
>
