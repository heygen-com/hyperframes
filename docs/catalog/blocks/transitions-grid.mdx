...
<CatalogDetail
  previewSrc="/public/catalog/blocks/transitions-grid.json"
  compositionId="transitions-grid"
  compositionSrc="compositions/transitions-grid.html"
  title="Grid Transitions"
  description="Showcase of grid-based tile transitions"
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"CSS Transitions","badge":"Stable","codeLines":305}}
  attribution={{"path":"registry/blocks/transitions-grid","tags":["transition","showcase"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/transitions-grid/transitions-grid.html"
>

<CatalogSlot slot="code">

```html transitions-grid.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
