...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-13.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-13.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-13" item="loop-carousel-13" />

That writes one file: `compositions/loop-carousel-13.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-13"
  data-composition-src="compositions/loop-carousel-13.html"
  data-start="0"
  data-duration="18"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `850` | 0 to 1700, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-13-bg"></div>
        <div id="loop-carousel-13-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-13-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-13-bg"));
        const stage = document.getElementById("loop-carousel-13-stage");
        ...
        window.__timelines["loop-carousel-13"] = tl;
      })();
    </script>
  </body>
</html>
