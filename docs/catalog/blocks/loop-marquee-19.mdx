---
title: "Loop Marquee 19"
description: "Lanes of image cards scroll across the frame like a marquee. 8 image slots, 8s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-19.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-marquee-19.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-marquee-19" item="loop-marquee-19" />

That writes one file: `compositions/loop-marquee-19.html`.
...
```html index.html
<div
  data-composition-id="loop-marquee-19"
  data-composition-src="compositions/loop-marquee-19.html"
  data-start="0"
  data-duration="8"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `145` | 0 to 360, step 10 | Card size in scene units. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-marquee-19-bg"></div>
        <div id="loop-marquee-19-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-marquee-19-loop").dataset.duration = DUR;
        background(document.getElementById("loop-marquee-19-bg"));
        const stage = document.getElementById("loop-marquee-19-stage");
        ...
        window.__timelines["loop-marquee-19"] = tl;
      })();
    </script>
  </body>
</html>
