...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-corridor.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-corridor.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-corridor" item="loop-corridor" />

That writes one file: `compositions/loop-corridor.html`.
...
<div
  ...
  data-composition-src="compositions/loop-corridor.html"
  data-start="0"
  data-duration="14"
  data-track-index="1"
  data-width="1080"
...
| `speed` | `15` | 0 to 30, step 1 | Motion speed multiplier. |
| `lineColor` | `#b0b0b0` | color | Line Color (engine parameter; see the block header comment). |
| `accentColor` | `#ff6a00` | color | Accent Color (engine parameter; see the block header comment). |
| `lineOpacity` | `50` | 0 to 100, step 1 | Line Opacity (engine parameter; see the block header comment). |
| `grid` | `4` | 0 to 10, step 0.1 | Grid (engine parameter; see the block header comment). |
| `segments` | `15` | 0 to 30, step 1 | Segments (engine parameter; see the block header comment). |
| `fill` | `32` | 0 to 64, step 1 | Fill (engine parameter; see the block header comment). |
| `tunnelWidth` | `100` | 0 to 200, step 1 | Tunnel Width (engine parameter; see the block header comment). |
...
Tagged `loop` `images` `showcase` `gallery` `corridor` `3d`.
