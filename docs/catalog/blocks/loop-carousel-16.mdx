...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-16.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel-16.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel-16" item="loop-carousel-16" />

That writes one file: `compositions/loop-carousel-16.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel-16"
  data-composition-src="compositions/loop-carousel-16.html"
  data-start="0"
  data-duration="13"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `473` | 0 to 1700, step 10 | Card size in scene units. |
| `gap` | `0` | 0px to 1000px, step 10px | Spacing between cards. |
...
| `scaleFocus` | `start` | `center`, `start`, `end` | Scale Focus (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel-16-bg"></div>
        <div id="loop-carousel-16-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel-16-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel-16-bg"));
        const stage = document.getElementById("loop-carousel-16-stage");
        ...
        window.__timelines["loop-carousel-16"] = tl;
      })();
    </script>
  </body>
</html>
