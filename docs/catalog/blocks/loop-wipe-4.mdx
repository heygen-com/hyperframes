---
title: "Loop Wipe 4"
description: "Each incoming image wipes over the last. 8 image slots, 21s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-wipe-4.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-wipe-4.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-wipe-4" item="loop-wipe-4" />

That writes one file: `compositions/loop-wipe-4.html`.

## Add it to your video

It runs for 21 seconds at 1080×1080. Paste this into your composition:

```html index.html
<div
  data-composition-id="loop-wipe-4"
  data-composition-src="compositions/loop-wipe-4.html"
  data-start="0"
  data-duration="21"
  data-track-index="1"
  data-width="1080"
...
| `delay` | `1` | 0s to 10s, step 0.1s | Hold time between steps, seconds. |
...
| `planeSize` | `68` | 0 to 200, step 1 | Card size in scene units. |
| `scale` | `0` | 0 to 8, step 0.1 | Scale (engine parameter; see the block header comment). |
| `feather` | `0` | 0 to 2, step 0.01 | Feather (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-wipe-4-bg"></div>
        <div id="loop-wipe-4-stage"></div>
      </div>
    </div>
    <script>
      ...
      (async () => {
        ...
        const __V = Object.assign(
          ...
          (window.__hyperframes && window.__hyperframes.getVariables
            ...
            : null) || {},
          { loopDuration: 21, loopRepeat: 2, imageCount: 8 },
        );
        const __PH = [
        ...
        document.getElementById("loop-wipe-4-loop").dataset.duration = DUR;
        background(document.getElementById("loop-wipe-4-bg"));
        const stage = document.getElementById("loop-wipe-4-stage");
        ...
        window.__timelines["loop-wipe-4"] = tl;
      })();
    </script>
  </body>
</html>
...
Tagged `loop` `images` `showcase` `gallery` `wipe`.
