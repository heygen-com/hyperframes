...
<CatalogDetail
  previewSrc="/public/catalog/blocks/logo-outro.json"
  compositionId="logo-outro"
  compositionSrc="compositions/logo-outro.html"
  title="Logo Outro"
  description="Cinematic logo reveal with piece-by-piece assembly, glow bloom, tagline fade-in, and URL pill"
  variables={[]}
  meta={{"duration":6,"width":1920,"height":1080,"category":"Blocks","badge":"Stable","codeLines":226}}
  attribution={{"path":"registry/blocks/logo-outro","tags":["branding","outro","logo"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/logo-outro/logo-outro.html"
>

<CatalogSlot slot="code">

```html logo-outro.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
