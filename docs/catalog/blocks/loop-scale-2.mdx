...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-scale-2.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-scale-2.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-scale-2" item="loop-scale-2" />

That writes one file: `compositions/loop-scale-2.html`.
...
```html index.html
<div
  data-composition-id="loop-scale-2"
  data-composition-src="compositions/loop-scale-2.html"
  data-start="0"
  data-duration="4"
  data-track-index="1"
  data-width="1080"
...
| `stagger` | `0.4` | 0 to 2, step 0.01 | Stagger (engine parameter; see the block header comment). |
...
| `scaleStyle` | `recede` | `bloom`, `recede` | Scale Style (engine parameter; see the block header comment). |
| `growFrom` | `center` | `center`, `top`, `bottom`, `left`, `right` | Grow From (engine parameter; see the block header comment). |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-scale-2-bg"></div>
        <div id="loop-scale-2-stage"></div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-scale-2-loop").dataset.duration = DUR;
        background(document.getElementById("loop-scale-2-bg"));
        const stage = document.getElementById("loop-scale-2-stage");
        ...
        window.__timelines["loop-scale-2"] = tl;
      })();
    </script>
  </body>
</html>
