...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-apple-terminal-red-sands.json"
  compositionId="code-snippet-apple-terminal-red-sands"
  compositionSrc="compositions/code-snippet-apple-terminal-red-sands.html"
  title="Code Snippet - Apple Terminal Red Sands"
  description="Apple Terminal Red Sands profile: deep red background with sandy text, per-character typing animation of a shell session."
  variables={[]}
  meta={{"duration":12,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":244}}
  attribution={{"path":"registry/blocks/code-snippet-apple-terminal-red-sands","tags":["code","developer","showcase","terminal","apple","apple-terminal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-apple-terminal-red-sands/code-snippet-apple-terminal-red-sands.html"
>

<CatalogSlot slot="code">

```html code-snippet-apple-terminal-red-sands.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
