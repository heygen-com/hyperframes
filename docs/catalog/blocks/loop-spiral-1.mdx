...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-1.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-spiral-1.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-spiral-1" item="loop-spiral-1" />

That writes one file: `compositions/loop-spiral-1.html`.
...
<div
  ...
  data-composition-src="compositions/loop-spiral-1.html"
  data-start="0"
  data-duration="10"
  data-track-index="1"
  data-width="1080"
...
| `count` | `70` | 0 to 240, step 10 | Count (engine parameter; see the block header comment). |
| `radius` | `1060` | 0 to 6000, step 10 | Radius (engine parameter; see the block header comment). |
| `turns` | `6` | 0 to 20, step 0.1 | Turns (engine parameter; see the block header comment). |
...
| `planeSize` | `250` | 0 to 1620, step 10 | Card size in scene units. |
| `distance` | `3050` | 0 to 9300, step 10 | Camera distance from the formation. |
