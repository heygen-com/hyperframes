...
<CatalogDetail
  previewSrc="/public/catalog/blocks/domain-warp-dissolve.json"
  compositionId="domain-warp-dissolve"
  compositionSrc="compositions/domain-warp-dissolve.html"
  title="Domain Warp Dissolve"
  description="Shader transition with fractal noise domain warping"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":380}}
  attribution={{"path":"registry/blocks/domain-warp-dissolve","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/domain-warp-dissolve/domain-warp-dissolve.html"
>

<CatalogSlot slot="code">

```html domain-warp-dissolve.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
