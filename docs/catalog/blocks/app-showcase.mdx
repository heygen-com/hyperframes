...
<CatalogDetail
  previewSrc="/public/catalog/blocks/app-showcase.json"
  compositionId="app-showcase"
  compositionSrc="compositions/app-showcase.html"
  title="App Showcase"
  description="Fitness app product showcase with three floating smartphone screens"
  variables={[]}
  meta={{"duration":5.5,"width":1920,"height":1080,"category":"Showcases","badge":"Stable","codeLines":947}}
  attribution={{"path":"registry/blocks/app-showcase","tags":["showcase","app","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/app-showcase/app-showcase.html"
>

<CatalogSlot slot="code">

```html app-showcase.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
