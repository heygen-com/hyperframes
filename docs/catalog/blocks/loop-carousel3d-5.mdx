---
title: "Loop Carousel 3D 5"
description: "Radial image panes spin around a vertical axis like a paddle wheel under a 3D camera. 8 image slots, 20s seamless loop, 1:1."
---

import { InstallCommand } from "/snippets/install-command.jsx";

<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-5.mp4" poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/blocks/loop-carousel3d-5.png" autoPlay muted loop playsInline />

## Install

<InstallCommand command="npx hyperframes add loop-carousel3d-5" item="loop-carousel3d-5" />

That writes one file: `compositions/loop-carousel3d-5.html`.
...
```html index.html
<div
  data-composition-id="loop-carousel3d-5"
  data-composition-src="compositions/loop-carousel3d-5.html"
  data-start="0"
  data-duration="20"
  data-track-index="1"
  data-width="1080"
...
| `planeSize` | `250` | 0 to 820, step 10 | Card size in scene units. |
| `orbitRadius` | `480` | 0 to 960, step 10 | Ring radius in scene units. |
| `distance` | `1370` | 0 to 3740, step 10 | Camera distance from the formation. |
| `perspective` | `160` | 0 to 600, step 10 | Camera focal length: smaller = stronger perspective. |
| `rotationX` | `22` | -180° to 180°, step 1° | Formation tilt about the horizontal axis, degrees. |
...
| `offsetY` | `-6` | -100% to 100%, step 1% | Vertical offset of the formation, % of height. |
...
>
  ...
  <body>
    ...
    >
      ...
      >
        <div id="loop-carousel3d-5-bg"></div>
        <div id="loop-carousel3d-5-stage">
          <div id="loop-carousel3d-5-ring"><div id="loop-carousel3d-5-spin"></div></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script>
      (async () => {
        ...
        document.getElementById("loop-carousel3d-5-loop").dataset.duration = DUR;
        background(document.getElementById("loop-carousel3d-5-bg"));
        ...
        const Rpx = R * s;
        document.getElementById("loop-carousel3d-5-stage").style.perspective = f + "px";
        document.getElementById("loop-carousel3d-5-ring").style.transform =
          `translate3d(${(OX / 100) * W}px,${(OY / 100) * H}px,0) rotateX(${RX}deg) rotateY(${RY}deg) rotateZ(${RZ}deg)`;
        const spin = document.getElementById("loop-carousel3d-5-spin");
        for (let i = 0; i < N; i++) {
          const m = IMAGES[i],
        ...
        window.__timelines["loop-carousel3d-5"] = tl;
      })();
    </script>
  </body>
</html>
