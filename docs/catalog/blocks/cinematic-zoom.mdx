...
<CatalogDetail
  previewSrc="/public/catalog/blocks/cinematic-zoom.json"
  compositionId="cinematic-zoom"
  compositionSrc="compositions/cinematic-zoom.html"
  title="Cinematic Zoom"
  description="Shader transition with dramatic zoom blur"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/cinematic-zoom","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/cinematic-zoom/cinematic-zoom.html"
>

<CatalogSlot slot="code">

```html cinematic-zoom.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
