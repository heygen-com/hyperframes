...
<CatalogDetail
  previewSrc="/public/catalog/blocks/flash-through-white.json"
  compositionId="flash-through-white"
  compositionSrc="compositions/flash-through-white.html"
  title="Flash Through White"
  description="Shader transition with white flash crossfade"
  variables={[]}
  meta={{"duration":4,"width":1920,"height":1080,"category":"Shader Transitions","badge":"Stable","codeLines":366}}
  attribution={{"path":"registry/blocks/flash-through-white","tags":["transition","shader"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/flash-through-white/flash-through-white.html"
>

<CatalogSlot slot="code">

```html flash-through-white.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
