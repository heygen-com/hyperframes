...
<CatalogDetail
  previewSrc="/public/catalog/blocks/code-snippet-dark-plus.json"
  compositionId="code-snippet-dark-plus"
  compositionSrc="compositions/code-snippet-dark-plus.html"
  title="Code Snippet - Dark+"
  description="VS Code workbench with per-character typing animation in the Dark+ theme. Full editor chrome with activity bar, sidebar, tabs, terminal, and status bar."
  variables={[]}
  meta={{"duration":11,"width":1920,"height":1080,"category":"Code Snippets","badge":"Stable","codeLines":1056}}
  attribution={{"path":"registry/blocks/code-snippet-dark-plus","tags":["code","developer","showcase","vscode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/code-snippet-dark-plus/code-snippet-dark-plus.html"
>

<CatalogSlot slot="code">

```html code-snippet-dark-plus.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=1920, height=1080" />
    <title>Dark+ VS Code Theme Composition</title>
  </head>
  <body>
    <template id="vscode-dark-plus-template">
      <div
        id="root"
      ...
      >
        <main class="scene-content">
          <section class="header">
            <div>
              ...
              <h1 class="title"><span class="theme-label">Dark+</span></h1>
            </div>
            <p class="source-note">
              Typing `functional_toolkit.py` with workbench colors from
              <span class="theme-source">dark_plus.json</span>.
            </p>
          </section>
        ...
        <script>
          ...
          window.__timelines["vscode-dark-plus"] =
            window.__timelines["vscode-dark-plus"] || gsap.timeline({ paused: true });
          window.createVSCodeThemeComposition("vscode-dark-plus", {
            id: "dark-plus",
            label: "Dark+",
