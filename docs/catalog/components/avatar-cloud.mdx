          ...
          *::after {
          ...
          .ac-clip {
            ...
            background:
              radial-gradient(
                ellipse at 50% 47.5%,
                color-mix(in srgb, var(--brand, #6366f1) 16%, transparent),
                transparent 48%
              ),
              var(--bg, #0b0c10);
          }
          ...
          .ac-link {
            fill: none;
            stroke: color-mix(in srgb, var(--accent, #38bdf8) 56%, transparent);
            stroke-width: 1.8;
            vector-effect: non-scaling-stroke;
          }

          .ac-link-secondary {
            stroke: color-mix(in srgb, var(--brand, #6366f1) 38%, transparent);
            stroke-width: 1.2;
          }
          ...
          .ac-avatar {
            ...
            background: var(--ac-color, var(--brand, #6366f1));
            color: var(--bg, #0b0c10);
            ...
            box-shadow:
              ...
              0 0 2.2cqw color-mix(in srgb, var(--ac-color, var(--brand, #6366f1)) 32%, transparent),
              inset 0 0.12cqw 0 color-mix(in srgb, var(--fg, #f8fafc) 26%, transparent);
            will-change: transform, opacity;
          }

          .ac-avatar[data-tone="0"] {
            --ac-color: var(--brand, #6366f1);
          }

          .ac-avatar[data-tone="1"] {
            --ac-color: var(--accent, #38bdf8);
          }
          ...
          .ac-avatar[data-tone="3"] {
            --ac-color: color-mix(in srgb, var(--brand, #6366f1) 54%, var(--fg, #f8fafc));
          }

          .ac-avatar[data-tone="4"] {
            --ac-color: color-mix(in oklch, var(--accent, #38bdf8) 62%, var(--brand, #6366f1));
          }
          ...
          .ac-hub {
            ...
            background: color-mix(in srgb, var(--surface, #1e293b) 92%, var(--brand, #6366f1));
            box-shadow:
              0 2cqh 5cqh color-mix(in srgb, var(--bg, #0b0c10) 56%, transparent),
              0 0 4cqw color-mix(in srgb, var(--brand, #6366f1) 20%, transparent),
