...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-neon-accent.json"
  compositionId="caption-neon-accent"
  compositionSrc="compositions/components/caption-neon-accent.html"
  title="Neon Accent"
  description="Multi-color neon glow accents with wiggle drift animation"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":514}}
  attribution={{"path":"registry/components/caption-neon-accent","tags":["captions","caption-style","neon","glow","accent"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-neon-accent/caption-neon-accent.html"
>

<CatalogSlot slot="code">

```html caption-neon-accent.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
