...
<CatalogDetail
  previewSrc="/public/catalog/components/yt-camera-move.json"
  compositionId="yt-camera-move"
  compositionSrc="compositions/components/yt-camera-move.html"
  title="Camera Punch-In"
  description="Dynamic zoom, slide, and 3D tilt-pan helpers for any wrapper (video, include, card) with cubic-easing defaults and an edge-defocus pulse overlay"
  variables={[]}
  meta={{"category":"Camera","badge":"Stable","codeLines":175}}
  attribution={{"path":"registry/components/yt-camera-move","tags":["camera","zoom","effect","creator"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/yt-camera-move/yt-camera-move.html"
>

<CatalogSlot slot="code">

```html yt-camera-move.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
