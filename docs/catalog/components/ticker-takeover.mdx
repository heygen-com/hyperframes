...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/ticker-takeover.html"
  compositionId="ticker-takeover"
  compositionSrc="compositions/components/ticker-takeover.html"
  variables={[{"id":"options","type":"string","role":"content","label":"Options","description":"Comma-separated words shown by the ticker.","default":"faster,smarter,together,everywhere"},{"id":"final_word","type":"string","role":"content","label":"Final word","description":"Word the ticker locks on and promotes.","default":"together"},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Color used for the lock flash and promoted word.","default":"green","options":[{"value":"green","label":"Green"},{"value":"blue","label":"Blue"},{"value":"violet","label":"Violet"}]}]}
>
