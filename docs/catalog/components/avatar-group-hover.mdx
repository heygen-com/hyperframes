...
<CatalogDetail
  ...
  attribution={{"path":"registry/components/avatar-group-hover","tags":["video-primitive","transition-primitive","transitions-dev-port","avatar","hover"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/avatar-group-hover/avatar-group-hover.html"
>
