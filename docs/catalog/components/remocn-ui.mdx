...
<Accordion title={`remocn-ui.html`}>

```html
<!--
  Remocn UI - Operator Black primitive-kit summary.
...
<div data-hf-ui-root class="hf-remocn-remocn-ui">
  <div class="row"><span class="label">Controls</span><span class="hint">18 primitives</span></div>
  <div class="row"><span class="label">Overlays</span><span class="hint">12 primitives</span></div>
  <div class="row"><span class="label">Feedback</span><span class="hint">9 primitives</span></div>
</div>
...
<style>
  ...
  .hf-remocn-remocn-ui .label {
    font-size: 13px;
    font-weight: var(--_hf-ui-weight-medium);
  }
  .hf-remocn-remocn-ui .hint {
    color: var(--hf-muted);
    font: var(--_hf-ui-weight-regular) 11px/1 var(--_hf-ui-font-mono);
  }
  .hf-remocn-remocn-ui .row:nth-child(2) {
    background: var(--_hf-ui-surface-inset);
    box-shadow: inset 2px 0 0 var(--hf-accent);
  }
</style>

<!--
  Timeline integration:
  tl.set('.hf-remocn-remocn-ui', { opacity: 1 }, startTime);
  tl.fromTo('.hf-remocn-remocn-ui .row', { '--hf-row-x': '-4px', '--hf-row-opacity': 0 }, { '--hf-row-x': '0px', '--hf-row-opacity': 1, duration: 0.16, ease: 'power2.out' }, startTime);
-->
```
