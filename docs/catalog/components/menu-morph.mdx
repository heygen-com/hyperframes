...
<CatalogDetail
  ...
  compositionSrc="compositions/components/menu-morph.html"
  title="Menu Morph"
  description="A transitions.dev-inspired hamburger and plus-menu morph primitive for compact action menus"
  variables={[{"id":"actions","type":"string","role":"content","label":"Actions","description":"Comma separated labels for the pills that fan out under the button. Up to six.","default":"Text, Image, Audio"},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Colour of the round button behind the white bars.","default":"ink","options":[{"value":"ink","label":"Ink"},{"value":"green","label":"Green"},{"value":"blue","label":"Blue"},{"value":"violet","label":"Violet"}]},{"id":"size","type":"number","role":"layout","label":"Button size","description":"Diameter of the round button in pixels. The bars scale with it.","default":68,"min":52,"max":112,"step":4,"unit":"px"}]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":161}}
  attribution={{"path":"registry/components/menu-morph","tags":["video-primitive","transition-primitive","transitions-dev-port","menu","morph"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/menu-morph/menu-morph.html"
>
