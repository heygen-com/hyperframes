...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-matrix-decode.json"
  compositionId="caption-matrix-decode"
  compositionSrc="compositions/components/caption-matrix-decode.html"
  title="Matrix Decode"
  description="Character scramble animation before text reveal"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":254}}
  attribution={{"path":"registry/components/caption-matrix-decode","tags":["captions","caption-style","matrix","scramble","decode"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-matrix-decode/caption-matrix-decode.html"
>

<CatalogSlot slot="code">

```html caption-matrix-decode.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
