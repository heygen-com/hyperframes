...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-particle-burst.json"
  compositionId="caption-particle-burst"
  compositionSrc="compositions/components/caption-particle-burst.html"
  title="Particle Burst"
  description="Keyword words trigger colored particle explosions"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":296}}
  attribution={{"path":"registry/components/caption-particle-burst","tags":["captions","caption-style","particles","burst","effects"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-particle-burst/caption-particle-burst.html"
>

<CatalogSlot slot="code">

```html caption-particle-burst.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
