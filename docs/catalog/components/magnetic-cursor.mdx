...
<CatalogDetail
  ...
  video="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/magnetic-cursor.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/magnetic-cursor.png"
  hasCode
