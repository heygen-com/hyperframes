...
description: "A soft dot pointer glides across an editor toolbar, is pulled into each button and morphs into its rounded hover plate while the icon leans toward it, presses one, and leaves as a dot."
mode: "frame"
---
...
<CatalogDetail
  previewSrc="/public/catalog/components/magnetic-cursor.json"
  compositionId="magnetic-cursor"
  compositionSrc="compositions/components/magnetic-cursor.html"
  title="Magnetic Cursor"
  description="A soft dot pointer glides across an editor toolbar, is pulled into each button and morphs into its rounded hover plate while the icon leans toward it, presses one, and leaves as a dot."
  variables={[{"id":"accent","type":"color","role":"style","label":"Accent","default":"#3b82f6"},{"id":"tone","type":"enum","role":"style","label":"Tone","default":"light","options":[{"value":"light","label":"Light toolbar"},{"value":"dark","label":"Dark toolbar"}]},{"id":"visits","type":"string","role":"content","label":"Buttons visited","description":"Comma-separated indexes 0-5: bold, italic, underline, link, list, image.","default":"0,3,5"},{"id":"press","type":"number","role":"timing","label":"Pressed visit","default":2,"min":1,"max":3,"step":1}]}
  meta={{"category":"Cursors","badge":"Stable","codeLines":370}}
  attribution={{"path":"registry/components/magnetic-cursor","tags":["cursor","motion-primitive","pointer","hover","morph","toolbar"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/magnetic-cursor/magnetic-cursor.html"
>

<CatalogSlot slot="code">

```html magnetic-cursor.html
<!doctype html>
<!--
...
<InstallCommand command="npx hyperframes add magnetic-cursor" item="magnetic-cursor" />

That writes one file: `compositions/components/magnetic-cursor.html`.
...
Open `compositions/components/magnetic-cursor.html` and copy what is inside into your own composition.
...
| `visits` | `0,3,5` | string | Comma-separated indexes 0-5: bold, italic, underline, link, list, image. |
| `press` | `2` | 1 to 3, step 1 |  |
...
<div
  data-composition-id="magnetic-cursor"
  data-composition-src="compositions/components/magnetic-cursor.html"
  data-variable-values='{"accent":"#3b82f6","tone":"light","visits":"0,3,5","press":2}'
></div>
```

{/* hf:generated-footer */}

Tagged `cursor` `motion-primitive` `pointer` `hover` `morph` `toolbar`.
