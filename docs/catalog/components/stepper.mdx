...
<Accordion title={`stepper.html`}>

```html
<!--
  Stepper - Operator Black horizontal progress primitive for HyperFrames.
...
<div data-hf-ui-root class="hf-ui-stepper" role="list" aria-label="Render progress">
  <div class="hf-ui-stepper-line"><div class="hf-ui-stepper-fill"></div></div>
  <div class="hf-ui-step is-done" role="listitem"><span>1</span><strong>Prompt</strong></div>
  <div class="hf-ui-step is-active" role="listitem" aria-current="step">
    <span>2</span><strong>Preview</strong>
  </div>
  <div class="hf-ui-step" role="listitem"><span>3</span><strong>Render</strong></div>
</div>
...
<style>
  ...
  .hf-ui-step span {
    ...
    font: var(--_hf-ui-weight-semibold) 12px/1 var(--_hf-ui-font-mono);
    box-shadow: var(--_hf-ui-shadow-inset);
  }
  .hf-ui-step.is-done span,
  .hf-ui-step.is-active span {
...
<!--
  ...
  tl.fromTo('.hf-ui-stepper-fill', { clipPath: 'inset(0 100% 0 0)' }, { clipPath: 'inset(0 0% 0 0)', duration: 0.72, ease: 'power3.out' }, 0.35);
  tl.fromTo('.hf-ui-step', { y: 4, opacity: 0 }, { y: 0, opacity: 1, duration: 0.16, stagger: 0.04, ease: 'power3.out' }, 0.35);
  tl.to('.hf-ui-step.is-active span', { opacity: 0.82, duration: 0.12, ease: 'power3.out' }, 1.05);
  tl.to('.hf-ui-step.is-active span', { opacity: 1, duration: 0.12, ease: 'power3.out' }, 1.17);
-->
```
