...
<CatalogDetail
  ...
  compositionSrc="compositions/components/shared-axis-y.html"
  title="Shared Axis Y"
  description="Per-word vertical shared-axis transition for sharp editorial swaps."
  variables={[{"id":"direction","type":"enum","role":"motion","label":"Direction","description":"Which side of the baseline the words travel in from.","default":"up","options":[{"value":"up","label":"Up"},{"value":"down","label":"Down"}]},{"id":"distance","type":"enum","role":"motion","label":"Distance","description":"Scales the vertical offset, so the words cover a shorter or longer run in the same time.","default":"standard","options":[{"value":"close","label":"Close"},{"value":"standard","label":"Standard"},{"value":"far","label":"Far"}]},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Word colour: ink for light frames, paper for dark ones, accent rides --brand.","default":"ink","options":[{"value":"ink","label":"Ink"},{"value":"paper","label":"Paper"},{"value":"accent","label":"Accent"}]}]}
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":98}}
  attribution={{"path":"registry/components/shared-axis-y","tags":["motion-primitive","typography"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/shared-axis-y/shared-axis-y.html"
>
...
<!--
  ...
  keeps driving one vertical offset, and these decide what that offset means
  on screen. At rest the offset is 0, so every setting lands on the same
  final frame.

    - direction (up | down, default up): which side of the baseline the words
      travel in from. up rises into place, down drops in.
  ...
  On every default the result is identical to the original: words rise 32px
  into place in near-black.
-->
...
```html wrap
<div
  data-composition-id="shared-axis-y"
  data-composition-src="compositions/components/shared-axis-y.html"
  data-variable-values='{"direction":"up","distance":"standard","tone":"ink"}'
></div>
```
