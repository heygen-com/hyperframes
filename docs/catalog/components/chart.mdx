...
<figure data-hf-ui-root class="hf-ui-chart" role="img" aria-label="Weekly usage bar chart">
  <div>
...
<style>
  ...
  .hf-ui-chart span {
    ...
    background: var(--_hf-ui-data-1);
    transform: scaleY(var(--hf-chart-progress, 1));
    transform-origin: bottom;
    will-change: transform;
  }
  .hf-ui-chart span:nth-child(2) {
    background: var(--_hf-ui-data-2);
  }
  .hf-ui-chart span:nth-child(3) {
    background: var(--_hf-ui-data-3);
  }
  .hf-ui-chart span:nth-child(4) {
    background: var(--_hf-ui-data-4);
  }
