...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":378}}
  attribution={{"path":"registry/components/touch-indicator","tags":["cursor","motion-primitive","mobile","gesture","touch","pointer"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/touch-indicator/touch-indicator.html"
>
...
Tagged `cursor` `motion-primitive` `mobile` `gesture` `touch` `pointer`.
