...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":390}}
  attribution={{"path":"registry/components/cursor-glyph-trail","tags":["cursor","motion-primitive","demonstrate","trail","glyphs","deterministic"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/cursor-glyph-trail/cursor-glyph-trail.html"
>
...
Tagged `cursor` `motion-primitive` `demonstrate` `trail` `glyphs` `deterministic`.
