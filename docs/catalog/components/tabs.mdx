...
<Accordion title={`tabs.html`}>

```html
<!--
  Tabs - Operator Black tab primitive for HyperFrames.

  Animate --hf-tabs-index between 0 and 1 for two tabs. Add more triggers by
  changing the indicator width and index math.
-->

<div data-hf-ui-root class="hf-ui-tabs">
  <div class="hf-ui-tabs-list" role="tablist">
    <span class="hf-ui-tabs-indicator" aria-hidden="true"></span>
    <button
      id="hf-ui-tabs-preview-tab"
      class="hf-ui-tabs-trigger"
      type="button"
      role="tab"
      aria-selected="true"
      aria-controls="hf-ui-tabs-preview-panel"
      tabindex="0"
    >
      Preview
    </button>
    <button
      id="hf-ui-tabs-exports-tab"
      class="hf-ui-tabs-trigger"
      type="button"
      role="tab"
      aria-selected="false"
      aria-controls="hf-ui-tabs-exports-panel"
      tabindex="-1"
    >
      Exports
    </button>
  ...
  <div
    id="hf-ui-tabs-preview-panel"
    class="hf-ui-tabs-panel"
    role="tabpanel"
    aria-labelledby="hf-ui-tabs-preview-tab"
  >
    <span class="hf-ui-tabs-kicker">Preview ready</span>
    <strong>12 scenes assembled</strong>
  </div>
  <div
    id="hf-ui-tabs-exports-panel"
    class="hf-ui-tabs-panel-secondary"
    role="tabpanel"
    aria-labelledby="hf-ui-tabs-exports-tab"
    hidden
  >
    <span class="hf-ui-tabs-secondary-kicker">Export queue</span>
    <strong>3 formats prepared</strong>
  </div>
</div>
...
<style>
  ...
  .hf-ui-tabs-indicator {
    ...
    transform: translateX(calc(var(--hf-tabs-index) * 100%));
  ...
  .hf-ui-tabs-trigger[aria-selected="true"] {
    color: var(--_hf-ui-text-strong);
  }
  .hf-ui-tabs-trigger:focus-visible {
    border-radius: var(--_hf-ui-radius-control);
    outline: 2px solid var(--_hf-ui-accent);
    outline-offset: 3px;
  }
  .hf-ui-tabs-trigger:active {
  ...
  .hf-ui-tabs-panel-secondary {
    display: grid;
    gap: 6px;
    padding: 0 4px;
  }
  .hf-ui-tabs-panel-secondary[hidden] {
    display: none;
  }
  .hf-ui-tabs-secondary-kicker {
    color: var(--_hf-ui-text-muted);
    font-size: 12px;
    font-weight: var(--_hf-ui-weight-medium);
  }
  .hf-ui-tabs-panel-secondary strong {
    color: var(--_hf-ui-text-strong);
    font-size: 20px;
    font-weight: var(--_hf-ui-weight-semibold);
    line-height: 1.2;
  ...
  @media (hover: hover) and (pointer: fine) {
    .hf-ui-tabs-trigger:hover {
      color: var(--_hf-ui-text);
    }
  }
  @media (pointer: coarse) {
    .hf-ui-tabs-trigger::before {
      position: absolute;
...
<!--
  ...
  tl.to(".hf-ui-tabs", { "--hf-tabs-index": 1, duration: 0.21, ease: "power3.out" }, startTime);
-->
```
