...
<CatalogDetail
  ...
  video="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-context-menu.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-context-menu.png"
  hasCode
