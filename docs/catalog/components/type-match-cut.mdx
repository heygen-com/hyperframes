...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/type-match-cut.html"
  compositionId="type-match-cut"
  compositionSrc="compositions/components/type-match-cut.html"
  variables={[{"id":"text","type":"string","role":"content","label":"Headline","description":"Text split around the incoming panel.","default":"Meet the new editor"},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Accent color used by the incoming editor scene.","default":"green","options":[{"value":"green","label":"Green"},{"value":"blue","label":"Blue"},{"value":"violet","label":"Violet"}]}]}
>
