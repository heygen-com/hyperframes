...
<CatalogDetail
  ...
  compositionSrc="compositions/components/skeleton-reveal.html"
  title="Skeleton Reveal"
  description="A skeleton loader transition that pulses, then cross-fades into content"
  variables={[{"id":"name","type":"string","role":"content","label":"Name","description":"Primary line revealed once the skeleton fades out.","default":"Jane Cooper"},{"id":"detail","type":"string","role":"content","label":"Detail","description":"Secondary line under the name, such as an email or a role.","default":"jane@example.com"},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Card palette. Light is the paper card, dark is a near-black card with the matching skeleton bars and text.","default":"light","options":[{"value":"light","label":"Light"},{"value":"dark","label":"Dark"}]}]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":130}}
  attribution={{"path":"registry/components/skeleton-reveal","tags":["video-primitive","transition-primitive","transitions-dev-port","skeleton","reveal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/skeleton-reveal/skeleton-reveal.html"
>
...
<!--
  ...
  CSS below consumes, or straight onto the revealed text. The timeline recipe
  stays untouched: it keeps sweeping the skeleton and cross-fading to the
  content, and these decide what that content says and what both halves look
  like.

    - name (string, default Jane Cooper): the primary line revealed once the
      skeleton fades out. Blank falls back to the default.
    - detail (string, default jane@example.com): the secondary line under the
      name, such as an email or a role. Blank falls back to the default.
    - tone (light | dark, default light): card palette. Light is the paper card
      with grey bars, dark is a near-black card with the matching skeleton bars
      and text, for compositions on a dark stage.

  On every default the result is identical to the original: a white card that
  shimmers, then reveals Jane Cooper and jane@example.com.
-->

<div
  class="hf-transition-skeleton-reveal"
...
```html wrap
<div
  data-composition-id="skeleton-reveal"
  data-composition-src="compositions/components/skeleton-reveal.html"
  data-variable-values='{"name":"Jane Cooper","detail":"jane@example.com","tone":"light"}'
></div>
```
