      ...
      <div id="root" data-composition-id="ink-bleed-reveal" data-duration="4" data-fps="30">
        ...
        >
          <svg aria-hidden="true" width="0" height="0" style="position: absolute">
            <defs>
              <filter id="ibr-grain-filter" x="0%" y="0%" width="100%" height="100%" color-interpolation-filters="sRGB">
                <feTurbulence type="fractalNoise" baseFrequency="0.82" numOctaves="2" seed="11" stitchTiles="stitch" result="noise" />
                <feColorMatrix
                  in="noise"
                  type="matrix"
