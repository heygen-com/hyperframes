...
| --- | --- | --- | --- |
| `tint` | `green` | `green`, `blue`, `violet`, `amber` | Colour pair, a pale halo behind a saturated mark. |
...
<!--
  ...
  big it is, what colour it wears and how far the pop swings.
    ...
    - tint (green | blue | violet | amber, default green): the colour pair, a
      pale halo behind a saturated mark. Both halves are literal colours, so
      the pair stays legible whatever the surrounding theme tokens hold.
...
<div
  ...
  data-composition-variables='[
    { "id": "tint", "type": "enum", "role": "style", "label": "Tint", "description": "Colour pair, a pale halo behind a saturated mark.", "default": "green", "options": [{ "value": "green", "label": "Green" }, { "value": "blue", "label": "Blue" }, { "value": "violet", "label": "Violet" }, { "value": "amber", "label": "Amber" }] },
...
<script>
  (function () {
    ...
    var tints = {
      ...
      blue: { halo: "#dbeafe", ink: "#2563eb" },
      violet: { halo: "#ede9fe", ink: "#7c3aed" },
