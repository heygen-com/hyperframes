...
<CatalogDetail
  ...
  attribution={{"path":"registry/components/number-pop-in","tags":["video-primitive","transition-primitive","transitions-dev-port","number","pop"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/number-pop-in/number-pop-in.html"
>
