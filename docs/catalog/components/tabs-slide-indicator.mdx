...
<CatalogDetail
  ...
  meta={{"category":"Effects","badge":"Stable","codeLines":169}}
  attribution={{"path":"registry/components/tabs-slide-indicator","tags":["transition-primitive","transitions-dev-port","tabs","indicator"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/tabs-slide-indicator/tabs-slide-indicator.html"
>
