...
| --- | --- | --- | --- |
| `accent` | `ink` | `ink`, `green`, `blue`, `violet` | Fill of the sliding pill, with a drop shadow tinted to match. |
...
<!--
  ...
  wide that tab is, what the pill looks like and what the tabs say.
    ...
    - accent (ink | green | blue | violet, default ink): fill of the sliding
      pill, with a drop shadow tinted to match. The labels sitting on it stay
      white, so all four keep the active tab readable.
...
<div
  ...
  data-composition-variables='[
    { "id": "accent", "type": "enum", "role": "style", "label": "Accent", "description": "Fill of the sliding pill, with a drop shadow tinted to match.", "default": "ink", "options": [{ "value": "ink", "label": "Ink" }, { "value": "green", "label": "Green" }, { "value": "blue", "label": "Blue" }, { "value": "violet", "label": "Violet" }] },
...
<style>
  ...
  .hf-transition-tabs-slide-indicator .indicator {
    ...
    box-shadow: 0 12px 26px var(--hf-tab-shadow, rgba(24, 24, 27, 0.18));
  }
...
<script>
  (function () {
    ...
    var accents = {
      ink: { fill: "#18181b", shadow: "rgba(24, 24, 27, 0.18)" },
      green: { fill: "#16a34a", shadow: "rgba(22, 163, 74, 0.24)" },
      blue: { fill: "#2563eb", shadow: "rgba(37, 99, 235, 0.24)" },
      violet: { fill: "#7c3aed", shadow: "rgba(124, 58, 237, 0.24)" },
    };
    ...
    for (var i = 0; i < roots.length; i += 1) {
      roots[i].style.setProperty("--hf-tab-fill", accent.fill);
      roots[i].style.setProperty("--hf-tab-shadow", accent.shadow);
