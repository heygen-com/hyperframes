...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-clip-wipe.json"
  compositionId="caption-clip-wipe"
  compositionSrc="compositions/components/caption-clip-wipe.html"
  title="Clip Wipe"
  description="Left-to-right clip-path wipe reveal per word"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":226}}
  attribution={{"path":"registry/components/caption-clip-wipe","tags":["captions","caption-style","wipe","clip-path","reveal"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-clip-wipe/caption-clip-wipe.html"
>

<CatalogSlot slot="code">

```html caption-clip-wipe.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
