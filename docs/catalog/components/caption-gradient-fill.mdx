...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-gradient-fill.json"
  compositionId="caption-gradient-fill"
  compositionSrc="compositions/components/caption-gradient-fill.html"
  title="Gradient Fill"
  description="Gradient-clipped text with elastic bounce entrance"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":219}}
  attribution={{"path":"registry/components/caption-gradient-fill","tags":["captions","caption-style","gradient","colorful"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-gradient-fill/caption-gradient-fill.html"
>

<CatalogSlot slot="code">

```html caption-gradient-fill.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
