...
<iframe src="/public/catalog/preview/components/three-orbiting-cards.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Three Orbiting Cards preview" />

## Install

<InstallCommand command="npx hyperframes add three-orbiting-cards" />

That writes one file: `compositions/components/three-orbiting-cards.html`.

## Source

<Accordion title={`three-orbiting-cards.html`}>
