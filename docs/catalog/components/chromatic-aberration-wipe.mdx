...
<CatalogDetail
  ...
  compositionSrc="compositions/components/chromatic-aberration-wipe.html"
  title="Chromatic Aberration Wipe"
  description="A fast slide wipe with RGB channel split on peak frames."
  variables={[{"id":"direction","type":"enum","role":"motion","label":"Direction","description":"The direction the reveal travels; both scenes slide the same way and the wipe edge follows.","default":"left","options":[{"value":"left","label":"Left"},{"value":"right","label":"Right"},{"value":"up","label":"Up"},{"value":"down","label":"Down"}]},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Colour family of the incoming scene's gradient.","default":"blue","options":[{"value":"blue","label":"Blue"},{"value":"green","label":"Green"},{"value":"violet","label":"Violet"}]},{"id":"aberration","type":"number","role":"style","label":"Aberration","description":"Multiplies the red/cyan channel split: 0 removes it, 1 is the stock strength, 2 doubles the offset and saturates the flash.","default":1,"min":0,"max":2,"step":0.1,"unit":"x"}]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":165}}
  attribution={{"path":"registry/components/chromatic-aberration-wipe","tags":["video-primitive","transition-primitive"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/chromatic-aberration-wipe/chromatic-aberration-wipe.html"
>
