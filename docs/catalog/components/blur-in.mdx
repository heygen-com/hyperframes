...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/blur-in.html"
  compositionId="blur-in"
  compositionSrc="compositions/components/blur-in.html"
  variables={[{"id":"size","type":"number","role":"style","label":"Size","description":"Type size of the revealed words in pixels; the gap between words scales with it.","default":52,"min":24,"max":120,"step":2,"unit":"px"},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Word colour: strong for headlines, muted for supporting lines, accent for the brand green.","default":"strong","options":[{"value":"strong","label":"Strong"},{"value":"muted","label":"Muted"},{"value":"accent","label":"Accent"}]},{"id":"align","type":"enum","role":"style","label":"Align","description":"Horizontal alignment of the words in the frame.","default":"left","options":[{"value":"left","label":"Left"},{"value":"center","label":"Center"},{"value":"right","label":"Right"}]}]}
>
