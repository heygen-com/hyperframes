...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/stop-motion-cadence.html"
      ...
      <div id="root" data-composition-id="stop-motion-cadence" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            root.style.setProperty("--smc-c2", "color-mix(in srgb, var(--fg, #f8fafc) 72%, transparent)");
            root.style.setProperty("--smc-c3", "color-mix(in srgb, var(--fg, #f8fafc) 45%, transparent)");
