...
<!--
  ...
  Variables (declared in data-composition-variables below):
    ...
    - accent ("green" | "blue" | "violet", default "green"): the lead
      ...
      rides --accent-2 (the other shapes take the remaining two tokens).
      ...
      <div id="root" data-composition-id="stop-motion-cadence" data-duration="4" data-fps="30">
        <style>
          ...
          *::after {
          ...
          .smc-shape {
            ...
            top: 0;
            opacity: 0;
            filter: drop-shadow(0.5cqmin 0.7cqmin 0 color-mix(in srgb, var(--bg, #000000) 35%, transparent));
          }
          ...
          .smc-star {
            ...
            height: 9cqmin;
            clip-path: polygon(
              50% 0%, 63% 34%, 98% 35%, 70% 57%, 81% 91%,
              50% 70%, 19% 91%, 30% 57%, 2% 35%, 37% 34%
            );
        ...
        <script>
          (function () {
            ...
            // The lead shape rides the chosen accent token; the other two
            // paper colors take the remaining tokens in rotation.
            var order = { green: ["green", "blue", "violet"], blue: ["blue", "violet", "green"], violet: ["violet", "green", "blue"] }[accent];
            root.style.setProperty("--smc-c1", accentColors[order[0]]);
            root.style.setProperty("--smc-c2", accentColors[order[1]]);
            root.style.setProperty("--smc-c3", accentColors[order[2]]);
            ...
            var throws = [
              { t0: 0.15, t1: 1.0, from: { x: -0.12 * W, yB: 0.28 * H }, to: 0.3 * W, arc: 0.3 * H, rot0: -170, rot1: 8, squash: 0.3, life: 2 },
              { t0: 0.6, t1: 1.5, from: { x: 1.12 * W, yB: 0.2 * H }, to: 0.56 * W, arc: 0.34 * H, rot0: 150, rot1: -6, squash: 0.34, life: 3 },
              { t0: 1.25, t1: 2.0, from: { x: 0.78 * W, yB: -0.12 * H }, to: 0.72 * W, arc: 0.06 * H, rot0: -120, rot1: 5, squash: 0.26, life: 2 },
              { t0: 1.8, t1: 2.55, from: { x: -0.08 * W, yB: 0.1 * H }, to: 0.43 * W, arc: 0.4 * H, rot0: 200, rot1: -12, squash: 0.22, life: 3 },
            ];
