...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/parallax-device-dive.html"
  compositionId="parallax-device-dive"
  compositionSrc="compositions/components/parallax-device-dive.html"
  variables={[{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Highlight color used throughout the app UI.","default":"blue","options":[{"value":"green","label":"Green"},{"value":"blue","label":"Blue"},{"value":"violet","label":"Violet"}]},{"id":"app_title","type":"string","role":"content","label":"App title","description":"Title displayed in the app header.","default":"Dashboard"}]}
>
