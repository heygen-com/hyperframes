...
<CatalogDetail
  previewSrc="/public/catalog/components/arc-motion-path.json"
  compositionId="arc-motion-path"
  compositionSrc="compositions/components/arc-motion-path.html"
  title="Arc Motion Path"
  description="A GSAP MotionPath primitive that flies a callout along a curved arc with autorotation."
  variables={[]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":99}}
  attribution={{"path":"registry/components/arc-motion-path","tags":["video-primitive","motionpath","gsap-plugin","hyperframes-native"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/arc-motion-path/arc-motion-path.html"
>

<CatalogSlot slot="code">

```html arc-motion-path.html
<!--
