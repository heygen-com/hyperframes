...
<div data-hf-ui-root class="hf-ui-scroll-area" role="region" tabindex="0" aria-label="Scene list">
...
<style>
  ...
  .hf-ui-scroll-content {
    display: grid;
    gap: 4px;
    transform: translateY(var(--hf-scroll-y, 0px));
  ...
  .hf-ui-scroll-thumb {
    ...
    transform: translateY(var(--hf-scroll-thumb-y, 0px));
    will-change: transform;
  }
