...
<VariablesExplorer
  ...
  compositionSrc="compositions/components/logo-wall.html"
  variables={[{"id":"rows","type":"number","role":"layout","label":"Rows","description":"Number of logo rows in the wall.","default":3,"min":2,"max":4,"step":1},{"id":"cols","type":"number","role":"layout","label":"Columns","description":"Number of logo columns in the wall.","default":5,"min":3,"max":6,"step":1},{"id":"stagger","type":"number","role":"motion","label":"Stagger","description":"Delay between consecutive logo cell entrances.","default":45,"min":20,"max":75,"step":1,"unit":"ms"}]}
>
...
<div
  ...
  data-composition-src="compositions/components/logo-wall.html"
  data-variable-values='{"rows":3,"cols":5,"stagger":45}'
></div>
```

## Source

<Accordion title={`logo-wall.html`}>
