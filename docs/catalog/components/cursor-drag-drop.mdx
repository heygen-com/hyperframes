...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":465}}
      ...
      <script>
        (function () {
          ...
          $("dd-stage").style.transform =
            ...
            "px) scale(" +
            fit +
            ") translate(960px,545px) scale(1.15) translate(-960px,-545px)";
          ...
          function render(t) {
            ...
            slot.style.opacity =
              t < T_DROP ? "1" : (1 - clamp01((t - T_DROP) / (0.3 * s))).toFixed(3);
