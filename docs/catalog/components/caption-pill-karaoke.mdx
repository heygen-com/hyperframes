...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-pill-karaoke.json"
  compositionId="caption-pill-karaoke"
  compositionSrc="compositions/components/caption-pill-karaoke.html"
  title="Pill Karaoke"
  description="Pill-shaped container with per-word karaoke color highlight"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":382}}
  attribution={{"path":"registry/components/caption-pill-karaoke","tags":["captions","caption-style","karaoke","pill"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-pill-karaoke/caption-pill-karaoke.html"
>

<CatalogSlot slot="code">

```html caption-pill-karaoke.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
