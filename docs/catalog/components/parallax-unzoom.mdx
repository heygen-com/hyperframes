...
<CatalogDetail
  previewSrc="/public/catalog/components/parallax-unzoom.json"
  compositionId="parallax-unzoom"
  compositionSrc="compositions/components/parallax-unzoom.html"
  title="Parallax Unzoom"
  description="Reveal transition — focus card scales down from full frame as siblings parallax in to form a grid (reverse of parallax-zoom)"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":103}}
  attribution={{"path":"registry/components/parallax-unzoom","tags":["transition","reveal","unzoom","parallax","grid","hero"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/parallax-unzoom/parallax-unzoom.html"
>

<CatalogSlot slot="code">

```html parallax-unzoom.html
<!--
