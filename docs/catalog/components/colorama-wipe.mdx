...
<CatalogDetail
  ...
  video="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/colorama-wipe.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/colorama-wipe.png"
  hasCode
