...
<CatalogDetail
  ...
  compositionSrc="compositions/components/drift-hold.html"
  title="Drift Hold"
  description="A centered content card stays subtly alive through loop-exact rotation, scale breathing, and a slow light sweep."
  variables={[{"id":"text","type":"string","role":"content","label":"Text","description":"Text displayed in the default centered card.","default":"Always alive"},{"id":"intensity","type":"enum","role":"motion","label":"Intensity","description":"Amplitude of the ambient rotation, breathing, and light sweep.","default":"standard","options":[{"value":"whisper","label":"Whisper"},{"value":"standard","label":"Standard"}]}]}
  meta={{"category":"Camera","badge":"Stable","codeLines":192}}
  attribution={{"path":"registry/components/drift-hold","tags":["motion-primitive","camera","ambient","drift","hold","loopable"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/drift-hold/drift-hold.html"
>
