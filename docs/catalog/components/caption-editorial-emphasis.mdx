...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-editorial-emphasis.json"
  compositionId="caption-editorial-emphasis"
  compositionSrc="compositions/components/caption-editorial-emphasis.html"
  title="Editorial Emphasis"
  description="Dual-font system with dramatic size contrast for emphasis words"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":412}}
  attribution={{"path":"registry/components/caption-editorial-emphasis","tags":["captions","caption-style","editorial","typography","emphasis"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-editorial-emphasis/caption-editorial-emphasis.html"
>

<CatalogSlot slot="code">

```html caption-editorial-emphasis.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
