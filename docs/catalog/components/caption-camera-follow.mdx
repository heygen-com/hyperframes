          ...
          (function () {
            ...
            function smear(centre, scale, count, at, up, down, peak) {
              for (var j = 0; j < count; j++) {
                ...
                var d =
                  (scale *
                    Math.sqrt(
                      (cx - centre.x) * (cx - centre.x) +
                        (cy - centre.y) * (cy - centre.y)
                    )) /
                  HALF_DIAG;
              ...
              tl.to(
                world,
                { "--amt": "0px", duration: down, ease: EASE_BLUR_DOWN },
                at + up
              );
            }
            ...
            WORDS.forEach(function (wd, i) {
              ...
              tl.fromTo(
                els[i],
                { opacity: 0 },
                { opacity: 1, duration: 0.16, ease: EASE_INK },
                t
              );
              ...
              tl.to(
                world,
                { x: p.x, y: p.y, scale: p.scale, duration: MOVE, ease: EASE_STEP },
                t
              );
