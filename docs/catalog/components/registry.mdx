...
<Accordion title={`registry.html`}>

```html
<!--
  Registry - Operator Black installable-component metadata list.
...
<div data-hf-ui-root class="hf-remocn-registry">
  <div class="row"><span class="label">button</span><span class="hint">component</span></div>
  <div class="row"><span class="label">dialog</span><span class="hint">overlay</span></div>
  <div class="row"><span class="label">chart</span><span class="hint">data</span></div>
</div>
...
<style>
  ...
  .hf-remocn-registry .label {
    font-family: var(--_hf-ui-font-mono);
    font-size: 13px;
    font-weight: var(--_hf-ui-weight-medium);
  }
  .hf-remocn-registry .hint {
    color: var(--hf-muted);
    font-size: 12px;
  }
  .hf-remocn-registry .row:nth-child(2) {
...
<!--
  ...
  tl.set('.hf-remocn-registry', { opacity: 1 }, startTime);
  tl.fromTo('.hf-remocn-registry .row', { '--hf-row-x': '-4px', '--hf-row-opacity': 0 }, { '--hf-row-x': '0px', '--hf-row-opacity': 1, duration: 0.16, ease: 'power2.out' }, startTime);
-->
```
