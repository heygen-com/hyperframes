...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-neon-glow.json"
  compositionId="caption-neon-glow"
  compositionSrc="compositions/components/caption-neon-glow.html"
  title="Neon Glow"
  description="Cyan and magenta neon glow with keyword accent colors"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":216}}
  attribution={{"path":"registry/components/caption-neon-glow","tags":["captions","caption-style","neon","glow","gaming"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-neon-glow/caption-neon-glow.html"
>

<CatalogSlot slot="code">

```html caption-neon-glow.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
