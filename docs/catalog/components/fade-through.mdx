...
<CatalogDetail
  ...
  meta={{"category":"Effects","badge":"Stable","codeLines":96}}
  attribution={{"path":"registry/components/fade-through","tags":["motion-primitive","transition","fade","scene"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/fade-through/fade-through.html"
>
