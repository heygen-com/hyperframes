...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-parallax-layers.json"
  compositionId="caption-parallax-layers"
  compositionSrc="compositions/components/caption-parallax-layers.html"
  title="Parallax Layers"
  description="Behind-subject 3D text layering with vertical stretch effect"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":355}}
  attribution={{"path":"registry/components/caption-parallax-layers","tags":["captions","caption-style","parallax","3d","depth"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-parallax-layers/caption-parallax-layers.html"
>

<CatalogSlot slot="code">

```html caption-parallax-layers.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
