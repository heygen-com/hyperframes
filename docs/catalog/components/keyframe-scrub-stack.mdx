...
<CatalogDetail
  previewSrc="/public/catalog/components/keyframe-scrub-stack.json"
  compositionId="keyframe-scrub-stack"
  compositionSrc="compositions/components/keyframe-scrub-stack.html"
  title="Keyframe Scrub Stack"
  description="A keyframe-sequenced stack of cards with offset timing and easing presets."
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":84}}
  attribution={{"path":"registry/components/keyframe-scrub-stack","tags":["advanced-motion","anime-inspired","hyperframes-native"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/keyframe-scrub-stack/keyframe-scrub-stack.html"
>

<CatalogSlot slot="code">

```html keyframe-scrub-stack.html
<!--
