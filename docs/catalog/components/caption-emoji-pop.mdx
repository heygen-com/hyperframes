...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-emoji-pop.json"
  compositionId="caption-emoji-pop"
  compositionSrc="compositions/components/caption-emoji-pop.html"
  title="Emoji Pop"
  description="Emoji integration with stroked text and horizontal squeeze entrance"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":467}}
  attribution={{"path":"registry/components/caption-emoji-pop","tags":["captions","caption-style","emoji","social"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-emoji-pop/caption-emoji-pop.html"
>

<CatalogSlot slot="code">

```html caption-emoji-pop.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
