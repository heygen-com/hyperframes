...
<CatalogDetail
  previewSrc="/public/catalog/components/parallax-zoom.json"
  compositionId="parallax-zoom"
  compositionSrc="compositions/components/parallax-zoom.html"
  title="Parallax Zoom"
  description="Center card scales up to fill the frame while siblings parallax outward — inspired by the eBay Playbook hero transition"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":99}}
  attribution={{"path":"registry/components/parallax-zoom","tags":["transition","zoom","parallax","grid","hero"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/parallax-zoom/parallax-zoom.html"
>

<CatalogSlot slot="code">

```html parallax-zoom.html
<!--
