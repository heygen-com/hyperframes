...
<CatalogDetail
  previewSrc="/public/catalog/components/onboarding-stepper-flow.json"
  compositionId="onboarding-stepper-flow"
  compositionSrc="compositions/components/onboarding-stepper-flow.html"
  title="Onboarding Stepper Flow"
  description="A composed onboarding flow with milestone rail, active step card, and next-action button"
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":92}}
  attribution={{"path":"registry/components/onboarding-stepper-flow","tags":["ui-flow","onboarding","stepper"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/onboarding-stepper-flow/onboarding-stepper-flow.html"
>

<CatalogSlot slot="code">

```html onboarding-stepper-flow.html
<!--
