...
<CatalogDetail
  previewSrc="/public/catalog/components/spotlight-card.json"
  compositionId="spotlight-card"
  compositionSrc="compositions/components/spotlight-card.html"
  title="Spotlight Card"
  description="A card with a scripted cursor spotlight and lit border."
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":105}}
  attribution={{"path":"registry/components/spotlight-card","tags":["effect"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/spotlight-card/spotlight-card.html"
>

<CatalogSlot slot="code">

```html spotlight-card.html
<!--
  Spotlight Card - catalog component for HyperFrames.
