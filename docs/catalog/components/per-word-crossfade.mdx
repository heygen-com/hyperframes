...
<iframe src="/public/catalog/preview/components/per-word-crossfade.html" className="w-full aspect-video rounded-xl border border-zinc-200 dark:border-zinc-800" loading="lazy" title="Per-Word Crossfade preview" />
