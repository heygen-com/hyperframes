...
<CatalogDetail
  ...
  compositionSrc="compositions/components/directional-wipe.html"
  title="Directional Wipe"
  description="A directional scene push that slides one panel over another."
  variables={[{"id":"palette","type":"enum","role":"style","label":"Palette","description":"Theme token for the ring marking the incoming panel. Slate rides --accent, teal --brand, ember --accent-2; each falls back to a neutral hairline.","default":"slate","options":[{"value":"slate","label":"Slate"},{"value":"teal","label":"Teal"},{"value":"ember","label":"Ember"}]},{"id":"corner","type":"enum","role":"style","label":"Corner","description":"Corner radius of the transition card.","default":"rounded","options":[{"value":"square","label":"Square"},{"value":"rounded","label":"Rounded"},{"value":"soft","label":"Soft"}]}]}
  meta={{"category":"Effects","badge":"Stable","codeLines":146}}
  attribution={{"path":"registry/components/directional-wipe","tags":["transition-primitive"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/directional-wipe/directional-wipe.html"
>
