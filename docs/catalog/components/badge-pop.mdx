...
<CatalogDetail
  ...
  compositionSrc="compositions/components/badge-pop.html"
  title="Badge Pop"
  description="A transitions.dev-inspired notification badge pop with elastic scale and count reveal"
  variables={[{"id":"count","type":"string","role":"style","label":"Count","description":"Text shown inside the notification badge, up to four characters.","default":"3","maxLength":4},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Colour family of the badge.","default":"red","options":[{"value":"red","label":"Red"},{"value":"blue","label":"Blue"},{"value":"green","label":"Green"},{"value":"violet","label":"Violet"}]},{"id":"surface","type":"enum","role":"style","label":"Surface","description":"Chrome of the button and the badge ring: light for bright frames, dark for dark ones.","default":"light","options":[{"value":"light","label":"Light"},{"value":"dark","label":"Dark"}]}]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":148}}
  attribution={{"path":"registry/components/badge-pop","tags":["video-primitive","transition-primitive","transitions-dev-port","badge","microinteraction"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/badge-pop/badge-pop.html"
>
...
<!--
  ...
  the CSS below consumes, or as the badge text. The timeline recipe at the
  bottom is untouched by them: it keeps popping the same badge, whatever the
  badge says and however it is coloured.

    - count (any text up to four characters, default "3"): what the badge
      reads. Use it to say 1, 12, 99+ or NEW.
    - accent (red | blue | green | violet, default red): the badge colour
      family. red is the literal notification convention; the other three ride
      the composition's own accent, brand and accent-2 tokens and fall back to
      ink when the composition declares none. All four clear 3:1 against the
      white count.
    - surface (light | dark, default light): the chrome of the button and the
      ring around the badge. light suits bright frames, dark suits dark ones.

  On every default the result is identical to the original: a white bell tile
  with a red 3 badge.
-->
