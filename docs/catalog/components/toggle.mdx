...
<Accordion title={`toggle.html`}>

```html
<!--
  Toggle - Operator Black pressed-state primitive for HyperFrames.
...
<button data-hf-ui-root class="hf-ui-toggle" type="button" aria-pressed="true">Bold</button>
...
<style>
  ...
  .hf-ui-toggle {
    ...
    transform: scale(var(--hf-toggle-scale));
  ...
  .hf-ui-toggle[aria-pressed="true"] {
  ...
  .hf-ui-toggle:active {
    --hf-toggle-scale: 0.98;
    transform: translateY(1px) scale(var(--hf-toggle-scale));
  }
  .hf-ui-toggle:disabled,
  .hf-ui-toggle[aria-disabled="true"] {
    --hf-toggle-scale: 1;
    cursor: not-allowed;
    opacity: 0.48;
    transform: none;
...
<!--
  ...
  tl.fromTo('.hf-ui-toggle', { '--hf-toggle-scale': 0.98 }, { '--hf-toggle-scale': 1, duration: 0.16, ease: 'power3.out' }, startTime);
-->
```
