      ...
      <div id="root" data-composition-id="stitched-text-draw" data-duration="4" data-fps="30">
        ...
        >
          <div class="std-stage" role="img">
            <svg class="std-svg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true"></svg>
          </div>
        </div>
        ...
        <script>
          (function () {
            ...
            var GLYPHS = {
              ...
              D: [join([[6, 2], [24, 2]], arcPts(24, 50, 40, 48, -90, 90), [[24, 98], [6, 98], [6, 4]])],
              E: [
                [[60, 2], [8, 2], [8, 98], [60, 98]],
                [[8, 50], [48, 50]],
              ],
              ...
              G: [join(arcPts(38, 50, 30, 46, -60, -305), [[56, 62], [38, 62]])],
              H: [
                [[8, 2], [8, 98]],
                [[62, 2], [62, 98]],
                [[8, 50], [62, 50]],
              ...
              J: [join([[58, 2], [58, 72]], arcPts(33, 72, 25, 26, 0, 180))],
              K: [
                [[8, 2], [8, 98]],
                [[60, 2], [8, 56]],
                [[24, 42], [62, 98]],
              ...
              L: [[[8, 2], [8, 98], [60, 98]]],
              M: [[[6, 98], [6, 2], [35, 58], [64, 2], [64, 98]]],
              N: [[[8, 98], [8, 2], [62, 98], [62, 2]]],
              O: [arcPts(35, 50, 30, 47, -90, 270)],
              P: [
                [[8, 98], [8, 2]],
                join([[8, 2], [36, 2]], arcPts(36, 27, 26, 25, -90, 90), [[36, 52], [8, 52]]),
              ],
              Q: [
              ...
              S: [
                [
                  [58, 14], [44, 3], [24, 3], [10, 14], [10, 30], [24, 42],
                  [46, 56], [58, 68], [58, 86], [44, 97], [22, 97], [8, 86],
                ],
              ],
              T: [
                [[6, 2], [64, 2]],
              ...
              U: [join([[8, 2], [8, 68]], arcPts(35, 68, 27, 29, 180, 360), [[62, 68], [62, 2]])],
              V: [[[6, 2], [35, 98], [64, 2]]],
              W: [[[4, 2], [19, 98], [35, 34], [51, 98], [66, 2]]],
              X: [
                [[8, 2], [62, 98]],
                [[62, 2], [8, 98]],
              ],
              ...
              Z: [[[8, 2], [62, 2], [8, 98], [62, 98]]],
              "0": [arcPts(35, 50, 27, 47, -90, 270)],
              "1": [[[20, 20], [38, 4], [38, 98]]],
              "2": [join(arcPts(35, 26, 26, 24, -160, 10), [[8, 98], [62, 98]])],
              ...
              "5": [
                [
                  [58, 3], [14, 3], [11, 44], [34, 38], [55, 48], [59, 72],
                  [46, 94], [20, 96], [8, 84],
                ],
              ],
              "6": [join([[52, 4], [28, 26], [13, 56]], arcPts(35, 72, 24, 26, -180, 180))],
              "7": [[[8, 3], [62, 3], [30, 98]]],
              "8": [join(arcPts(35, 27, 21, 24, 90, 450), arcPts(35, 74, 26, 25, -90, 270))],
              "9": [join(arcPts(37, 28, 25, 25, 0, 360), [[62, 28], [56, 64], [34, 98]])],
            };
            var GLYPH_W = 70;
            var SPACE_W = 40;
            var GAP = 24;
            ...
            for (var li = 0; li < letters.length; li += 1) {
              ...
              for (var sj = 0; sj < letter.strokes.length; sj += 1) {
                ...
                var d = "M " + stroke.points.map(function (pt) {
            ...
            needle.setAttribute(
              "stroke",
              "color-mix(in srgb, var(--std-accent) 60%, transparent)",
            );
