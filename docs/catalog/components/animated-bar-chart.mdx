...
<CatalogDetail
  previewSrc="/public/catalog/components/animated-bar-chart.json"
  compositionId="animated-bar-chart"
  compositionSrc="compositions/components/animated-bar-chart.html"
  title="Animated Bar Chart"
  description="A compact data card with deterministic bar growth and value callouts."
  variables={[]}
  meta={{"category":"Data","badge":"Stable","codeLines":98}}
  attribution={{"path":"registry/components/animated-bar-chart","tags":["data"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/animated-bar-chart/animated-bar-chart.html"
>

<CatalogSlot slot="code">

```html animated-bar-chart.html
<!--
