...
<CatalogDetail
  previewSrc="/public/catalog/components/svg-line-draw-loader.json"
  compositionId="svg-line-draw-loader"
  compositionSrc="compositions/components/svg-line-draw-loader.html"
  title="SVG Line Draw Loader"
  description="An Anime.js-style path drawing loader implemented as a seekable GSAP stroke timeline."
  variables={[]}
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":75}}
  attribution={{"path":"registry/components/svg-line-draw-loader","tags":["video-primitive","advanced-motion","anime-inspired","hyperframes-native"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/svg-line-draw-loader/svg-line-draw-loader.html"
>

<CatalogSlot slot="code">

```html svg-line-draw-loader.html
<!--
