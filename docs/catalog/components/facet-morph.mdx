  ...
  <body>
    <template>
      <div id="root" data-composition-id="facet-morph" data-duration="5" data-fps="30">
        ...
        >
          <div class="fm-stage">
            <svg class="fm-svg" viewBox="0 0 100 100" role="img" aria-label="Reshaping faceted mass">
              <g class="fm-mesh"></g>
            </svg>
          </div>
        </div>
            ...
            function render(t) {
              ...
              for (var fi = 0; fi < facets.length; fi += 1) {
                ...
                for (var v = 0; v < 3; v += 1) {
                  ...
                  var pt = kind === "o" ? outerPts[index] : kind === "i" ? innerPts[index] : centerPt;
                ...
                var shade =
                  (nx / len) * LIGHT_X + (ny / len) * LIGHT_Y + facetTilt[fi];
