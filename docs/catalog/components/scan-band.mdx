...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/scan-band.html"
  compositionId="scan-band"
  compositionSrc="compositions/components/scan-band.html"
  variables={[{"id":"wordmark","type":"string","role":"content","label":"Wordmark","description":"Text displayed by the scan effect.","default":"HYPERFRAMES"},{"id":"band_angle","type":"number","role":"layout","label":"Band angle","description":"Diagonal angle of the distortion band in degrees.","default":12,"min":-30,"max":30,"step":1,"unit":"deg"}]}
>
