...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":432}}
      ...
      <script>
        (function () {
          ...
          var duration = Math.max(
            0.001,
            parseFloat(
              root.dataset.duration || html.getAttribute("data-composition-duration") || "5.6",
            ),
          );
          ...
          function render(t) {
            ...
            var approach = {
              x: press.x + 150 * u,
              y: offsetIn(para).y + para.offsetHeight + 70 * u,
            };
