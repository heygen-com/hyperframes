...
<CatalogDetail
  ...
  video="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-text-select.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-text-select.png"
  hasCode
      ...
      <script>
        (function () {
          ...
          function render(t) {
            ...
            var m = Math.max(0, Math.min(1, (inside + 6 * u) / (24 * u)));
            var overBar =
