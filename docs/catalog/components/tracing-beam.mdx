...
<VariablesExplorer
  ...
  compositionSrc="compositions/components/tracing-beam.html"
  variables={[{"id":"labels","type":"string","role":"content","label":"Labels","description":"Three comma-separated labels shown in path order.","default":"Search,Preview,Export"},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Beam and active-element color.","default":"cyan","options":[{"value":"cyan","label":"Cyan"},{"value":"violet","label":"Violet"},{"value":"amber","label":"Amber"}]}]}
>
...
<div
  data-composition-id="tracing-beam"
  data-composition-src="compositions/components/tracing-beam.html"
  data-variable-values='{"labels":"Search,Preview,Export","accent":"cyan"}'
></div>
```

## Source

<Accordion title={`tracing-beam.html`}>
