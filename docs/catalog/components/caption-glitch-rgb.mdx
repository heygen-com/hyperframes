...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-glitch-rgb.json"
  compositionId="caption-glitch-rgb"
  compositionSrc="compositions/components/caption-glitch-rgb.html"
  title="Glitch RGB"
  description="RGB chromatic aberration with CRT scanline overlay"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":329}}
  attribution={{"path":"registry/components/caption-glitch-rgb","tags":["captions","caption-style","glitch","cyber","tech"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-glitch-rgb/caption-glitch-rgb.html"
>

<CatalogSlot slot="code">

```html caption-glitch-rgb.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
