...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-highlight.json"
  compositionId="caption-highlight"
  compositionSrc="compositions/components/caption-highlight.html"
  title="Highlight"
  description="Red background sweep behind each active word, TikTok-style"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":261}}
  attribution={{"path":"registry/components/caption-highlight","tags":["captions","caption-style","highlight","social","tiktok"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-highlight/caption-highlight.html"
>

<CatalogSlot slot="code">

```html caption-highlight.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
