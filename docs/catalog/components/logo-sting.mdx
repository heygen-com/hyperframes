...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/logo-sting.html"
  compositionId="logo-sting"
  compositionSrc="compositions/components/logo-sting.html"
  variables={[{"id":"wordmark","type":"string","role":"content","label":"Wordmark","description":"Brand name displayed in the final lockup.","default":"HYPERFRAMES"},{"id":"accent","type":"enum","role":"style","label":"Accent","description":"Color of the single impact ring.","default":"green","options":[{"value":"green","label":"Green"},{"value":"blue","label":"Blue"},{"value":"violet","label":"Violet"}]}]}
>
