...
<div data-hf-ui-root class="hf-ui-accordion">
...
<style>
  ...
  .hf-ui-accordion-trigger {
    ...
    font: var(--_hf-ui-weight-semibold) 14px/1.3 var(--_hf-ui-font-sans);
    text-align: start;
    cursor: pointer;
  ...
  .hf-ui-accordion-content {
    max-height: calc(var(--hf-accordion-open) * 112px);
    overflow: hidden;
    opacity: var(--hf-accordion-open);
  }
  .hf-ui-accordion-inner {
    padding: 0 40px calc(var(--hf-accordion-open) * 16px) 0;
