...
<CatalogDetail
  ...
  meta={{"category":"Motion Primitives","badge":"Stable","codeLines":104}}
  attribution={{"path":"registry/components/dynamic-grid","tags":["video-primitive","motion-primitive","background","grid","ui"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/dynamic-grid/dynamic-grid.html"
>
