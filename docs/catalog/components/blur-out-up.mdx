...
<CatalogDetail
  ...
  compositionSrc="compositions/components/blur-out-up.html"
  title="Blur Out Up"
  description="Words arrive clean and depart upward with increasing blur for airy exits."
  variables={[{"id":"direction","type":"enum","role":"motion","label":"Direction","description":"Where the offset the timeline drives points.","default":"up","options":[{"value":"up","label":"Up"},{"value":"down","label":"Down"},{"value":"left","label":"Left"},{"value":"right","label":"Right"}]},{"id":"distance","type":"enum","role":"motion","label":"Distance","description":"Scales the travel offset, so the words cover a shorter or longer run in the same time.","default":"standard","options":[{"value":"close","label":"Close"},{"value":"standard","label":"Standard"},{"value":"far","label":"Far"}]},{"id":"blur","type":"enum","role":"style","label":"Blur","description":"Scales the blur radius the timeline drives, from a light haze to a full smear.","default":"standard","options":[{"value":"soft","label":"Soft"},{"value":"standard","label":"Standard"},{"value":"heavy","label":"Heavy"}]},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Word colour: ink for light frames, paper for dark ones, accent rides --brand.","default":"ink","options":[{"value":"ink","label":"Ink"},{"value":"paper","label":"Paper"},{"value":"accent","label":"Accent"}]}]}
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":110}}
  attribution={{"path":"registry/components/blur-out-up","tags":["motion-primitive","typography"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/blur-out-up/blur-out-up.html"
>
...
<!--
  ...
  keeps driving one offset and one blur, and these decide what that offset and
  that blur mean on screen.

    - direction (up | down | left | right, default up): where the offset
      points. up rises into place, down drops in, left and right slide in
      along the baseline.
  ...
  through a 5px blur in near-black.
-->
...
```html wrap
<div
  data-composition-id="blur-out-up"
  data-composition-src="compositions/components/blur-out-up.html"
