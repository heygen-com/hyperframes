...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":496}}
      ...
      <script>
        (function () {
          ...
          var duration = Math.max(
            0.001,
            parseFloat(
              root.dataset.duration || html.getAttribute("data-composition-duration") || "4.6",
            ),
          );
          ...
          var tiles = PHOTOS.map(function (p, i) {
            ...
            el.innerHTML =
              '<div class="ms-ring"></div><div class="ms-photo" style="--a:' +
              p[0] +
              ";--b:" +
              p[1] +
              ";--c:" +
              p[2] +
              '"></div><div class="ms-check">' +
              CHECK +
          ...
          function pointerAt(t) {
            ...
            if (t <= T_EXIT)
              return arc(B, ASIDE, 0.1, easeArrive(clamp01((t - T_DRIFT) / (0.5 * s))));
