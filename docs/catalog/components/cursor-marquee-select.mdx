...
<CatalogDetail
  ...
  video="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-marquee-select.mp4"
  poster="https://static.heygen.ai/hyperframes-oss/docs/images/catalog/components/cursor-marquee-select.png"
  hasCode
