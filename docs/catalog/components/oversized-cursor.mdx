    ...
    <template>
      ...
      <script>
        (function () {
          ...
          // <html>, not this file's own <html> (the mount contract discards
          // this file's <head>/<html> after the loader reads its declared
          ...
          if (exit === "fade") {
            ...
            tl.to(
              stage,
              { opacity: 0, y: "-4cqh", duration: OUT, ease: "power2.in" },
              OUT_AT,
            );
          }
