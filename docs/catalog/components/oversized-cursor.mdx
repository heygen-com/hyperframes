...
<CatalogDetail
  ...
  meta={{"category":"Cursors","badge":"Stable","codeLines":422}}
  attribution={{"path":"registry/components/oversized-cursor","tags":["cursor","motion-primitive","actor","pointer","interaction"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/oversized-cursor/oversized-cursor.html"
>
...
Tagged `cursor` `motion-primitive` `actor` `pointer` `interaction`.
