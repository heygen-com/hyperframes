      ...
      <div id="root" data-composition-id="typed-prompt" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var maxLength = rows.reduce(function (best, row) {
