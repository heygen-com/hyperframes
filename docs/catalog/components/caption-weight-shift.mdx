...
<CatalogDetail
  previewSrc="/public/catalog/components/caption-weight-shift.json"
  compositionId="caption-weight-shift"
  compositionSrc="compositions/components/caption-weight-shift.html"
  title="Weight Shift"
  description="Elegant font-weight transition between caption lines"
  variables={[]}
  meta={{"category":"Captions","badge":"Stable","codeLines":397}}
  attribution={{"path":"registry/components/caption-weight-shift","tags":["captions","caption-style","minimal","typography"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/caption-weight-shift/caption-weight-shift.html"
>

<CatalogSlot slot="code">

```html caption-weight-shift.html
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
