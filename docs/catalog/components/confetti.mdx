...
<CatalogDetail
  previewSrc="/public/catalog/components/confetti.json"
  compositionId="confetti"
  compositionSrc="compositions/components/confetti.html"
  title="Confetti"
  description="A deterministic celebration burst with seeded particles and gravity."
  variables={[]}
  meta={{"category":"Effects","badge":"Stable","codeLines":127}}
  attribution={{"path":"registry/components/confetti","tags":["effect"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/confetti/confetti.html"
>
...
```html confetti.html
<!--
  Confetti - catalog component for HyperFrames.
...
<style>
  ...
  .hf-catalog-confetti .card {
    position: absolute;
    inset: var(--space-3, 74px) var(--space-3, 92px);
