...
<!--
  ...
  literal "marker-checklist-card" key. Ships two OFL faces. Deterministic.
-->
<html
  lang="en"
...
<Accordion title={`marker-checklist-card.html`}>
