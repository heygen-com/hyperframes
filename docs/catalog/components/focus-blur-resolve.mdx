...
<CatalogDetail
  ...
  meta={{"category":"Typography & Text","badge":"Stable","codeLines":91}}
  attribution={{"path":"registry/components/focus-blur-resolve","tags":["motion-primitive","typography"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/focus-blur-resolve/focus-blur-resolve.html"
>
