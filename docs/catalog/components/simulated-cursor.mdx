...
<CatalogDetail
  ...
  compositionSrc="compositions/components/simulated-cursor.html"
  title="Simulated Cursor"
  description="A lightweight cursor pointer and click pulse for product walkthroughs and agent UI demos"
  variables={[{"id":"size","type":"number","role":"layout","label":"Size","description":"Height and width of the pointer in pixels. The click ring scales with it. Values outside the range clamp to the nearest end and anything that is not a number falls back to 44.","default":44,"min":20,"max":120,"step":2,"unit":"px"},{"id":"tone","type":"enum","role":"style","label":"Tone","description":"Pointer fill and click ring colour: light reads on dark screens, dark reads on light ones, accent rides --hf-ui-accent.","default":"light","options":[{"value":"light","label":"Light"},{"value":"dark","label":"Dark"},{"value":"accent","label":"Accent"}]},{"id":"pulse","type":"enum","role":"style","label":"Click ring","description":"Weight of the ring the click animation expands: subtle is a thin small ring, bold a thick wide one, none removes the ring entirely.","default":"standard","options":[{"value":"subtle","label":"Subtle"},{"value":"standard","label":"Standard"},{"value":"bold","label":"Bold"},{"value":"none","label":"None"}]}]}
  meta={{"category":"Cursors","badge":"Stable","codeLines":141}}
  attribution={{"path":"registry/components/simulated-cursor","tags":["cursor","video-primitive","motion-primitive","ui","walkthrough"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/simulated-cursor/simulated-cursor.html"
>
...
Open `compositions/components/simulated-cursor.html` and copy what is inside into your own composition.
...
Tagged `cursor` `video-primitive` `motion-primitive` `ui` `walkthrough`.
