...
<CatalogDetail
  ...
  compositionSrc="compositions/components/multiplayer-cursors.html"
  title="Multiplayer Cursors"
  description="Labeled collaborator cursors with token-derived colors and soft glows drift from spread positions into a shared center zone, proving live multiplayer presence."
  variables={[{"id":"cursorCount","type":"number","role":"content","label":"Cursor count","description":"Number of labeled collaborator cursors.","default":4,"min":2,"max":6,"step":1},{"id":"labels","type":"string","role":"content","label":"Labels","description":"Comma-separated cursor names, in order.","default":"Ana,Ken,Wen,Mia"}]}
  meta={{"category":"Cursors","badge":"Stable","codeLines":429}}
  attribution={{"path":"registry/components/multiplayer-cursors","tags":["cursor","pointer","multiplayer","collaboration","presence","loop","prove"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/components/multiplayer-cursors/multiplayer-cursors.html"
>
