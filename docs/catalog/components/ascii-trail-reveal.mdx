...
<VariablesExplorer
  previewSrc="/public/catalog/preview/components/ascii-trail-reveal.html"
      ...
      <div id="root" data-composition-id="ascii-trail-reveal" data-duration="4" data-fps="30">
        ...
        <script>
          (function () {
            ...
            var accentColors = { green: "var(--brand, #4ade80)", blue: "var(--accent, #38bdf8)", violet: "var(--accent-2, #a78bfa)" };
