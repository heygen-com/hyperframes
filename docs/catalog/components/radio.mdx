...
```html
<!-- Radio Group - animate --hf-radio-selected between 0 and 1 on each option. -->
<div data-hf-ui-root class="hf-ui-radio-group" role="radiogroup" aria-label="Render mode">
  <label
    class="hf-ui-radio"
...
<style>
  ...
  .hf-ui-radio {
    ...
    font: var(--_hf-ui-weight-medium) 14px/1 var(--_hf-ui-font-sans);
    cursor: pointer;
