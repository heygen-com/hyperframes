...
- `section`
- `aside`
- anime.js or GSAP-driven cards, overlays, and text blocks
...
Generic motion clips do not have an equivalent playback-offset model yet. For an anime.js or GSAP-driven `section` or `div`, the Studio can:
