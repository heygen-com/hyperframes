...
<AccordionGroup>
  ...
  <Accordion title="Agent doesn't find the skill">
    ...
    Lead your prompt with _"Use the /product-launch-video skill"_ for the most reliable results — site tours are its **tour angle**. Agents also discover it automatically when they see a URL and a video request.
  </Accordion>
</AccordionGroup>
