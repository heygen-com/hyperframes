...
New feedback stores the raw integer together with `rating_scale: 10`. Where an NPS category is needed, scores `0–6` are detractors, `7–8` are passives, and `9–10` are promoters.
