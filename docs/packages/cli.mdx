...
# Agents: no prompts, centered Inter blank
npx hyperframes init my-video --agent
...
| Flag                | Description                                                                                                                                                                                                                                                                          |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `--example, -e`     | Example to scaffold. Required with `--non-interactive` unless `--agent`, `--video`, or `--audio` is set. See [Examples](/examples) for the full list.                                                                                                                                 |
| `--agent`           | Non-interactive agent scaffold: centered Inter blank, paused timeline, no CSS `transform` centering.                                                                                                                                                                                 |
