...
<Note>
  This API ships in hyperframes PR #1814. You need a version of `@hyperframes/sdk` that includes the `/editing` subpath export. Check your installed version before importing.
</Note>
