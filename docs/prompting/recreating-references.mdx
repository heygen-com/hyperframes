...
<Accordion title="Worked example: the hologram globe (full distilled spec)">
  ...
  >
  > No audio.
    <video controls muted loop playsinline preload="metadata" src="https://www.heygenverse.com/s/81c5aeb9-ab43-488a-935a-5f284475bdff/raw" style={{ borderRadius: "0.5rem", marginTop: "0.75rem" }}></video>
