...
<video controls muted loop playsinline preload="metadata" src="https://www.heygenverse.com/s/a3a2da5a-9261-4d0b-a1a8-8e3d54ecb3ed/raw" style={{ borderRadius: "0.5rem", marginTop: "0.75rem" }}></video>
