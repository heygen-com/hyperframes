...
<!-- VALIDATION PENDING: changelog-video -->
...
*Next ride: same one-prompt move, now dressing footage you already shot → [Captions and talking-head footage](/prompting/captions-and-talking-heads).*
