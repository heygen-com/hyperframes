...
*You've been riding workflows — six one-prompt rides, six kinds of input, one finished video each. Level 2 opens the prompt itself → [Prompt anatomy](/prompting/anatomy).*
