...
| `vscode-theme-visualizer` | Code workbench | Landscape | Dev content, code showcases, tutorials |
...
<Tabs>
  ...
  <Tab title="vscode-theme-visualizer">
    ### vscode-theme-visualizer

    Full VS Code workbench with per-character typing animation across 12 built-in themes. Activity bar, sidebar, editor tabs, code typing with cursor tracking, terminal panel, and status bar — all driven by official theme JSON files.
