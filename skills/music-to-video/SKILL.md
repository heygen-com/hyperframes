...
**Lyric videos:** for lyrics synced to the vocals, get word/line timing by transcribing the track via `/hyperframes-media`, or ask the user for the lyrics text and place lines on the beat grid.
