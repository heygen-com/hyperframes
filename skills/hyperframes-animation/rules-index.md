...
<platform-motion-idioms path="rules/platform-motion-idioms.md">Platform motion dialects — Android/M3 vs iOS transition idioms, easing/duration tokens, predictive back, modal semantics — applied when a mocked surface resolves to a platform device frame. Tags: platform, android, ios, m3, hig, dialect, device-frame</platform-motion-idioms>
