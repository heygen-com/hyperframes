...
- horizontal `[marquee]` scroll (3d-hand) → `viewport-change` (PAN mode on the marquee strip), _thin fit; a literal CSS-marquee/translateX loop is closer to a `techniques.md`/CSS recipe than a named motion rule_
