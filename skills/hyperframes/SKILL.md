...
- **[references/motion-principles.md](references/motion-principles.md)** — Motion design principles, image motion treatment, required GSAP rules. **Always read** — every composition has motion.
