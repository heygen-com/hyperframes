...
| `interpolate(frame, [0, 15, 75, 90], [0, 1, 1, 0])` at fps=30 | `anime.createTimeline({ autoplay: false })` with three `.add()` calls at offsets 0/500/2500ms, each `ease: "linear"` |
