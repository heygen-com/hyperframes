...
2. EXTEND the engine for the NEW pieces only, port the demo's motion logic into
   anime.js generator functions, parameterized (sizes, colors, counts, seeds become DNA
