...
| [animate-text.md](../../hyperframes-animation/adapters/animate-text.md)                          | Named text animation effects and adapter guidance                                                                          | Beat has text animation                           |
...
| [transitions overview](../../hyperframes-animation/transitions/overview.md)                      | Shader transition API, HyperShader.init() pattern, and WebGL shader transition guidance                                    | Beat has shader transitions                       |
| [transitions/](../../hyperframes-animation/transitions/)                                         | CSS transition category files: push, scale, dissolve, blur, 3D flip, light leak, distortion, grid, mechanical, destruction | Beat uses CSS transitions                         |
| [css-marker-patterns.md](../../hyperframes-animation/rules/css-marker-patterns.md)               | Text markers: highlight sweeps, hand-drawn circles, burst lines, scribble, sketchout                                       | Beat uses text emphasis/markers                   |
...
| [caption authoring](../../hyperframes-media/references/captions/authoring.md)                    | Per-word karaoke, tone-adaptive styling, positioning                                                                       | Beat includes captions                            |
...
| [dynamic-content-sequencing.md](../../hyperframes-animation/rules/dynamic-content-sequencing.md) | Counter animations, data-driven visuals, dynamic content                                                                   | Beat has counters or data visualization           |
