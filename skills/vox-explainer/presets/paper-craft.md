# Style block — vox paper-craft diorama (Ori V1 DNA, from mesmer breakdown)
...
Final beat: minimal die-cut silhouette with a soft golden glow, large negative space, static.
No dialogue. No narration. No music. Quiet paper-rustle ambience only.
```

Palette: cream #E8E4D8 / indigo-purple accents / gold; labels white+black.
Palette arc: cream (setup) → indigo/gold (drama) → cream (test) → minimal cream (payoff).
