# Style block — vox collage-zine (Hongbin 6/26 DNA, verified in route-A demo)

Append to every clip prompt, then the mute template.
...
Palette: deep purple / signal red / mustard / kraft tan / hot pink / white.
If a real person must appear (avatar variant): "Keep the person's face 100% identical to the reference photo… Do NOT stylize, redraw, or cartoonify the face. Do not place any graphic elements over the face." (ArcFace-verified 0.89-0.91 identity retention with NB2L.)
