...
- `/hyperframes-studio` — work as the coding agent Studio runs: the element edit request format, the run queue, and `OverlayState` (the line an agent emits to drive what the selection overlay shows while it works).
