...
function HyperframesLogo() {
  // Derived from logo-dark.svg (263×79). Paths 8–9 = gradient icon mark;
  // paths 10–20 = Hyperframes wordmark, black → white for dark background.
  const W = 263;
  const H = 79;
  const height = 30;
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#hf-logo-g1)"
      />
      {/* Hyperframes wordmark — white fills */}
      <path
