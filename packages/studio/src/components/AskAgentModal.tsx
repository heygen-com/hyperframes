  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t("askAgentModal.title")}
        tabIndex={-1}
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-800/60">
          <div>
            <h3 className="text-sm font-medium text-neutral-200">{t("askAgentModal.title")}</h3>
        ...
        <div className="px-5 py-4 space-y-3">
          <textarea
            ...
            placeholder={t("askAgentModal.placeholder")}
            value={value}
          ...
          {contextPreview && (
            <details className="group">
              <summary className="text-[11px] text-neutral-500 cursor-pointer select-none hover:text-neutral-400">
                {t("askAgentModal.contextIncluded")}
              </summary>
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-neutral-800/60">
          <span className="text-[11px] text-neutral-600">
            {navigator.platform.includes("Mac")
              ? t("askAgentModal.shortcutHintMac")
              : t("askAgentModal.shortcutHintOther")}
          </span>
          <button
