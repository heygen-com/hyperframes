 ...
 *   codex    — Codex's own app icon (white plate, gradient mark)
...
export function AgentGlyph({
  ...
  if (kind === "codex") {
    // Codex's own app icon: a white plate under a gradient mark, so it reads
    // the same here as it does in the dock.
    return (
      <svg
        width={size}
        height={size}
      ...
      >
        <defs>
          <linearGradient id={CODEX_GRADIENT_ID} gradientUnits="userSpaceOnUse" x1="12" x2="12" y1="3" y2="21">
            <stop stopColor="#B1A7FF" />
            <stop offset=".5" stopColor="#7A9DFF" />
            <stop offset="1" stopColor="#3941FF" />
          </linearGradient>
        </defs>
        <path d={CODEX_PLATE_PATH} fill="#fff" />
