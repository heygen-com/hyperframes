import { Eye as EmptyStateEye, Layers } from "../../icons/SystemIcons";

interface PropertyPanelEmptyStateProps {
  multiSelectCount: number;
}

export function PropertyPanelEmptyState({ multiSelectCount }: PropertyPanelEmptyStateProps) {
  return (
    <div className="flex h-full flex-col bg-neutral-900">
      <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
        {multiSelectCount > 1 ? (
          ...
          <>
            <EmptyStateEye size={18} className="mb-3 text-neutral-600" />
            <p className="text-sm font-medium text-neutral-200">
