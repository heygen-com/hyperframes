    ...
    (layer: DomEditLayerItem) => {
      ...
      if (matchedId) {
        ...
        if (el) {
          ...
          const clipStart = el.start;
          const clipEnd = el.start + el.duration;
          // Only seek if current time is outside the clip range
          if (currentTime < clipStart || currentTime > clipEnd) {
            usePlayerStore.getState().requestSeek(clipStart + el.duration / 2);
          }
        }
      }
    },
