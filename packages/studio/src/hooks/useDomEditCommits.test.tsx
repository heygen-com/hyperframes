...
interface RenderedDomEditCommits {
  ...
  recordEdit: ReturnType<typeof makeRecordEdit>;
...
function makeRecordEdit() {
  return vi.fn(async (_entry: CapturedRecordEdit) => {});
}
...
function renderDomEditCommits(
  ...
  const recordEdit = makeRecordEdit();
