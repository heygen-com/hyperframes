...
function PropertyGroupNavigation({
  ...
  const CHEVRON_BUTTON_CLASS =
    ...
    "focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-accent " +
    ...
    >
      ...
      >
        <button
          ...
          className="flex h-6 w-6 shrink-0 items-center justify-center border-0 bg-transparent p-0 text-[11px] text-accent focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-accent"
          onClick={(event) => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={!onReveal}
        className="flex min-w-0 flex-1 flex-col justify-center rounded-sm border-0 bg-transparent p-0 text-left leading-tight enabled:hover:text-white focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-accent"
      ...
      {onRemove && target !== null && !isCarve && (
        <button
          ...
          className="flex h-6 w-6 shrink-0 items-center justify-center border-0 bg-transparent p-0 text-[11px] text-white/35 hover:text-white focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-accent"
          onPointerDown={(event) => event.stopPropagation()}
          onClick={(event) => {
