...
function devProjectApi(): Plugin {
  // Project data directory — defaults to studio/data/projects
    ...
    configureServer(server): void {
      ...
      server.middlewares.use(async (req, res, next) => {
        ...
        if (req.method === "GET" && rest.startsWith("/preview/comp/")) {
          ...
          const runtimeUrl = (process.env.HYPERFRAME_RUNTIME_URL || "").trim() || "https://unpkg.com/@hyperframes/core/dist/hyperframe.runtime.iife.js";
