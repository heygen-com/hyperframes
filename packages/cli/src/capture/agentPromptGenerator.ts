 ...
 * product-launch-video skill (the tour angle) — this file points agents there.
 */
...
To create a video from this capture, use the \`product-launch-video\` skill (its tour angle builds from the site's own screens).
