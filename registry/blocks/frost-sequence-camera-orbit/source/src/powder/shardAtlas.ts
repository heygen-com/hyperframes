...
export const SHARD_ATLAS_URL =
  "https://static.heygen.ai/hyperframes-oss/docs/images/catalog/assets/frost-sequence-camera-orbit/shards-atlas.png"; // FROST: was '/shards-atlas.png'
